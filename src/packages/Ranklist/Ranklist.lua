...
function RankList:GenerateUID_(nickname) 
...
function RankList:Getscorerange(data)
    assert(type(data) ==  "table", "data is NOT a table")
...
-- zrank 
-- param: ranklist
function RankList:Getrank(data) 
    assert(type(data) ==  "table", "data is NOT a table")
...
-- zrevrank 
-- param: ranklist
function RankList:Getrevrank(data) 
    assert(type(data) ==  "table", "data is NOT a table")
...
function RankList:Getrankrange(data)
    assert(type(data) ==  "table", "data is NOT a table")
...
-- zrevrange
-- param: ranklist, offset, count 
function RankList:Getrevrankrange(data)
    assert(type(data) ==  "table", "data is NOT a table")
...
-- param: ranklist, count
function RankList:Revlimit(data) 
    assert(type(data) ==  "table", "data is NOT a table")
