...
cc.isUndefined=function(a){return"undefined"==typeof a};cc.isObject=function(a){var c=typeof a;return"function"==c||a&&"object"==c};cc.isCrossOrigin=function(a){if(!a)return cc.log("invalid URL"),!1;var c=a.indexOf("://");if(-1==c)return!1;c=a.indexOf("/",c+3);return(-1==c?a:a.substring(0,c))!=location.origin};
...
_createScript:function(a,c,b){var d=document,e=cc.newElement("script");e.async=c;e.src=a;this._jsCache[a]=!0;cc._addEventListener(e,"load",function(){e.parentNode.removeChild(e);this.removeEventListener("load",arguments.callee,!1);b()},!1);cc._addEventListener(e,"error",function(){e.parentNode.removeChild(e);b("Load "+a+" failed!")},!1);d.body.appendChild(e)},_loadJs4Dependency:function(a,c,b,d){if(b>=c.length)d&&d();else{var e=this;e._createScript(cc.path.join(a,c[b]),!1,function(f){if(f)return d(f);
e._loadJs4Dependency(a,c,b+1,d)})}},_loadJsImg:function(){var a=document,c=a.getElementById("cocos2d_loadJsImg");if(!c){c=cc.newElement("img");cc._loadingImage&&(c.src=cc._loadingImage);a=a.getElementById(cc.game.config.id);a.style.backgroundColor="black";a.parentNode.appendChild(c);var b=getComputedStyle?getComputedStyle(a):a.currentStyle;b||(b={width:a.width,height:a.height});c.style.left=a.offsetLeft+(parseFloat(b.width)-c.width)/2+"px";c.style.top=a.offsetTop+(parseFloat(b.height)-c.height)/2+
"px";c.style.position="absolute"}return c},loadTxt:function(a,c){if(cc._isNodeJs)require("fs").readFile(a,function(a,b){a?c(a):c(null,b.toString())});else{var b=this.getXMLHttpRequest(),d="load "+a+" failed!";b.open("GET",a,!0);/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)?(b.setRequestHeader("Accept-Charset","utf-8"),b.onreadystatechange=function(){4==b.readyState&&(200==b.status?c(null,b.responseText):c(d))}):(b.overrideMimeType&&b.overrideMimeType("text/plain; charset\x3dutf-8"),
...
c){var b=new XMLHttpRequest;b.open("GET",a,!0);b.responseType="arraybuffer";b.onload=function(){var d=b.response;d&&(window.msg=d);4==b.readyState&&(200==b.status?c(null,b.response):c("load "+a+" failed!"))};b.send(null)},loadJson:function(a,c){this.loadTxt(a,function(b,d){if(b)c(b);else{try{var e=JSON.parse(d)}catch(f){throw"parse json ["+a+"] failed : "+f;}c(null,e)}})},_checkIsImageURL:function(a){return null!=/(\.png)|(\.jpg)|(\.bmp)|(\.jpeg)|(\.gif)/.exec(a)},loadImg:function(a,c,b){var d={isCrossOrigin:!0};
void 0!==b?d.isCrossOrigin=null==c.isCrossOrigin?d.isCrossOrigin:c.isCrossOrigin:void 0!==c&&(b=c);var e=this.getRes(a);if(e)return b&&b(null,e),e;e=new Image;d.isCrossOrigin&&"file://"!=location.origin&&(e.crossOrigin="Anonymous");var f=function(){this.removeEventListener("load",f,!1);this.removeEventListener("error",g,!1);cc.loader.cache[a]=e;b&&b(null,e)},g=function(){this.removeEventListener("error",g,!1);e.crossOrigin&&"anonymous"==e.crossOrigin.toLowerCase()?(d.isCrossOrigin=!1,cc.loader.loadImg(a,
d,b)):"function"==typeof b&&b("load image failed")};cc._addEventListener(e,"load",f);cc._addEventListener(e,"error",g);e.src=a;return e},_loadResIterator:function(a,c,b){var d=this,e=null,f=a.type;f?(f="."+f.toLowerCase(),e=a.src?a.src:a.name+f):(e=a,f=cc.path.extname(e));if(c=d.getRes(e))return b(null,c);c=null;f&&(c=d._register[f.toLowerCase()]);if(!c)return cc.error("loader for ["+f+"] not exists!"),b();f=c.getBasePath?c.getBasePath():d.resPath;f=d.getUrl(f,e);c.load(f,e,a,function(a,c){a?(cc.log(a),
d.cache[e]=null,delete d.cache[e],b()):(d.cache[e]=c,b(null,c))})},getUrl:function(a,c){var b=this._langPathCache,d=cc.path;if(void 0!==a&&void 0===c){c=a;var e=d.extname(c),e=e?e.toLowerCase():"";a=(e=this._register[e])?e.getBasePath?e.getBasePath():this.resPath:this.resPath}c=cc.path.join(a||"",c);if(c.match(/[\/(\\\\)]lang[\/(\\\\)]/i)){if(b[c])return b[c];d=d.extname(c)||"";c=b[c]=c.substring(0,c.length-d.length)+"_"+cc.sys.language+d}return c},load:function(a,c,b){var d=this,e=arguments.length;
if(0==e)throw"arguments error!";3==e?"function"==typeof c&&(c="function"==typeof b?{trigger:c,cb:b}:{cb:c,cbTarget:b}):2==e?"function"==typeof c&&(c={cb:c}):1==e&&(c={});a instanceof Array||(a=[a]);e=new cc.AsyncPool(a,0,function(a,b,e,k){d._loadResIterator(a,b,function(a){if(a)return e(a);var b=Array.prototype.slice.call(arguments,1);c.trigger&&c.trigger.call(c.triggerTarget,b[0],k.size,k.finishedSize);e(null,b[0])})},c.cb,c.cbTarget);e.flow();return e},_handleAliases:function(a,c){var b=this._aliases,
d=[],e;for(e in a){var f=a[e];b[e]=f;d.push(f)}this.load(d,c)},loadAliases:function(a,c){var b=this,d=b.getRes(a);d?b._handleAliases(d.filenames,c):b.load(a,function(a,d){b._handleAliases(d[0].filenames,c)})},register:function(a,c){if(a&&c){if("string"==typeof a)return this._register[a.trim().toLowerCase()]=c;for(var b=0,d=a.length;b<d;b++)this._register["."+a[b].trim().toLowerCase()]=c}},getRes:function(a){return this.cache[a]||this.cache[this._aliases[a]]},release:function(a){var c=this.cache,b=
this._aliases;delete c[a];delete c[b[a]];delete b[a]},releaseAll:function(){var a=this.cache,c=this._aliases,b;for(b in a)delete a[b];for(b in c)delete c[b]}};cc.formatStr=function(){var a=arguments,c=a.length;if(1>c)return"";var b=a[0],d=!0;"object"==typeof b&&(d=!1);for(var e=1;e<c;++e){var f=a[e];if(d)for(;;){var g=null;if("number"==typeof f&&(g=b.match(/(%d)|(%s)/))){b=b.replace(/(%d)|(%s)/,f);break}b=(g=b.match(/%s/))?b.replace(/%s/,f):b+("    "+f);break}else b+="    "+f}return b};
...
cc._initSys=function(a,c){cc._RENDER_TYPE_CANVAS=0;cc._RENDER_TYPE_WEBGL=1;cc.sys={};var b=cc.sys;b.LANGUAGE_ENGLISH="en";b.LANGUAGE_CHINESE="zh";b.LANGUAGE_FRENCH="fr";b.LANGUAGE_ITALIAN="it";b.LANGUAGE_GERMAN="de";b.LANGUAGE_SPANISH="es";b.LANGUAGE_DUTCH="du";b.LANGUAGE_RUSSIAN="ru";b.LANGUAGE_KOREAN="ko";b.LANGUAGE_JAPANESE="ja";b.LANGUAGE_HUNGARIAN="hu";b.LANGUAGE_PORTUGUESE="pt";b.LANGUAGE_ARABIC="ar";b.LANGUAGE_NORWEGIAN="no";b.LANGUAGE_POLISH="pl";b.OS_WINDOWS="Windows";b.OS_IOS="iOS";b.OS_OSX=
"OS X";b.OS_UNIX="UNIX";b.OS_LINUX="Linux";b.OS_ANDROID="Android";b.OS_UNKNOWN="Unknown";b.WINDOWS=0;b.LINUX=1;b.MACOS=2;b.ANDROID=3;b.IPHONE=4;b.IPAD=5;b.BLACKBERRY=6;b.NACL=7;b.EMSCRIPTEN=8;b.TIZEN=9;b.WINRT=10;b.WP8=11;b.MOBILE_BROWSER=100;b.DESKTOP_BROWSER=101;b.BROWSER_TYPE_WECHAT="wechat";b.BROWSER_TYPE_ANDROID="androidbrowser";b.BROWSER_TYPE_IE="ie";b.BROWSER_TYPE_QQ="qqbrowser";b.BROWSER_TYPE_MOBILE_QQ="mqqbrowser";b.BROWSER_TYPE_UC="ucbrowser";b.BROWSER_TYPE_360="360browser";b.BROWSER_TYPE_BAIDU_APP=
"baiduboxapp";b.BROWSER_TYPE_BAIDU="baidubrowser";b.BROWSER_TYPE_MAXTHON="maxthon";b.BROWSER_TYPE_OPERA="opera";b.BROWSER_TYPE_OUPENG="oupeng";b.BROWSER_TYPE_MIUI="miuibrowser";b.BROWSER_TYPE_FIREFOX="firefox";b.BROWSER_TYPE_SAFARI="safari";b.BROWSER_TYPE_CHROME="chrome";b.BROWSER_TYPE_LIEBAO="liebao";b.BROWSER_TYPE_QZONE="qzone";b.BROWSER_TYPE_SOUGOU="sogou";b.BROWSER_TYPE_UNKNOWN="unknown";b.isNative=!1;var d=[b.BROWSER_TYPE_BAIDU,b.BROWSER_TYPE_OPERA,b.BROWSER_TYPE_FIREFOX,b.BROWSER_TYPE_CHROME,
b.BROWSER_TYPE_SAFARI],e=[b.OS_IOS,b.OS_WINDOWS,b.OS_OSX,b.OS_LINUX],f=[b.BROWSER_TYPE_BAIDU,b.BROWSER_TYPE_OPERA,b.BROWSER_TYPE_FIREFOX,b.BROWSER_TYPE_CHROME,b.BROWSER_TYPE_BAIDU_APP,b.BROWSER_TYPE_SAFARI,b.BROWSER_TYPE_UC,b.BROWSER_TYPE_QQ,b.BROWSER_TYPE_MOBILE_QQ,b.BROWSER_TYPE_IE],g=window,h=g.navigator,k=document,m=k.documentElement,p=h.userAgent.toLowerCase();b.isMobile=-1!=p.indexOf("mobile")||-1!=p.indexOf("android");b.platform=b.isMobile?b.MOBILE_BROWSER:b.DESKTOP_BROWSER;var n=h.language,
n=(n=n?n:h.browserLanguage)?n.split("-")[0]:b.LANGUAGE_ENGLISH;b.language=n;var n=b.BROWSER_TYPE_UNKNOWN,r=p.match(/sogou|qzone|liebao|micromessenger|qqbrowser|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i)||p.match(/chrome|safari/i);r&&0<r.length&&(n=r[0],"micromessenger"==n?n=b.BROWSER_TYPE_WECHAT:"safari"===n&&p.match(/android.*applewebkit/)?n=b.BROWSER_TYPE_ANDROID:"trident"==n?n=b.BROWSER_TYPE_IE:"360 aphone"==n&&(n=b.BROWSER_TYPE_360));
b.browserType=n;n=p.match(/(iPad|iPhone|iPod)/i)?!0:!1;p=p.match(/android/i)||h.platform.match(/android/i)?!0:!1;r=b.OS_UNKNOWN;-1!=h.appVersion.indexOf("Win")?r=b.OS_WINDOWS:n?r=b.OS_IOS:-1!=h.appVersion.indexOf("Mac")?r=b.OS_OSX:-1!=h.appVersion.indexOf("X11")?r=b.OS_UNIX:p?r=b.OS_ANDROID:-1!=h.appVersion.indexOf("Linux")&&(r=b.OS_LINUX);b.os=r;b._supportMultipleAudio=-1<f.indexOf(b.browserType);f=parseInt(a[c.renderMode]);p=cc._RENDER_TYPE_WEBGL;n=cc.newElement("Canvas");cc._supportRender=!0;d=
!window.WebGLRenderingContext||-1==d.indexOf(b.browserType)||-1==e.indexOf(b.os);if(1===f||0===f&&d||"file://"==location.origin)p=cc._RENDER_TYPE_CANVAS;b._canUseCanvasNewBlendModes=function(){var a=document.createElement("canvas");a.width=1;a.height=1;a=a.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,1,1);a.globalCompositeOperation="multiply";var c=document.createElement("canvas");c.width=1;c.height=1;var b=c.getContext("2d");b.fillStyle="#fff";b.fillRect(0,0,1,1);a.drawImage(c,0,0,1,1);return 0===
a.getImageData(0,0,1,1).data[0]};b._supportCanvasNewBlendModes=b._canUseCanvasNewBlendModes();if(p==cc._RENDER_TYPE_WEBGL&&(!g.WebGLRenderingContext||!cc.create3DContext(n,{stencil:!0,preserveDrawingBuffer:!0})))0==f?p=cc._RENDER_TYPE_CANVAS:cc._supportRender=!1;if(p==cc._RENDER_TYPE_CANVAS)try{n.getContext("2d")}catch(s){cc._supportRender=!1}cc._renderType=p;try{b._supportWebAudio=!(!g.AudioContext&&!g.webkitAudioContext&&!g.mozAudioContext)}catch(u){b._supportWebAudio=!1}try{var t=b.localStorage=
g.localStorage;t.setItem("storage","");t.removeItem("storage");t=null}catch(v){("SECURITY_ERR"===v.name||"QuotaExceededError"===v.name)&&cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"),b.localStorage=function(){}}t=b.capabilities={canvas:!0};cc._renderType==cc._RENDER_TYPE_WEBGL&&(t.opengl=!0);if(void 0!==m.ontouchstart||void 0!==k.ontouchstart||h.msPointerEnabled)t.touches=!0;void 0!==m.onmouseup&&(t.mouse=!0);void 0!==m.onkeyup&&(t.keyboard=!0);if(g.DeviceMotionEvent||
g.DeviceOrientationEvent)t.accelerometer=!0;b.garbageCollect=function(){};b.dumpRoot=function(){};b.restartVM=function(){};b.cleanScript=function(a){};b.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+="language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";a+="os : "+this.os+"\r\n";a+="platform : "+this.platform+"\r\n";cc.log(a)}};cc.ORIENTATION_PORTRAIT=0;cc.ORIENTATION_PORTRAIT_UPSIDE_DOWN=1;
...
arguments))})):console&&console.log.apply&&(cc.error=function(){return console.error.apply(console,arguments)},cc.assert=function(a,c){if(!a&&c){for(var b=2;b<arguments.length;b++)c=c.replace(/(%s)|(%d)/,cc._formatString(arguments[b]));throw c;}},a!=c.DEBUG_MODE_ERROR&&(cc.warn=function(){return console.warn.apply(console,arguments)}),a==c.DEBUG_MODE_INFO&&(cc.log=function(){return console.log.apply(console,arguments)}))}};cc._initDebugSetting(cc.game.config[cc.game.CONFIG_KEY.debugMode]);cc.loader.loadBinary=function(a,c){var b=this,d=this.getXMLHttpRequest(),e="load "+a+" failed!";d.open("GET",a,!0);/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)?(d.setRequestHeader("Accept-Charset","x-user-defined"),d.onreadystatechange=function(){if(4==d.readyState&&200==d.status){var a=cc._convertResponseBodyToText(d.responseBody);c(null,b._str2Uint8Array(a))}else c(e)}):(d.overrideMimeType&&d.overrideMimeType("text/plain; charset\x3dx-user-defined"),d.onload=function(){4==
d.readyState&&200==d.status?c(null,b._str2Uint8Array(d.responseText)):c(e)});d.send(null)};cc.loader._str2Uint8Array=function(a){if(!a)return null;for(var c=new Uint8Array(a.length),b=0;b<a.length;b++)c[b]=a.charCodeAt(b)&255;return c};
cc.loader.loadBinarySync=function(a){var c=this.getXMLHttpRequest(),b="load "+a+" failed!";c.open("GET",a,!1);a=null;if(/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)){c.setRequestHeader("Accept-Charset","x-user-defined");c.send(null);if(200!=c.status)return cc.log(b),null;(c=cc._convertResponseBodyToText(c.responseBody))&&(a=this._str2Uint8Array(c))}else{c.overrideMimeType&&c.overrideMimeType("text/plain; charset\x3dx-user-defined");c.send(null);if(200!=c.status)return cc.log(b),
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var p=arguments[k],n;for(n in p){var r="function"===typeof p[n],s="function"===typeof e[n],u=a.test(p[n]);c&&r&&s&&u?(h.value=ClassManager.compileSuper(p[n],n,g),Object.defineProperty(f,n,h)):r&&s&&u?(h.value=function(a,c){return function(){var b=this._super;this._super=e[a];var d=c.apply(this,
arguments);this._super=b;return d}}(n,p[n]),Object.defineProperty(f,n,h)):r?(h.value=p[n],Object.defineProperty(f,n,h)):f[n]=p[n];if(r){var t,v;if(this.__getters__&&this.__getters__[n]){var r=this.__getters__[n],w;for(w in this.__setters__)if(this.__setters__[w]==r){v=w;break}cc.defineGetterSetter(f,r,p[n],p[v]?p[v]:f[v],n,v)}if(this.__setters__&&this.__setters__[n]){r=this.__setters__[n];for(w in this.__getters__)if(this.__getters__[w]==r){t=w;break}cc.defineGetterSetter(f,r,p[t]?p[t]:f[t],p[n],
t,n)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var c in a)f[c]=a[c]};return d}})();
...
b?c=!1:"true"==b?c=!0:"real"==b?c=parseFloat(a.firstChild.nodeValue):"integer"==b&&(c=parseInt(a.firstChild.nodeValue,10));return c},_parseArray:function(a){for(var c=[],b=0,d=a.childNodes.length;b<d;b++){var e=a.childNodes[b];1==e.nodeType&&c.push(this._parseNode(e))}return c},_parseDict:function(a){for(var c={},b=null,d=0,e=a.childNodes.length;d<e;d++){var f=a.childNodes[d];1==f.nodeType&&("key"==f.tagName?b=f.firstChild.nodeValue:c[b]=this._parseNode(f))}return c}});cc._txtLoader={load:function(a,c,b,d){cc.loader.loadTxt(a,d)}};cc.loader.register(["txt","xml","vsh","fsh","atlas"],cc._txtLoader);cc._jsonLoader={load:function(a,c,b,d){cc.loader.loadJson(a,d)}};cc.loader.register(["json","ExportJson"],cc._jsonLoader);cc._imgLoader={load:function(a,c,b,d){cc.loader.cache[c]=cc.loader.loadImg(a,function(a,b){if(a)return d(a);cc.textureCache.handleLoadedTexture(c);d(null,b)})}};cc.loader.register("png jpg bmp jpeg gif ico".split(" "),cc._imgLoader);
cc._serverImgLoader={load:function(a,c,b,d){cc.loader.cache[c]=cc.loader.loadImg(b.src,function(a,b){if(a)return d(a);cc.textureCache.handleLoadedTexture(c);d(null,b)})}};cc.loader.register(["serverImg"],cc._serverImgLoader);cc._plistLoader={load:function(a,c,b,d){cc.loader.loadTxt(a,function(a,c){if(a)return d(a);d(null,cc.plistParser.parse(c))})}};cc.loader.register(["plist"],cc._plistLoader);
cc._fontLoader={TYPE:{".eot":"embedded-opentype",".ttf":"truetype",".woff":"woff",".svg":"svg"},_loadFont:function(a,c,b){var d=document,e=cc.path,f=this.TYPE,g=cc.newElement("style");g.type="text/css";d.body.appendChild(g);var h="@font-face { font-family:"+a+"; src:";if(c instanceof Array)for(var k=0,m=c.length;k<m;k++)b=e.extname(c[k]).toLowerCase(),h+="url('"+c[k]+"') format('"+f[b]+"')",h+=k==m-1?";":",";else h+="url('"+c+"') format('"+f[b]+"');";g.textContent+=h+"};";c=cc.newElement("div");b=
c.style;b.fontFamily=a;c.innerHTML=".";b.position="absolute";b.left="-100px";b.top="-100px";d.body.appendChild(c)},load:function(a,c,b,d){c=b.type;a=b.name;c=b.srcs;cc.isString(b)?(c=cc.path.extname(b),a=cc.path.basename(b,c),this._loadFont(a,b,c)):this._loadFont(a,c);d(null,!0)}};cc.loader.register(["font","eot","ttf","woff","svg"],cc._fontLoader);cc._binaryLoader={load:function(a,c,b,d){cc.loader.loadBinary(a,d)}};cc._csbLoader={load:function(a,c,b,d){cc.loader.loadCsb(a,d)}};
...
cc.arrayRemoveArray=function(a,c){for(var b=0,d=c.length;b<d;b++)cc.arrayRemoveObject(a,c[b])};cc.arrayAppendObjectsToIndex=function(a,c,b){a.splice.apply(a,[b,0].concat(c));return a};cc.copyArray=function(a){var c,b=a.length,d=Array(b);for(c=0;c<b;c+=1)d[c]=a[c];return d};cc=cc||{};cc._tmp=cc._tmp||{};
...
a||0;this._yF32[0]=b||0};cc.Vertex2F.BYTES_PER_ELEMENT=8;Object.defineProperties(cc.Vertex2F.prototype,{x:{get:function(){return this._xF32[0]},set:function(a){this._xF32[0]=a},enumerable:!0},y:{get:function(){return this._yF32[0]},set:function(a){this._yF32[0]=a},enumerable:!0}});cc.Vertex3F=function(a,b,d,e,f){this._arrayBuffer=e||new ArrayBuffer(cc.Vertex3F.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;f=this._offset;this._xF32=new Float32Array(e,f,1);this._xF32[0]=a||0;this._yF32=new Float32Array(e,
f+Float32Array.BYTES_PER_ELEMENT,1);this._yF32[0]=b||0;this._zF32=new Float32Array(e,f+2*Float32Array.BYTES_PER_ELEMENT,1);this._zF32[0]=d||0};cc.Vertex3F.BYTES_PER_ELEMENT=12;Object.defineProperties(cc.Vertex3F.prototype,{x:{get:function(){return this._xF32[0]},set:function(a){this._xF32[0]=a},enumerable:!0},y:{get:function(){return this._yF32[0]},set:function(a){this._yF32[0]=a},enumerable:!0},z:{get:function(){return this._zF32[0]},set:function(a){this._zF32[0]=a},enumerable:!0}});cc.Tex2F=function(a,
b,d,e){this._arrayBuffer=d||new ArrayBuffer(cc.Tex2F.BYTES_PER_ELEMENT);this._offset=e||0;this._uF32=new Float32Array(this._arrayBuffer,this._offset,1);this._vF32=new Float32Array(this._arrayBuffer,this._offset+4,1);this._uF32[0]=a||0;this._vF32[0]=b||0};cc.Tex2F.BYTES_PER_ELEMENT=8;Object.defineProperties(cc.Tex2F.prototype,{u:{get:function(){return this._uF32[0]},set:function(a){this._uF32[0]=a},enumerable:!0},v:{get:function(){return this._vF32[0]},set:function(a){this._vF32[0]=a},enumerable:!0}});
cc.Quad2=function(a,b,d,e,f,g){this._arrayBuffer=f||new ArrayBuffer(cc.Quad2.BYTES_PER_ELEMENT);this._offset=g||0;f=this._arrayBuffer;g=cc.Vertex2F.BYTES_PER_ELEMENT;this._tl=a?new cc.Vertex2F(a.x,a.y,f,0):new cc.Vertex2F(0,0,f,0);this._tr=b?new cc.Vertex2F(b.x,b.y,f,g):new cc.Vertex2F(0,0,f,g);this._bl=d?new cc.Vertex2F(d.x,d.y,f,2*g):new cc.Vertex2F(0,0,f,2*g);this._br=e?new cc.Vertex2F(e.x,e.y,f,3*g):new cc.Vertex2F(0,0,f,3*g)};cc.Quad2.BYTES_PER_ELEMENT=32;cc.Quad3=function(a,b,d,e){this.bl=a||
new cc.Vertex3F(0,0,0);this.br=b||new cc.Vertex3F(0,0,0);this.tl=d||new cc.Vertex3F(0,0,0);this.tr=e||new cc.Vertex3F(0,0,0)};Object.defineProperties(cc.Quad2.prototype,{tl:{get:function(){return this._tl},set:function(a){this._tl.x=a.x;this._tl.y=a.y},enumerable:!0},tr:{get:function(){return this._tr},set:function(a){this._tr.x=a.x;this._tr.y=a.y},enumerable:!0},bl:{get:function(){return this._bl},set:function(a){this._bl.x=a.x;this._bl.y=a.y},enumerable:!0},br:{get:function(){return this._br},set:function(a){this._br.x=
a.x;this._br.y=a.y},enumerable:!0}});cc.V3F_C4B_T2F=function(a,b,d,e,f){this._arrayBuffer=e||new ArrayBuffer(cc.V3F_C4B_T2F.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;f=this._offset;var g=cc.Vertex3F.BYTES_PER_ELEMENT;this._vertices=a?new cc.Vertex3F(a.x,a.y,a.z,e,f):new cc.Vertex3F(0,0,0,e,f);this._colors=b?cc.color(b.r,b.g,b.b,b.a,e,f+g):cc.color(0,0,0,0,e,f+g);this._texCoords=d?new cc.Tex2F(d.u,d.v,e,f+g+cc.Color.BYTES_PER_ELEMENT):new cc.Tex2F(0,0,e,f+g+cc.Color.BYTES_PER_ELEMENT)};
cc.V3F_C4B_T2F.BYTES_PER_ELEMENT=24;Object.defineProperties(cc.V3F_C4B_T2F.prototype,{vertices:{get:function(){return this._vertices},set:function(a){var b=this._vertices;b.x=a.x;b.y=a.y;b.z=a.z},enumerable:!0},colors:{get:function(){return this._colors},set:function(a){var b=this._colors;b.r=a.r;b.g=a.g;b.b=a.b;b.a=a.a},enumerable:!0},texCoords:{get:function(){return this._texCoords},set:function(a){this._texCoords.u=a.u;this._texCoords.v=a.v},enumerable:!0}});cc.V3F_C4B_T2F_Quad=function(a,b,d,
e,f,g){this._arrayBuffer=f||new ArrayBuffer(cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT);this._offset=g||0;f=this._arrayBuffer;g=this._offset;var h=cc.V3F_C4B_T2F.BYTES_PER_ELEMENT;this._tl=a?new cc.V3F_C4B_T2F(a.vertices,a.colors,a.texCoords,f,g):new cc.V3F_C4B_T2F(null,null,null,f,g);this._bl=b?new cc.V3F_C4B_T2F(b.vertices,b.colors,b.texCoords,f,g+h):new cc.V3F_C4B_T2F(null,null,null,f,g+h);this._tr=d?new cc.V3F_C4B_T2F(d.vertices,d.colors,d.texCoords,f,g+2*h):new cc.V3F_C4B_T2F(null,null,null,f,g+2*
h);this._br=e?new cc.V3F_C4B_T2F(e.vertices,e.colors,e.texCoords,f,g+3*h):new cc.V3F_C4B_T2F(null,null,null,f,g+3*h)};cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT=96;Object.defineProperties(cc.V3F_C4B_T2F_Quad.prototype,{tl:{get:function(){return this._tl},set:function(a){var b=this._tl;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords},enumerable:!0},bl:{get:function(){return this._bl},set:function(a){var b=this._bl;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords},enumerable:!0},
tr:{get:function(){return this._tr},set:function(a){var b=this._tr;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords},enumerable:!0},br:{get:function(){return this._br},set:function(a){var b=this._br;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords},enumerable:!0},arrayBuffer:{get:function(){return this._arrayBuffer},enumerable:!0}});cc.V3F_C4B_T2F_QuadZero=function(){return new cc.V3F_C4B_T2F_Quad};cc.V3F_C4B_T2F_QuadCopy=function(a){if(!a)return cc.V3F_C4B_T2F_QuadZero();
var b=a.tl,d=a.bl,e=a.tr;a=a.br;return{tl:{vertices:{x:b.vertices.x,y:b.vertices.y,z:b.vertices.z},colors:{r:b.colors.r,g:b.colors.g,b:b.colors.b,a:b.colors.a},texCoords:{u:b.texCoords.u,v:b.texCoords.v}},bl:{vertices:{x:d.vertices.x,y:d.vertices.y,z:d.vertices.z},colors:{r:d.colors.r,g:d.colors.g,b:d.colors.b,a:d.colors.a},texCoords:{u:d.texCoords.u,v:d.texCoords.v}},tr:{vertices:{x:e.vertices.x,y:e.vertices.y,z:e.vertices.z},colors:{r:e.colors.r,g:e.colors.g,b:e.colors.b,a:e.colors.a},texCoords:{u:e.texCoords.u,
v:e.texCoords.v}},br:{vertices:{x:a.vertices.x,y:a.vertices.y,z:a.vertices.z},colors:{r:a.colors.r,g:a.colors.g,b:a.colors.b,a:a.colors.a},texCoords:{u:a.texCoords.u,v:a.texCoords.v}}}};cc.V3F_C4B_T2F_QuadsCopy=function(a){if(!a)return[];for(var b=[],d=0;d<a.length;d++)b.push(cc.V3F_C4B_T2F_QuadCopy(a[d]));return b};cc.V2F_C4B_T2F=function(a,b,d,e,f){this._arrayBuffer=e||new ArrayBuffer(cc.V2F_C4B_T2F.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;f=this._offset;var g=cc.Vertex2F.BYTES_PER_ELEMENT;
this._vertices=a?new cc.Vertex2F(a.x,a.y,e,f):new cc.Vertex2F(0,0,e,f);this._colors=b?cc.color(b.r,b.g,b.b,b.a,e,f+g):cc.color(0,0,0,0,e,f+g);this._texCoords=d?new cc.Tex2F(d.u,d.v,e,f+g+cc.Color.BYTES_PER_ELEMENT):new cc.Tex2F(0,0,e,f+g+cc.Color.BYTES_PER_ELEMENT)};cc.V2F_C4B_T2F.BYTES_PER_ELEMENT=20;Object.defineProperties(cc.V2F_C4B_T2F.prototype,{vertices:{get:function(){return this._vertices},set:function(a){this._vertices.x=a.x;this._vertices.y=a.y},enumerable:!0},colors:{get:function(){return this._colors},
set:function(a){var b=this._colors;b.r=a.r;b.g=a.g;b.b=a.b;b.a=a.a},enumerable:!0},texCoords:{get:function(){return this._texCoords},set:function(a){this._texCoords.u=a.u;this._texCoords.v=a.v},enumerable:!0}});cc.V2F_C4B_T2F_Triangle=function(a,b,d,e,f){this._arrayBuffer=e||new ArrayBuffer(cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT);this._offset=f||0;e=this._arrayBuffer;f=this._offset;var g=cc.V2F_C4B_T2F.BYTES_PER_ELEMENT;this._a=a?new cc.V2F_C4B_T2F(a.vertices,a.colors,a.texCoords,e,f):new cc.V2F_C4B_T2F(null,
null,null,e,f);this._b=b?new cc.V2F_C4B_T2F(b.vertices,b.colors,b.texCoords,e,f+g):new cc.V2F_C4B_T2F(null,null,null,e,f+g);this._c=d?new cc.V2F_C4B_T2F(d.vertices,d.colors,d.texCoords,e,f+2*g):new cc.V2F_C4B_T2F(null,null,null,e,f+2*g)};cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT=60;Object.defineProperties(cc.V2F_C4B_T2F_Triangle.prototype,{a:{get:function(){return this._a},set:function(a){var b=this._a;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords},enumerable:!0},b:{get:function(){return this._b},
set:function(a){var b=this._b;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords},enumerable:!0},c:{get:function(){return this._c},set:function(a){var b=this._c;b.vertices=a.vertices;b.colors=a.colors;b.texCoords=a.texCoords},enumerable:!0}})};cc._tmp.PrototypeColor=function(){var a=cc.color;a._getWhite=function(){return a(255,255,255)};a._getYellow=function(){return a(255,255,0)};a._getBlue=function(){return a(0,0,255)};a._getGreen=function(){return a(0,255,0)};a._getRed=function(){return a(255,0,0)};a._getMagenta=function(){return a(255,0,255)};a._getBlack=function(){return a(0,0,0)};a._getOrange=function(){return a(255,127,0)};a._getGray=function(){return a(166,166,166)};cc.defineGetterSetter(a,"WHITE",a._getWhite);cc.defineGetterSetter(a,
...
a},_initFrameSize:function(){var a=this._frameSize;a.width=cc.__BrowserGetter.availWidth(this._frame);a.height=cc.__BrowserGetter.availHeight(this._frame)},_adjustSizeKeepCanvasSize:function(){var a=this._originalDesignResolutionSize.width,c=this._originalDesignResolutionSize.height;0<a&&this.setDesignResolutionSize(a,c,this._resolutionPolicy)},_setViewPortMeta:function(){if(this._isAdjustViewPort){var a=document.getElementById("cocosMetaElement");a&&document.head.removeChild(a);var c,b=(a=document.getElementsByName("viewport"))?
a[0]:null,d,a=cc.newElement("meta");a.id="cocosMetaElement";a.name="viewport";a.content="";c=cc.__BrowserGetter.meta;d=b?b.content:"";for(var e in c)RegExp(e).test(d)||(d+=","+e+"\x3d"+c[e]);/^,/.test(d)&&(d=d.substr(1));a.content=d;b&&(b.content=d);document.head.appendChild(a)}},_setScaleXYForRenderTexture:function(){var a=cc.contentScaleFactor();this._scaleY=this._scaleX=a},_resetScale:function(){this._scaleX=this._originalScaleX;this._scaleY=this._originalScaleY},_adjustSizeToBrowser:function(){},
...
swapBuffers:function(){},setIMEKeyboardState:function(a){},setContentTranslateLeftTop:function(a,c){this._contentTranslateLeftTop={left:a,top:c}},getContentTranslateLeftTop:function(){return this._contentTranslateLeftTop},getFrameSize:function(){return cc.size(this._frameSize.width,this._frameSize.height)},setFrameSize:function(a,c){this._frameSize.width=a;this._frameSize.height=c;this._frame.style.width=a+"px";this._frame.style.height=c+"px";this._resizeEvent();cc.director.setProjection(cc.director.getProjection())},
centerWindow:function(){},getVisibleSize:function(){return cc.size(this._visibleRect.width,this._visibleRect.height)},getVisibleOrigin:function(){return cc.p(this._visibleRect.x,this._visibleRect.y)},canSetContentScaleFactor:function(){return!0},getResolutionPolicy:function(){return this._resolutionPolicy},setResolutionPolicy:function(a){if(a instanceof cc.ResolutionPolicy)this._resolutionPolicy=a;else{var c=cc.ResolutionPolicy;a===c.EXACT_FIT&&(this._resolutionPolicy=this._rpExactFit);a===c.SHOW_ALL&&
(this._resolutionPolicy=this._rpShowAll);a===c.NO_BORDER&&(this._resolutionPolicy=this._rpNoBorder);a===c.FIXED_HEIGHT&&(this._resolutionPolicy=this._rpFixedHeight);a===c.FIXED_WIDTH&&(this._resolutionPolicy=this._rpFixedWidth)}},setDesignResolutionSize:function(a,c,b){if(0<a||0<c)if(this.setResolutionPolicy(b),b=this._resolutionPolicy){b.preApply(this);cc.sys.isMobile&&this._setViewPortMeta();this._initFrameSize();this._originalDesignResolutionSize.width=this._designResolutionSize.width=a;this._originalDesignResolutionSize.height=
this._designResolutionSize.height=c;var d=b.apply(this,this._designResolutionSize);d.scale&&2==d.scale.length&&(this._scaleX=d.scale[0],this._scaleY=d.scale[1]);d.viewport&&(a=this._viewPortRect,c=this._visibleRect,d=d.viewport,a.x=d.x,a.y=d.y,a.width=d.width,a.height=d.height,c.x=-a.x/this._scaleX,c.y=-a.y/this._scaleY,c.width=cc._canvas.width/this._scaleX,c.height=cc._canvas.height/this._scaleY,cc._renderContext.setOffset&&cc._renderContext.setOffset(a.x,-a.y));a=cc.director;a._winSizeInPoints.width=
this._designResolutionSize.width;a._winSizeInPoints.height=this._designResolutionSize.height;b.postApply(this);cc.winSize.width=a._winSizeInPoints.width;cc.winSize.height=a._winSizeInPoints.height;cc._renderType==cc._RENDER_TYPE_WEBGL&&(a._createStatsLabel(),a.setGLDefaultValues());this._originalScaleX=this._scaleX;this._originalScaleY=this._scaleY;cc.DOM&&cc.DOM._resetEGLViewDiv();cc.visibleRect&&cc.visibleRect.init(this._visibleRect)}else cc.log(cc._LogInfos.EGLView_setDesignResolutionSize_2);else cc.log(cc._LogInfos.EGLView_setDesignResolutionSize)},
getDesignResolutionSize:function(){return cc.size(this._designResolutionSize.width,this._designResolutionSize.height)},setViewPortInPoints:function(a,c,b,d){var e=this._frameZoomFactor,f=this._scaleX,g=this._scaleY;cc._renderContext.viewport(a*f*e+this._viewPortRect.x*e,c*g*e+this._viewPortRect.y*e,b*f*e,d*g*e)},setScissorInPoints:function(a,c,b,d){var e=this._frameZoomFactor,f=this._scaleX,g=this._scaleY;cc._renderContext.scissor(a*f*e+this._viewPortRect.x*e,c*g*e+this._viewPortRect.y*e,b*f*e,d*
g*e)},isScissorEnabled:function(){var a=cc._renderContext;return a.isEnabled(a.SCISSOR_TEST)},getScissorRect:function(){var a=cc._renderContext,c=this._scaleX,b=this._scaleY,a=a.getParameter(a.SCISSOR_BOX);return cc.rect((a[0]-this._viewPortRect.x)/c,(a[1]-this._viewPortRect.y)/b,a[2]/c,a[3]/b)},setViewName:function(a){null!=a&&0<a.length&&(this._viewName=a)},getViewName:function(){return this._viewName},getViewPortRect:function(){return this._viewPortRect},getScaleX:function(){return this._scaleX},
getScaleY:function(){return this._scaleY},getDevicePixelRatio:function(){return this._devicePixelRatio},convertToLocationInView:function(a,c,b){return{x:this._devicePixelRatio*(a-b.left),y:this._devicePixelRatio*(b.top+b.height-c)}},_convertMouseToLocationInView:function(a,c){var b=this._viewPortRect;a.x=(this._devicePixelRatio*(a.x-c.left)-b.x)/this._scaleX;a.y=(this._devicePixelRatio*(c.top+c.height-a.y)-b.y)/this._scaleY},_convertTouchesWithScale:function(a){for(var c=this._viewPortRect,b=this._scaleX,
d=this._scaleY,e,f,g,h=0;h<a.length;h++)e=a[h],f=e._point,g=e._prevPoint,e._setPoint((f.x-c.x)/b,(f.y-c.y)/d),e._setPrevPoint((g.x-c.x)/b,(g.y-c.y)/d)}});cc.EGLView._getInstance=function(){this._instance||(this._instance=this._instance||new cc.EGLView,this._instance.initialize());return this._instance};
...
(function(){var a=cc.ContainerStrategy.extend({apply:function(a){this._setupContainer(a,a._frameSize.width,a._frameSize.height)}}),c=cc.ContainerStrategy.extend({apply:function(a,c){var b=a._frameSize.width,d=a._frameSize.height,e=cc.container.style,p=c.width,n=c.height,r=b/p,s=d/n,u,t;r<s?(u=b,t=n*r):(u=p*s,t=d);p=Math.round((b-u)/2);t=Math.round((d-t)/2);this._setupContainer(a,b-2*p,d-2*t);e.marginLeft=p+"px";e.marginRight=p+"px";e.marginTop=t+"px";e.marginBottom=t+"px"}});a.extend({preApply:function(a){this._super(a);
...
c){var b=cc._canvas.width,d=cc._canvas.height;return this._buildResult(b,d,b,d,b/c.width,d/c.height)}}),c=cc.ContentStrategy.extend({apply:function(a,c){var b=cc._canvas.width,d=cc._canvas.height,e=c.width,p=c.height,n=b/e,r=d/p,s=0,u,t;n<r?(s=n,u=b,t=p*s):(s=r,u=e*s,t=d);return this._buildResult(b,d,u,t,s,s)}}),b=cc.ContentStrategy.extend({apply:function(a,c){var b=cc._canvas.width,d=cc._canvas.height,e=c.width,p=c.height,n=b/e,r=d/p,s,u,t;n<r?(s=r,u=e*s,t=d):(s=n,u=b,t=p*s);return this._buildResult(b,
...
cc.rectApplyAffineTransform=function(a,c){var b=cc.rectGetMinY(a),d=cc.rectGetMinX(a),e=cc.rectGetMaxX(a),f=cc.rectGetMaxY(a),g=cc._pointApplyAffineTransform(d,b,c),b=cc._pointApplyAffineTransform(e,b,c),d=cc._pointApplyAffineTransform(d,f,c),h=cc._pointApplyAffineTransform(e,f,c),e=Math.min(g.x,b.x,d.x,h.x),f=Math.max(g.x,b.x,d.x,h.x),k=Math.min(g.y,b.y,d.y,h.y),g=Math.max(g.y,b.y,d.y,h.y);return cc.rect(e,k,f-e,g-k)};
cc._rectApplyAffineTransformIn=function(a,c){var b=cc.rectGetMinY(a),d=cc.rectGetMinX(a),e=cc.rectGetMaxX(a),f=cc.rectGetMaxY(a),g=cc._pointApplyAffineTransform(d,b,c),b=cc._pointApplyAffineTransform(e,b,c),d=cc._pointApplyAffineTransform(d,f,c),h=cc._pointApplyAffineTransform(e,f,c),e=Math.min(g.x,b.x,d.x,h.x),f=Math.max(g.x,b.x,d.x,h.x),k=Math.min(g.y,b.y,d.y,h.y),g=Math.max(g.y,b.y,d.y,h.y);a.x=e;a.y=k;a.width=f-e;a.height=g-k;return a};
...
cc.pForAngle=function(a){return cc.p(Math.cos(a),Math.sin(a))};cc.pToAngle=function(a){return Math.atan2(a.y,a.x)};cc.clampf=function(a,c,b){if(c>b){var d=c;c=b;b=d}return a<c?c:a<b?a:b};cc.pClamp=function(a,c,b){return cc.p(cc.clampf(a.x,c.x,b.x),cc.clampf(a.y,c.y,b.y))};cc.pFromSize=function(a){return cc.p(a.width,a.height)};cc.pCompOp=function(a,c){return cc.p(c(a.x),c(a.y))};cc.pLerp=function(a,c,b){return cc.pAdd(cc.pMult(a,1-b),cc.pMult(c,b))};
cc.pFuzzyEqual=function(a,c,b){return a.x-b<=c.x&&c.x<=a.x+b&&a.y-b<=c.y&&c.y<=a.y+b?!0:!1};cc.pCompMult=function(a,c){return cc.p(a.x*c.x,a.y*c.y)};cc.pAngleSigned=function(a,c){var b=cc.pNormalize(a),d=cc.pNormalize(c),b=Math.atan2(b.x*d.y-b.y*d.x,cc.pDot(b,d));return Math.abs(b)<cc.POINT_EPSILON?0:b};cc.pAngle=function(a,c){var b=Math.acos(cc.pDot(cc.pNormalize(a),cc.pNormalize(c)));return Math.abs(b)<cc.POINT_EPSILON?0:b};
...
cc.pSubIn=function(a,c){a.x-=c.x;a.y-=c.y};cc.pAddIn=function(a,c){a.x+=c.x;a.y+=c.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,c,b,d,e){e+=d;if(!(1>=e)){c*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var p=cc.p(a[2*(h+1)],a[2*(h+1)+1]),n=cc.pNormalize(cc.pSub(p,k)),r=cc.pNormalize(cc.pSub(m,k)),s=Math.acos(cc.pDot(n,r));m=s<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(n,
r))):s<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(n,r)):cc.pPerp(cc.pNormalize(cc.pSub(p,m)))}m=cc.pMult(m,c);b[2*f]=k.x+m.x;b[2*f+1]=k.y+m.y;b[2*(f+1)]=k.x-m.x;b[2*(f+1)+1]=k.y-m.y}for(h=0==d?0:d-1;h<g;h++){f=2*h;a=f+2;c=cc.vertex2(b[2*f],b[2*f+1]);e=cc.vertex2(b[2*(f+1)],b[2*(f+1)+1]);f=cc.vertex2(b[2*a],b[2*a]);d=cc.vertex2(b[2*(a+1)],b[2*(a+1)+1]);c=!cc.vertexLineIntersect(c.x,c.y,d.x,d.y,e.x,e.y,f.x,f.y);if(!c.isSuccess&&(0>c.value||1<c.value))c.isSuccess=!0;c.isSuccess&&(b[2*a]=d.x,
...
d.length&&(this._nodePriorityIndex=0,this._nodePriorityMap={},this._visitTarget(c,!0),b.getSceneGraphPriorityListeners().sort(this._sortEventListenersOfSceneGraphPriorityDes))}},_sortEventListenersOfSceneGraphPriorityDes:function(a,c){var b=cc.eventManager._nodePriorityMap;return!a||!c||!a._getSceneGraphPriority()||!c._getSceneGraphPriority()?-1:b[c._getSceneGraphPriority().__instanceId]-b[a._getSceneGraphPriority().__instanceId]},_sortListenersOfFixedPriority:function(a){if(a=this._listenersMap[a]){var c=
a.getFixedPriorityListeners();if(c&&0!==c.length){c.sort(this._sortListenersOfFixedPriorityAsc);for(var b=0,d=c.length;b<d&&!(0<=c[b]._getFixedPriority());)++b;a.gt0Index=b}}},_sortListenersOfFixedPriorityAsc:function(a,c){return a._getFixedPriority()-c._getFixedPriority()},_onUpdateListeners:function(a){if(a=this._listenersMap[a]){var c=a.getFixedPriorityListeners(),b=a.getSceneGraphPriorityListeners(),d,e;if(b)for(d=0;d<b.length;)e=b[d],e._isRegistered()?++d:cc.arrayRemoveObject(b,e);if(c)for(d=
0;d<c.length;)e=c[d],e._isRegistered()?++d:cc.arrayRemoveObject(c,e);b&&0===b.length&&a.clearSceneGraphListeners();c&&0===c.length&&a.clearFixedListeners()}},_updateListeners:function(a){var c=this._inDispatch;cc.assert(0<c,cc._LogInfos.EventManager__updateListeners);a.getType()==cc.Event.TOUCH?(this._onUpdateListeners(cc._EventListenerTouchOneByOne.LISTENER_ID),this._onUpdateListeners(cc._EventListenerTouchAllAtOnce.LISTENER_ID)):this._onUpdateListeners(cc.__getListenerID(a));if(!(1<c)){cc.assert(1==
c,cc._LogInfos.EventManager__updateListeners_2);a=this._listenersMap;var c=this._priorityDirtyFlagMap,b;for(b in a)a[b].empty()&&(delete c[b],delete a[b]);b=this._toAddedListeners;if(0!==b.length){a=0;for(c=b.length;a<c;a++)this._forceAddEventListener(b[a]);this._toAddedListeners.length=0}}},_onTouchEventCallback:function(a,c){if(!a._isRegistered)return!1;var b=c.event,d=c.selTouch;b._setCurrentTarget(a._node);var e=!1,f,g=b.getEventCode(),h=cc.EventTouch.EventCode;if(g==h.BEGAN)a.onTouchBegan&&(e=
a.onTouchBegan(d,b))&&a._registered&&a._claimedTouches.push(d);else if(0<a._claimedTouches.length&&-1!=(f=a._claimedTouches.indexOf(d)))if(e=!0,g===h.MOVED&&a.onTouchMoved)a.onTouchMoved(d,b);else if(g===h.ENDED){if(a.onTouchEnded)a.onTouchEnded(d,b);a._registered&&a._claimedTouches.splice(f,1)}else if(g===h.CANCELLED){if(a.onTouchCancelled)a.onTouchCancelled(d,b);a._registered&&a._claimedTouches.splice(f,1)}return b.isStopped()?(cc.eventManager._updateListeners(b),!0):e&&a._registered&&a.swallowTouches?
...
a&&(this._visible=a,this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty),cc.renderer.childrenOrderDirty=!0)},getAnchorPoint:function(){return cc.p(this._anchorPoint)},setAnchorPoint:function(a,c){var b=this._anchorPoint;if(void 0===c){if(a.x===b.x&&a.y===b.y)return;b.x=a.x;b.y=a.y}else{if(a===b.x&&c===b.y)return;b.x=a;b.y=c}this._renderCmd._updateAnchorPointInPoint()},_getAnchorX:function(){return this._anchorPoint.x},_setAnchorX:function(a){this._anchorPoint.x!==a&&(this._anchorPoint.x=
...
this._cascadeOpacityEnabled&&a._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.opacityDirty)},removeFromParent:function(a){this._parent&&(null==a&&(a=!0),this._parent.removeChild(this,a))},removeFromParentAndCleanup:function(a){cc.log(cc._LogInfos.Node_removeFromParentAndCleanup);this.removeFromParent(a)},removeChild:function(a,c){0!==this._children.length&&(null==c&&(c=!0),-1<this._children.indexOf(a)&&this._detachChild(a,c),cc.renderer.childrenOrderDirty=!0)},removeChildByTag:function(a,c){a===cc.NODE_TAG_INVALID&&
cc.log(cc._LogInfos.Node_removeChildByTag);var b=this.getChildByTag(a);null==b?cc.log(cc._LogInfos.Node_removeChildByTag_2,a):this.removeChild(b,c)},removeAllChildrenWithCleanup:function(a){this.removeAllChildren(a)},removeAllChildren:function(a){var c=this._children;if(null!=c){null==a&&(a=!0);for(var b=0;b<c.length;b++){var d=c[b];d&&(this._running&&(d.onExitTransitionDidStart(),d.onExit()),a&&d.cleanup(),d.parent=null)}this._children.length=0}},_detachChild:function(a,c){this._running&&(a.onExitTransitionDidStart(),
a.onExit());c&&a.cleanup();a.parent=null;a._renderCmd.detachFromParent();cc.arrayRemoveObject(this._children,a)},_insertChild:function(a,c){cc.renderer.childrenOrderDirty=this._reorderChildDirty=!0;this._children.push(a);a._setLocalZOrder(c)},setNodeDirty:function(){this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},reorderChild:function(a,c){cc.assert(a,cc._LogInfos.Node_reorderChild);cc.renderer.childrenOrderDirty=this._reorderChildDirty=!0;a.arrivalOrder=cc.s_globalOrderOfArrival;
cc.s_globalOrderOfArrival++;a._setLocalZOrder(c)},sortAllChildren:function(){if(this._reorderChildDirty){var a=this._children,c=a.length,b,d,e;for(b=1;b<c;b++){e=a[b];for(d=b-1;0<=d;){if(e._localZOrder<a[d]._localZOrder)a[d+1]=a[d];else if(e._localZOrder===a[d]._localZOrder&&e.arrivalOrder<a[d].arrivalOrder)a[d+1]=a[d];else break;d--}a[d+1]=e}this._reorderChildDirty=!1}},draw:function(a){},transformAncestors:function(){null!=this._parent&&(this._parent.transformAncestors(),this._parent.transform())},
...
schedule:function(a,c,b,d){c=c||0;cc.assert(a,cc._LogInfos.Node_schedule);cc.assert(0<=c,cc._LogInfos.Node_schedule_2);b=null==b?cc.REPEAT_FOREVER:b;this.scheduler.scheduleCallbackForTarget(this,a,c,b,d||0,!this._running)},scheduleOnce:function(a,c){this.schedule(a,0,0,c)},unschedule:function(a){a&&this.scheduler.unscheduleCallbackForTarget(this,a)},unscheduleAllCallbacks:function(){this.scheduler.unscheduleAllCallbacksForTarget(this)},resumeSchedulerAndActions:function(){cc.log(cc._LogInfos.Node_resumeSchedulerAndActions);
...
b=this._children;a=0;for(c=b.length;a<c;a++)(d=b[a])&&d._renderCmd&&d._renderCmd._updateDisplayOpacity(255);this._cascadeOpacityEnabledDirty=!1}else if(void 0===a&&(b=c._parent,a=255,b&&b._cascadeOpacityEnabled&&(a=b.getDisplayedOpacity())),this._displayedOpacity=c._realOpacity*a/255,c._cascadeOpacityEnabled){b=c._children;a=0;for(c=b.length;a<c;a++)if((d=b[a])&&d._renderCmd)d._renderCmd._updateDisplayOpacity(this._displayedOpacity),d._renderCmd._updateColor()}this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.opacityDirty},
...
f.tx+-(g.b+g.c)*d.ty;e.ty=d.tx*f.b+d.ty*f.d+f.ty+h}else e.a=d.a,e.b=d.b,e.c=d.c,e.d=d.d,e.tx=d.tx,e.ty=d.ty;if(b&&(d=this._node._children)&&0!==d.length){e=0;for(f=d.length;e<f;e++)d[e]._renderCmd.transform(this,b)}};a.getNodeToParentTransform=function(){var a=this._node,b=!1;a._usingNormalizedPosition&&a._parent&&(b=a._parent._contentSize,a._position.x=a._normalizedPosition.x*b.width,a._position.y=a._normalizedPosition.y*b.height,a._normalizedPositionDirty=!1,b=!0);if(b||this._dirtyFlag&cc.Node._dirtyFlags.transformDirty){b=
this._transform;b.tx=a._position.x;b.ty=a._position.y;var d=1,e=0;a._rotationX&&(e=0.017453292519943295*a._rotationX,d=Math.cos(e),e=Math.sin(e));b.a=b.d=d;b.b=-e;b.c=e;var f=a._scaleX,g=a._scaleY,h=this._anchorPointInPoints.x,k=this._anchorPointInPoints.y,m=1E-6>f&&-1E-6<f?1E-6:f,p=1E-6>g&&-1E-6<g?1E-6:g;if(a._skewX||a._skewY){var n=Math.tan(-a._skewX*Math.PI/180),r=Math.tan(-a._skewY*Math.PI/180);Infinity===n&&(n=99999999);Infinity===r&&(r=99999999);var s=k*n*m,u=h*r*p;b.a=d+-e*r;b.b=d*n+-e;b.c=
e+d*r;b.d=e*n+d;b.tx+=d*s+-e*u;b.ty+=e*s+d*u}if(1!==f||1!==g)b.a*=m,b.c*=m,b.b*=p,b.d*=p;b.tx+=d*-h*m+-e*k*p;b.ty-=e*-h*m+d*k*p;a._ignoreAnchorPointForPosition&&(b.tx+=h,b.ty+=k);a._additionalTransformDirty&&(this._transform=cc.affineTransformConcat(b,a._additionalTransform),a._additionalTransformDirty=!1)}return this._transform};a.visit=function(a){var b=this._node;if(b._visible){if(a=a||this.getParentRenderCmd())this._curLevel=a._curLevel+1;var d=b._children,e;this._syncStatus(a);a=d.length;if(0<
a){b.sortAllChildren();for(b=0;b<a;b++)if(e=d[b],0>e._localZOrder)e._renderCmd.visit(this);else break;for(cc.renderer.pushRenderCommand(this);b<a;b++)d[b]._renderCmd.visit(this)}else cc.renderer.pushRenderCommand(this);this._dirtyFlag=0}};a._syncStatus=function(a){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,e=a?a._node:null;e&&(e._cascadeColorEnabled&&a._dirtyFlag&b.colorDirty)&&(d|=b.colorDirty);e&&(e._cascadeOpacityEnabled&&a._dirtyFlag&b.opacityDirty)&&(d|=b.opacityDirty);a&&a._dirtyFlag&b.transformDirty&&
...
!1,this.dispatchEvent("load"))}},initWithString:function(a,c,b,d,e,f){cc.log(cc._LogInfos.Texture2D_initWithString);return null},initWithETCFile:function(a){cc.log(cc._LogInfos.Texture2D_initWithETCFile_2);return!1},initWithPVRFile:function(a){cc.log(cc._LogInfos.Texture2D_initWithPVRFile_2);return!1},initWithPVRTCData:function(a,c,b,d,e,f){cc.log(cc._LogInfos.Texture2D_initWithPVRTCData_2);return!1},setTexParameters:function(a,c,b,d){var e=cc._renderContext;void 0!==c&&(a={minFilter:a,magFilter:c,
wrapS:b,wrapT:d});cc.assert(this._pixelsWide==cc.NextPOT(this._pixelsWide)&&this._pixelsHigh==cc.NextPOT(this._pixelsHigh)||a.wrapS==e.CLAMP_TO_EDGE&&a.wrapT==e.CLAMP_TO_EDGE,"WebGLRenderingContext.CLAMP_TO_EDGE should be used in NPOT textures");cc.glBindTexture2D(this);e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,a.minFilter);e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,a.magFilter);e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,a.wrapS);e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,a.wrapT)},
...
var c=cc.Texture2D._B[a];if(null!=c)return c;cc.log(cc._LogInfos.Texture2D_bitsPerPixelForFormat,a);return-1},_initPremultipliedATextureWithImage:function(a,c,b){var d=cc.Texture2D,e=a.getData(),f=null,f=null,g=a.hasAlpha(),h=cc.size(a.getWidth(),a.getHeight()),k=d.defaultPixelFormat,m=a.getBitsPerComponent();g||(8<=m?k=d.PIXEL_FORMAT_RGB888:(cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),k=d.PIXEL_FORMAT_RGB565));var p=c*b;if(k==d.PIXEL_FORMAT_RGB565)if(g){e=new Uint16Array(c*
b);f=a.getData();for(m=0;m<p;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>2<<5|(f[m]>>16&255)>>3<<0}else{e=new Uint16Array(c*b);f=a.getData();for(m=0;m<p;++m)e[m]=(f[m]&255)>>3<<11|(f[m]&255)>>2<<5|(f[m]&255)>>3<<0}else if(k==d.PIXEL_FORMAT_RGBA4444){e=new Uint16Array(c*b);f=a.getData();for(m=0;m<p;++m)e[m]=(f[m]>>0&255)>>4<<12|(f[m]>>8&255)>>4<<8|(f[m]>>16&255)>>4<<4|(f[m]>>24&255)>>4<<0}else if(k==d.PIXEL_FORMAT_RGB5A1){e=new Uint16Array(c*b);f=a.getData();for(m=0;m<p;++m)e[m]=(f[m]>>0&255)>>3<<
11|(f[m]>>8&255)>>3<<6|(f[m]>>16&255)>>3<<1|(f[m]>>24&255)>>7<<0}else if(k==d.PIXEL_FORMAT_A8){e=new Uint8Array(c*b);f=a.getData();for(m=0;m<p;++m)e[m]=f>>24&255}if(g&&k==d.PIXEL_FORMAT_RGB888){f=a.getData();e=new Uint8Array(3*c*b);for(m=0;m<p;++m)e[3*m]=f>>0&255,e[3*m+1]=f>>8&255,e[3*m+2]=f>>16&255}this.initWithData(e,k,c,b,h);a.getData();this._hasPremultipliedAlpha=a.isPremultipliedAlpha();return!0},addLoadedEventListener:function(a,c){this.addEventListener("load",a,c)},removeLoadedEventListener:function(a){this.removeEventListener("load",
a)}})};
...
cc._tmp.WebGLTextureCache=function(){var a=cc.textureCache;a.handleLoadedTexture=function(a){var b=this._textures;cc._rendererInitialized||(b=this._loadedTexturesBefore);var d=b[a];d||(d=b[a]=new cc.Texture2D,d.url=a);d.handleLoadedTexture()};a.addImage=function(a,b,d){cc.assert(a,cc._LogInfos.Texture2D_addImage_2);var e=this._textures;cc._rendererInitialized||(e=this._loadedTexturesBefore);var f=e[a]||e[cc.loader._aliases[a]];if(f)return b&&b.call(d,f),f;f=e[a]=new cc.Texture2D;f.url=a;(cc.loader._checkIsImageURL(a)?
cc.loader.load:cc.loader.loadImg).call(cc.loader,a,function(f,h){if(f)return b&&b.call(d,f);cc.textureCache.handleLoadedTexture(a);var k=e[a];b&&b.call(d,k)});return f};a=null};cc._tmp.PrototypeTexture2D=function(){var a=cc.Texture2D;a.PVRImagesHavePremultipliedAlpha=function(a){cc.PVRHaveAlphaPremultiplied_=a};a.PIXEL_FORMAT_RGBA8888=2;a.PIXEL_FORMAT_RGB888=3;a.PIXEL_FORMAT_RGB565=4;a.PIXEL_FORMAT_A8=5;a.PIXEL_FORMAT_I8=6;a.PIXEL_FORMAT_AI88=7;a.PIXEL_FORMAT_RGBA4444=8;a.PIXEL_FORMAT_RGB5A1=7;a.PIXEL_FORMAT_PVRTC4=9;a.PIXEL_FORMAT_PVRTC2=10;a.PIXEL_FORMAT_DEFAULT=a.PIXEL_FORMAT_RGBA8888;var c=cc.Texture2D._M={};c[a.PIXEL_FORMAT_RGBA8888]="RGBA8888";c[a.PIXEL_FORMAT_RGB888]=
...
a&&this._textures[a]&&delete this._textures[a]},cacheImage:function(a,c){if(c instanceof cc.Texture2D)this._textures[a]=c;else{var b=new cc.Texture2D;b.initWithElement(c);b.handleLoadedTexture();this._textures[a]=b}},addUIImage:function(a,c){cc.assert(a,cc._LogInfos.textureCache_addUIImage_2);if(c&&this._textures[c])return this._textures[c];var b=new cc.Texture2D;b.initWithImage(a);null!=c&&null!=b?this._textures[c]=b:cc.log(cc._LogInfos.textureCache_addUIImage);return b},dumpCachedTextureInfo:function(){var a=
...
cc.LayerGradient=cc.LayerColor.extend({_endColor:null,_startOpacity:255,_endOpacity:255,_alongVector:null,_compressedInterpolation:!1,_className:"LayerGradient",ctor:function(a,c,b){cc.LayerColor.prototype.ctor.call(this);this._endColor=cc.color(0,0,0,255);this._alongVector=cc.p(0,-1);this._endOpacity=this._startOpacity=255;cc.LayerGradient.prototype.init.call(this,a,c,b)},init:function(a,c,b){a=a||cc.color(0,0,0,255);c=c||cc.color(0,0,0,255);b=b||cc.p(0,-1);var d=this._endColor;this._startOpacity=
a.a;d.r=c.r;d.g=c.g;d.b=c.b;this._endOpacity=c.a;this._alongVector=b;this._compressedInterpolation=!0;cc.LayerColor.prototype.init.call(this,cc.color(a.r,a.g,a.b,255));this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.colorDirty|cc.Node._dirtyFlags.opacityDirty|cc.Node._dirtyFlags.gradientDirty);return!0},setContentSize:function(a,c){cc.LayerColor.prototype.setContentSize.call(this,a,c);this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.gradientDirty)},_setWidth:function(a){cc.LayerColor.prototype._setWidth.call(this,
...
a;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.gradientDirty)},_createRenderCmd:function(){return cc._renderType===cc._RENDER_TYPE_CANVAS?new cc.LayerGradient.CanvasRenderCmd(this):new cc.LayerGradient.WebGLRenderCmd(this)}});cc.LayerGradient.create=function(a,c,b){return new cc.LayerGradient(a,c,b)};
...
new cc.BakeSprite,this._bakeSprite._parent=this._node)}};a.unbake=function(){if(this._isBaked){cc.renderer.childrenOrderDirty=!0;this._isBaked=this._needDraw=!1;this._cacheDirty=!0;for(var a=this._node._children,b=0,d=a.length;b<d;b++)a[b]._renderCmd._setCachedParent(null)}};a.isBaked=function(){return this._isBaked};a.rendering=function(){if(this._cacheDirty){var a=this._node,b=a._children,d=this._bakeSprite;this.transform(this.getParentRenderCmd(),!0);var e=this._getBoundingBoxForBake();e.width=
0|e.width+0.5;e.height=0|e.height+0.5;var f=d.getCacheContext(),g=f.getContext();d.resetCanvasSize(e.width,e.height);var h=d.getAnchorPointInPoints(),k=a._position;if(a._ignoreAnchorPointForPosition)f.setOffset(0-e.x,g.canvas.height-e.height+e.y),d.setPosition(h.x+e.x-k.x,h.y+e.y-k.y);else{var m=this.getAnchorPointInPoints(),p=k.x-m.x,k=k.y-m.y;f.setOffset(0-e.x,g.canvas.height-e.height+e.y);d.setPosition(h.x+e.x-p,h.y+e.y-k)}a.sortAllChildren();cc.renderer._turnToCacheMode(this.__instanceId);a=0;
for(e=b.length;a<e;a++)b[a].visit(this);cc.renderer._renderingToCacheCanvas(f,this.__instanceId);d.transform(this);this._cacheDirty=!1}};a.visit=function(a){if(this._isBaked){var b=this._node,d=b._children.length;b._visible&&0!==d&&(this._syncStatus(a),cc.renderer.pushRenderCommand(this),this._bakeSprite.visit(this),this._dirtyFlag=0)}else cc.Node.CanvasRenderCmd.prototype.visit.call(this,a)};a._bakeForAddChild=function(a){a._parent==this._node&&this._isBaked&&a._renderCmd._setCachedParent(this)};
a._getBoundingBoxForBake=function(){var a=null,b=this._node;if(!b._children||0===b._children.length)return cc.rect(0,0,10,10);for(var d=b.getNodeToWorldTransform(),b=b._children,e=0,f=b.length;e<f;e++){var g=b[e];g&&g._visible&&(a?(g=g._getBoundingBoxToCurrentNode(d))&&(a=cc.rectUnion(a,g)):a=g._getBoundingBoxToCurrentNode(d))}return a}})();
...
a._updateSquareVerticesHeight=function(){};a._bakeRendering=function(){if(this._cacheDirty){var a=this._node,b=this._bakeSprite,d=a._children,e=d.length;this.transform(this.getParentRenderCmd(),!0);var f=this._getBoundingBoxForBake();f.width=0|f.width+0.5;f.height=0|f.height+0.5;var g=b.getCacheContext(),h=g.getContext();b.resetCanvasSize(f.width,f.height);var k=b.getAnchorPointInPoints(),m=a._position;if(a._ignoreAnchorPointForPosition)g.setOffset(0-f.x,h.canvas.height-f.height+f.y),b.setPosition(k.x+
f.x-m.x,k.y+f.y-m.y);else{var p=this.getAnchorPointInPoints(),n=m.x-p.x,m=m.y-p.y;g.setOffset(0-f.x,h.canvas.height-f.height+f.y);b.setPosition(k.x+f.x-n,k.y+f.y-m)}cc.renderer._turnToCacheMode(this.__instanceId);if(0<e){a.sortAllChildren();for(a=0;a<e;a++)if(f=d[a],0>f._localZOrder)f._renderCmd.visit(this);else break;for(cc.renderer.pushRenderCommand(this);a<e;a++)d[a]._renderCmd.visit(this)}else cc.renderer.pushRenderCommand(this);cc.renderer._renderingToCacheCanvas(g,this.__instanceId);b.transform(this);
this._cacheDirty=!1}};a.visit=function(a){this._isBaked?this._node._visible&&(this._syncStatus(a),cc.renderer.pushRenderCommand(this._bakeRenderCmd),this._bakeSprite._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty),this._bakeSprite.visit(this),this._dirtyFlag=0):cc.Node.CanvasRenderCmd.prototype.visit.call(this)};a._getBoundingBoxForBake=function(){var a=this._node,b=cc.rect(0,0,a._contentSize.width,a._contentSize.height),d=a.getNodeToWorldTransform(),b=cc.rectApplyAffineTransform(b,a.getNodeToWorldTransform());
if(!a._children||0===a._children.length)return b;for(var a=a._children,e=0;e<a.length;e++){var f=a[e];f&&f._visible&&(f=f._getBoundingBoxToCurrentNode(d),b=cc.rectUnion(b,f))}return b}})();
...
0,0,255,b,2*e),cc.color(0,0,0,255,b,3*e)];this._verticesFloat32Buffer=cc._renderContext.createBuffer();this._colorsUint8Buffer=cc._renderContext.createBuffer()};var a=cc.LayerColor.WebGLRenderCmd.prototype=Object.create(cc.Layer.WebGLRenderCmd.prototype);a.constructor=cc.LayerColor.WebGLRenderCmd;cc.LayerColor.WebGLRenderCmd.prototype.rendering=function(a){a=a||cc._renderContext;var b=this._node;this._shaderProgram.use();this._shaderProgram._setUniformForMVPMatrixWithMat4(this._stackMatrix);cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION|
cc.VERTEX_ATTRIB_FLAG_COLOR);cc.glBlendFunc(b._blendFunc.src,b._blendFunc.dst);a.bindBuffer(a.ARRAY_BUFFER,this._verticesFloat32Buffer);a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,2,a.FLOAT,!1,0,0);a.bindBuffer(a.ARRAY_BUFFER,this._colorsUint8Buffer);a.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,a.UNSIGNED_BYTE,!0,0,0);a.drawArrays(a.TRIANGLE_STRIP,0,4)};a._updateSquareVertices=function(a,b){var d=this._squareVertices;void 0===b?(d[1].x=a.width,d[2].y=a.height,d[3].x=a.width,d[3].y=a.height):
(d[1].x=a,d[2].y=b,d[3].x=a,d[3].y=b);this._bindLayerVerticesBufferData()};a._updateSquareVerticesWidth=function(a){var b=this._squareVertices;b[1].x=a;b[3].x=a;this._bindLayerVerticesBufferData()};a._updateSquareVerticesHeight=function(a){var b=this._squareVertices;b[2].y=a;b[3].y=a;this._bindLayerVerticesBufferData()};a._updateColor=function(){for(var a=this._displayedColor,b=this._displayedOpacity,d=this._squareColors,e=0;4>e;e++)d[e].r=a.r,d[e].g=a.g,d[e].b=a.b,d[e].a=b;this._bindLayerColorsBufferData()};
...
(function(){cc.LayerGradient.WebGLRenderCmd=function(a){cc.LayerColor.WebGLRenderCmd.call(this,a);this._needDraw=!0};var a=cc.LayerGradient.WebGLRenderCmd.prototype=Object.create(cc.LayerColor.WebGLRenderCmd.prototype);cc.inject(cc.LayerGradient.RenderCmd,a);a.constructor=cc.LayerGradient.WebGLRenderCmd;a._syncStatus=function(a){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,e=a?a._node:null;e&&(e._cascadeColorEnabled&&a._dirtyFlag&b.colorDirty)&&(d|=b.colorDirty);e&&(e._cascadeOpacityEnabled&&a._dirtyFlag&
b.opacityDirty)&&(d|=b.opacityDirty);a&&a._dirtyFlag&b.transformDirty&&(d|=b.transformDirty);var e=d&b.colorDirty,f=d&b.opacityDirty;this._dirtyFlag=d;e&&this._syncDisplayColor();f&&this._syncDisplayOpacity();this.transform(a);(e||f||d&b.gradientDirty)&&this._updateColor()};a._updateColor=function(){this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.gradientDirty;var a=this._node,b=a._alongVector,d=cc.pLength(b);if(0!==d){var e=Math.sqrt(2),b=cc.p(b.x/d,b.y/d);a._compressedInterpolation&&(d=1/(Math.abs(b.x)+
Math.abs(b.y)),b=cc.pMult(b,d*e));var f=this._displayedOpacity/255,d=this._displayedColor,g=a._endColor,d={r:d.r,g:d.g,b:d.b,a:a._startOpacity*f},a={r:g.r,g:g.g,b:g.b,a:a._endOpacity*f},h=this._squareColors,f=h[0],g=h[1],k=h[2],h=h[3];f.r=a.r+(d.r-a.r)*((e+b.x+b.y)/(2*e));f.g=a.g+(d.g-a.g)*((e+b.x+b.y)/(2*e));f.b=a.b+(d.b-a.b)*((e+b.x+b.y)/(2*e));f.a=a.a+(d.a-a.a)*((e+b.x+b.y)/(2*e));g.r=a.r+(d.r-a.r)*((e-b.x+b.y)/(2*e));g.g=a.g+(d.g-a.g)*((e-b.x+b.y)/(2*e));g.b=a.b+(d.b-a.b)*((e-b.x+b.y)/(2*e));
g.a=a.a+(d.a-a.a)*((e-b.x+b.y)/(2*e));k.r=a.r+(d.r-a.r)*((e+b.x-b.y)/(2*e));k.g=a.g+(d.g-a.g)*((e+b.x-b.y)/(2*e));k.b=a.b+(d.b-a.b)*((e+b.x-b.y)/(2*e));k.a=a.a+(d.a-a.a)*((e+b.x-b.y)/(2*e));h.r=a.r+(d.r-a.r)*((e-b.x-b.y)/(2*e));h.g=a.g+(d.g-a.g)*((e-b.x-b.y)/(2*e));h.b=a.b+(d.b-a.b)*((e-b.x-b.y)/(2*e));h.a=a.a+(d.a-a.a)*((e-b.x-b.y)/(2*e));this._bindLayerColorsBufferData()}}})();cc._tmp.PrototypeSprite=function(){var a=cc.Sprite.prototype;cc.defineGetterSetter(a,"opacityModifyRGB",a.isOpacityModifyRGB,a.setOpacityModifyRGB);cc.defineGetterSetter(a,"opacity",a.getOpacity,a.setOpacity);cc.defineGetterSetter(a,"color",a.getColor,a.setColor);cc.defineGetterSetter(a,"flippedX",a.isFlippedX,a.setFlippedX);cc.defineGetterSetter(a,"flippedY",a.isFlippedY,a.setFlippedY);cc.defineGetterSetter(a,"offsetX",a._getOffsetX);cc.defineGetterSetter(a,"offsetY",a._getOffsetY);cc.defineGetterSetter(a,
...
this.setNodeDirty(!0))},setFlippedY:function(a){this._flippedY!=a&&(this._flippedY=a,this.setTextureRect(this._rect,this._rectRotated,this._contentSize),this.setNodeDirty(!0))},isFlippedX:function(){return this._flippedX},isFlippedY:function(){return this._flippedY},setOpacityModifyRGB:function(a){this._opacityModifyRGB!==a&&(this._opacityModifyRGB=a,this._renderCmd._setColorDirty())},isOpacityModifyRGB:function(){return this._opacityModifyRGB},setDisplayFrameWithAnimationName:function(a,c){cc.assert(a,
cc._LogInfos.Sprite_setDisplayFrameWithAnimationName_3);var b=cc.animationCache.getAnimation(a);b?(b=b.getFrames()[c])?this.setSpriteFrame(b.getSpriteFrame()):cc.log(cc._LogInfos.Sprite_setDisplayFrameWithAnimationName_2):cc.log(cc._LogInfos.Sprite_setDisplayFrameWithAnimationName)},getBatchNode:function(){return this._batchNode},_setReorderChildDirtyRecursively:function(){if(!this._reorderChildDirty){this._reorderChildDirty=!0;for(var a=this._parent;a&&a!=this._batchNode;)a._setReorderChildDirtyRecursively(),
a=a.parent}},getTexture:function(){return this._texture},_softInit:function(a,c,b){if(void 0===a)cc.Sprite.prototype.init.call(this);else if(cc.isString(a))"#"===a[0]?(a=a.substr(1,a.length-1),a=cc.spriteFrameCache.getSpriteFrame(a),this.initWithSpriteFrame(a)):cc.Sprite.prototype.init.call(this,a,c);else if(cc.isObject(a))if(a instanceof cc.Texture2D)this.initWithTexture(a,c,b);else if(a instanceof cc.SpriteFrame)this.initWithSpriteFrame(a);else if(a instanceof HTMLImageElement||a instanceof HTMLCanvasElement)c=
new cc.Texture2D,c.initWithElement(a),c.handleLoadedTexture(),this.initWithTexture(c)},getQuad:function(){return this._renderCmd.getQuad()},setBlendFunc:function(a,c){var b=this._blendFunc;void 0===c?(b.src=a.src,b.dst=a.dst):(b.src=a,b.dst=c);this._renderCmd.updateBlendFunc(b)},init:function(){if(0<arguments.length)return this.initWithFile(arguments[0],arguments[1]);cc.Node.prototype.init.call(this);this.dirty=this._recursiveDirty=!1;this._blendFunc.src=cc.BLEND_SRC;this._blendFunc.dst=cc.BLEND_DST;
this.texture=null;this._textureLoaded=!0;this._flippedX=this._flippedY=!1;this.anchorY=this.anchorX=0.5;this._offsetPosition.x=0;this._offsetPosition.y=0;this._hasChildren=!1;this._renderCmd._init();this.setTextureRect(cc.rect(0,0,0,0),!1,cc.size(0,0));return!0},initWithFile:function(a,c){cc.assert(a,cc._LogInfos.Sprite_initWithFile);var b=cc.textureCache.getTextureForKey(a);if(b){if(!c){var d=b.getContentSize();c=cc.rect(0,0,d.width,d.height)}return this.initWithTexture(b,c)}b=cc.textureCache.addImage(a);
return this.initWithTexture(b,c||cc.rect(0,0,b._contentSize.width,b._contentSize.height))},initWithTexture:function(a,c,b){cc.assert(0!=arguments.length,cc._LogInfos.CCSpriteBatchNode_initWithTexture);b=b||!1;a=this._renderCmd._handleTextureForRotatedTexture(a,c,b);if(!cc.Node.prototype.init.call(this))return!1;this._batchNode=null;this.dirty=this._recursiveDirty=!1;this._opacityModifyRGB=!0;this._blendFunc.src=cc.BLEND_SRC;this._blendFunc.dst=cc.BLEND_DST;this._flippedX=this._flippedY=!1;this.setAnchorPoint(0.5,
0.5);this._offsetPosition.x=0;this._offsetPosition.y=0;this._hasChildren=!1;this._renderCmd._init();var d=a.isLoaded();this._textureLoaded=d;if(!d)return this._rectRotated=b,c&&(this._rect.x=c.x,this._rect.y=c.y,this._rect.width=c.width,this._rect.height=c.height),this.texture&&this.texture.removeEventListener("load",this),a.addEventListener("load",this._renderCmd._textureLoadedCallback,this),this.texture=a,!0;c||(c=cc.rect(0,0,a.width,a.height));this._renderCmd._checkTextureBoundary(a,c,b);this.texture=
a;this.setTextureRect(c,b);this.setBatchNode(null);return!0},setTextureRect:function(a,c,b,d){this._rectRotated=c||!1;this.setContentSize(b||a);this.setVertexRect(a);this._renderCmd._setTextureCoords(a,d);a=this._unflippedOffsetPositionFromCenter;this._flippedX&&(a.x=-a.x);this._flippedY&&(a.y=-a.y);c=this._rect;this._offsetPosition.x=a.x+(this._contentSize.width-c.width)/2;this._offsetPosition.y=a.y+(this._contentSize.height-c.height)/2;this._batchNode?this.dirty=!0:this._renderCmd._resetForBatchNode()},
...
b.x;c._unflippedOffsetPositionFromCenter.y=b.y;c._rectRotated=a.isRotated();b=a.getTexture();a.textureLoaded()||(c._textureLoaded=!1,a.addEventListener("load",function(a){c._textureLoaded=!0;var b=a.getTexture();b!=c._texture&&(c.texture=b);c.setTextureRect(a.getRect(),a.isRotated(),a.getOriginalSize());c.dispatchEvent("load")},c));b!=c._texture&&(c.texture=b);c.setTextureRect(a.getRect(),c._rectRotated,a.getOriginalSize());this._renderCmd._updateForSetSpriteFrame(b)},setDisplayFrame:function(a){cc.log(cc._LogInfos.Sprite_setDisplayFrame);
...
this.textureAtlas=null,this.dirty=this._recursiveDirty=!1,this._renderCmd._resetForBatchNode())},setTexture:function(a){var c=this;if(a&&cc.isString(a)){a=cc.textureCache.addImage(a);c.setTexture(a);var b=a.getContentSize();c.setTextureRect(cc.rect(0,0,b.width,b.height));a._isLoaded||a.addEventListener("load",function(){var b=a.getContentSize();c.setTextureRect(cc.rect(0,0,b.width,b.height))},this)}else cc.assert(!a||a instanceof cc.Texture2D,cc._LogInfos.Sprite_setTexture_2),this._renderCmd._setTexture(a)},
...
a._resetForBatchNode=function(){};a._setTexture=function(a){var b=this._node;b._texture!=a&&(a&&a.getHtmlElementObj()instanceof HTMLImageElement&&(this._originalTexture=a),b._texture=a)};a._setColorDirty=function(){this.setDirtyFlag(cc.Node._dirtyFlags.colorDirty|cc.Node._dirtyFlags.opacityDirty)};a.isFrameDisplayed=function(a){var b=this._node;return a.getTexture()!=b._texture?!1:cc.rectEqualToRect(a.getRect(),b._rect)};a.updateBlendFunc=function(a){this._blendFuncStr=cc.Node.CanvasRenderCmd._getCompositeOperationByBlendFunc(a)};
a._setBatchNodeForAddChild=function(a){return!0};a._handleTextureForRotatedTexture=function(a,b,d){d&&a.isLoaded()&&(a=a.getHtmlElementObj(),a=cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas(a,b),d=new cc.Texture2D,d.initWithElement(a),d.handleLoadedTexture(),a=d,this._node._rect=cc.rect(0,0,b.width,b.height));return a};a._checkTextureBoundary=function(a,b,d){a&&a.url&&(d=b.y+b.height,b.x+b.width>a.width&&cc.error(cc._LogInfos.RectWidth,a.url),d>a.height&&cc.error(cc._LogInfos.RectHeight,a.url));
this._node._originalTexture=a};a.rendering=function(a,b,d){var e=this._node,f=this._textureCoord,g=this._displayedOpacity/255;if(!(e._texture&&(0===f.width||0===f.height||!e._texture._isLoaded)||0===g)){a=a||cc._renderContext;var h=a.getContext(),k=e._offsetPosition.x,m=e._rect.height,p=e._rect.width,n=-e._offsetPosition.y-m;a.setCompositeOperation(this._blendFuncStr);a.setGlobalAlpha(g);a.setTransform(this._worldTransform,b,d);(e._flippedX||e._flippedY)&&a.save();e._flippedX&&(k=-k-p,h.scale(-1,
...
function(a,b,d,e,f){e||(e=cc.rect(0,0,a.width,a.height));a=d.r/255;var g=d.g/255;d=d.b/255;var h=Math.min(e.width,b[0].width),k=Math.min(e.height,b[0].height),m;f?(m=f.getContext("2d"),m.clearRect(0,0,h,k)):(f=cc.newElement("canvas"),f.width=h,f.height=k,m=f.getContext("2d"));m.save();m.globalCompositeOperation="lighter";var p=m.globalAlpha;0<a&&(m.globalAlpha=a*p,m.drawImage(b[0],e.x,e.y,h,k,0,0,h,k));0<g&&(m.globalAlpha=g*p,m.drawImage(b[1],e.x,e.y,h,k,0,0,h,k));0<d&&(m.globalAlpha=d*p,m.drawImage(b[2],
e.x,e.y,h,k,0,0,h,k));1>a+g+d&&(m.globalAlpha=p,m.drawImage(b[3],e.x,e.y,h,k,0,0,h,k));m.restore();return f};cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor=function(a){function b(){var b=cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor,e=a.width,h=a.height;d[0].width=e;d[0].height=h;d[1].width=e;d[1].height=h;d[2].width=e;d[2].height=h;d[3].width=e;d[3].height=h;b.canvas.width=e;b.canvas.height=h;var k=b.canvas.getContext("2d");k.drawImage(a,0,0);b.tempCanvas.width=e;b.tempCanvas.height=
h;for(var k=k.getImageData(0,0,e,h).data,m=0;4>m;m++){var p=d[m].getContext("2d");p.getImageData(0,0,e,h).data;b.tempCtx.drawImage(a,0,0);for(var n=b.tempCtx.getImageData(0,0,e,h),r=n.data,s=0;s<k.length;s+=4)r[s]=0===m?k[s]:0,r[s+1]=1===m?k[s+1]:0,r[s+2]=2===m?k[s+2]:0,r[s+3]=k[s+3];p.putImageData(n,0,0)}a.onload=null}if(a.channelCache)return a.channelCache;var d=[cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas")];try{b()}catch(e){a.onload=b}return a.channelCache=
d};cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.canvas=cc.newElement("canvas");cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.tempCanvas=cc.newElement("canvas");cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.tempCtx=cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.tempCanvas.getContext("2d");cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas=function(a,b){if(!a)return null;if(!b)return a;var d=cc.newElement("canvas");d.width=b.width;d.height=b.height;var e=d.getContext("2d");
e.translate(d.width/2,d.height/2);e.rotate(-1.5707963267948966);e.drawImage(a,b.x,b.y,b.height,b.width,-b.height/2,-b.width/2,b.height,b.width);return d}})();(function(){cc.Sprite.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a);this._needDraw=!0;this._quad=new cc.V3F_C4B_T2F_Quad;this._quadWebBuffer=cc._renderContext.createBuffer();this._quadDirty=!0;this._recursiveDirty=this._dirty=!1};var a=cc.Sprite.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);a.constructor=cc.Sprite.WebGLRenderCmd;a.updateBlendFunc=function(a){};a.setDirtyFlag=function(a){cc.Node.WebGLRenderCmd.prototype.setDirtyFlag.call(this,a);this._dirty=
...
cc.ONE_MINUS_SRC_ALPHA,a.opacityModifyRGB=!1):(a._blendFunc.src=cc.BLEND_SRC,a._blendFunc.dst=cc.BLEND_DST,a.opacityModifyRGB=!0)}};a._setTexture=function(a){var b=this._node;b._batchNode&&b._batchNode.texture!=a?cc.log(cc._LogInfos.Sprite_setTexture):(this._shaderProgram=a?cc.shaderCache.programForKey(cc.SHADER_POSITION_TEXTURECOLOR):cc.shaderCache.programForKey(cc.SHADER_POSITION_COLOR),!b._batchNode&&b._texture!=a&&(b._texture=a,this._updateBlendFunc()))};a.updateTransform=function(){var a=this._node;
if(this._dirty){var b=this._quad,d=a._parent;if(!a._visible||d&&d!=a._batchNode&&d._shouldBeHidden)b.br.vertices=b.tl.vertices=b.tr.vertices=b.bl.vertices={x:0,y:0,z:0},a._shouldBeHidden=!0;else{a._shouldBeHidden=!1;0!==this._dirtyFlag&&(this.updateStatus(),this._dirtyFlag=0);a._transformToBatch=!d||d==a._batchNode?this.getNodeToParentTransform():cc.affineTransformConcat(this.getNodeToParentTransform(),d._transformToBatch);var e=a._transformToBatch,f=a._rect,d=a._offsetPosition.x,g=a._offsetPosition.y,
h=d+f.width,k=g+f.height,m=e.tx,p=e.ty,n=e.a,r=e.b,s=e.d,u=-e.c,e=d*n-g*u+m,f=d*r+g*s+p,t=h*n-g*u+m,g=h*r+g*s+p,v=h*n-k*u+m,h=h*r+k*s+p,m=d*n-k*u+m,d=d*r+k*s+p,k=a._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(e|=0,f|=0,t|=0,g|=0,v|=0,h|=0,m|=0,d|=0);b.bl.vertices={x:e,y:f,z:k};b.br.vertices={x:t,y:g,z:k};b.tl.vertices={x:m,y:d,z:k};b.tr.vertices={x:v,y:h,z:k}}a.textureAtlas.updateQuad(b,a.atlasIndex);this._dirty=a._recursiveDirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,
cc.Node._stateCallbackType.updateTransform)};a._checkTextureBoundary=function(a,b,d){a&&a.url&&(d?(d=b.x+b.height,b=b.y+b.width):(d=b.x+b.width,b=b.y+b.height),d>a.width&&cc.error(cc._LogInfos.RectWidth,a.url),b>a.height&&cc.error(cc._LogInfos.RectHeight,a.url))};a.rendering=function(a){var b=this._node;if(b._textureLoaded&&0!==this._displayedOpacity){a=a||cc._renderContext;var d=b._texture;d?d._isLoaded&&(this._shaderProgram.use(),this._shaderProgram._setUniformForMVPMatrixWithMat4(this._stackMatrix),
...
if(0!==cc.SPRITE_DEBUG_DRAW||b._showNode)cc.kmGLMatrixMode(cc.KM_GL_MODELVIEW),cc.current_stack.stack.push(cc.current_stack.top),cc.current_stack.top=this._stackMatrix,1===cc.SPRITE_DEBUG_DRAW||b._showNode?(b=this._quad,b=[cc.p(b.tl.vertices.x,b.tl.vertices.y),cc.p(b.bl.vertices.x,b.bl.vertices.y),cc.p(b.br.vertices.x,b.br.vertices.y),cc.p(b.tr.vertices.x,b.tr.vertices.y)],cc._drawingUtil.drawPoly(b,4,!0)):2===cc.SPRITE_DEBUG_DRAW&&(a=b.getTextureRect(),b=b.getOffsetPosition(),b=[cc.p(b.x,b.y),cc.p(b.x+
a.width,b.y),cc.p(b.x+a.width,b.y+a.height),cc.p(b.x,b.y+a.height)],cc._drawingUtil.drawPoly(b,4,!0)),cc.current_stack.top=cc.current_stack.stack.pop()}}})();cc.SpriteBatchNode=cc.Node.extend({_blendFunc:null,_descendants:null,_className:"SpriteBatchNode",ctor:function(a,c){cc.Node.prototype.ctor.call(this);this._descendants=[];this._blendFunc=new cc.BlendFunc(cc.BLEND_SRC,cc.BLEND_DST);var b;c=c||cc.SpriteBatchNode.DEFAULT_CAPACITY;cc.isString(a)?(b=cc.textureCache.getTextureForKey(a))||(b=cc.textureCache.addImage(a)):a instanceof cc.Texture2D&&(b=a);b&&this.initWithTexture(b,c)},addSpriteWithoutQuad:function(a,c,b){cc.assert(a,cc._LogInfos.SpriteBatchNode_addSpriteWithoutQuad_2);
if(!(a instanceof cc.Sprite))return cc.log(cc._LogInfos.SpriteBatchNode_addSpriteWithoutQuad),null;a.atlasIndex=c;var d=0,e,f=this._descendants;if(f&&0<f.length){d=0;for(e=f.length;d<e;d++){var g=f[d];if(g&&g.atlasIndex>=c)break}}f.splice(d,0,a);cc.Node.prototype.addChild.call(this,a,c,b);this.reorderBatch(!1);return this},getTextureAtlas:function(){return this._renderCmd.getTextureAtlas()},setTextureAtlas:function(a){this._renderCmd.getTextureAtlas(a)},getDescendants:function(){return this._descendants},
...
this._supportsShareableVAO;cc.checkGLErrorDebug()}},loadConfigFile:function(a){this._inited||this._init();var c=cc.loader.getRes(a);if(!c)throw"Please load the resource first : "+a;cc.assert(c,cc._LogInfos.configuration_loadConfigFile_2,a);if(c=c.data)for(var b in c)this._valueDict[b]=c[b];else cc.log(cc._LogInfos.configuration_loadConfigFile,a)}};cc.g_NumberOfDraws=0;cc.GLToClipTransform=function(a){var c=new cc.kmMat4;cc.kmGLGetMatrix(cc.KM_GL_PROJECTION,c);var b=new cc.kmMat4;cc.kmGLGetMatrix(cc.KM_GL_MODELVIEW,b);cc.kmMat4Multiply(a,c,b)};
...
"Arial",a);this._drawsLabel=new cc.LabelTTF("0000","Arial",a);a=cc.DIRECTOR_STATS_POSITION;this._drawsLabel.setPosition(this._drawsLabel.width/2+a.x,5*this._drawsLabel.height/2+a.y);this._SPFLabel.setPosition(this._SPFLabel.width/2+a.x,3*this._SPFLabel.height/2+a.y);this._FPSLabel.setPosition(this._FPSLabel.width/2+a.x,this._FPSLabel.height/2+a.y)};a.convertToGL=function(a){var b=new cc.kmMat4;cc.GLToClipTransform(b);var d=new cc.kmMat4;cc.kmMat4Inverse(d,b);var b=b.mat[14]/b.mat[15],e=this._openGLView.getDesignResolutionSize();
a=new cc.kmVec3(2*a.x/e.width-1,1-2*a.y/e.height,b);b=new cc.kmVec3;cc.kmVec3TransformCoord(b,a,d);return cc.p(b.x,b.y)};a.convertToUI=function(a){var b=new cc.kmMat4;cc.GLToClipTransform(b);var d=new cc.kmVec3;a=new cc.kmVec3(a.x,a.y,0);cc.kmVec3TransformCoord(d,a,b);b=this._openGLView.getDesignResolutionSize();return cc.p(b.width*(0.5*d.x+0.5),b.height*(0.5*-d.y+0.5))};a.getVisibleSize=function(){return this._openGLView.getVisibleSize()};a.getVisibleOrigin=function(){return this._openGLView.getVisibleOrigin()};
...
this._centerX=this._centerY=this._centerZ=0;this._upY=1;this._upZ=0;cc.kmMat4Identity(this._lookupMatrix);this._dirty=!1},locate:function(){if(this._dirty){var a=new cc.kmVec3,c=new cc.kmVec3,b=new cc.kmVec3;cc.kmVec3Fill(a,this._eyeX,this._eyeY,this._eyeZ);cc.kmVec3Fill(c,this._centerX,this._centerY,this._centerZ);cc.kmVec3Fill(b,this._upX,this._upY,this._upZ);cc.kmMat4LookAt(this._lookupMatrix,a,c,b);this._dirty=!1}cc.kmGLMultMatrix(this._lookupMatrix)},_locateForRenderer:function(a){if(this._dirty){var c=
new cc.kmVec3,b=new cc.kmVec3,d=new cc.kmVec3;cc.kmVec3Fill(c,this._eyeX,this._eyeY,this._eyeZ);cc.kmVec3Fill(b,this._centerX,this._centerY,this._centerZ);cc.kmVec3Fill(d,this._upX,this._upY,this._upZ);cc.kmMat4LookAt(this._lookupMatrix,c,b,d);this._dirty=!1}cc.kmMat4Multiply(a,a,this._lookupMatrix)},setEyeXYZ:function(a,c,b){this.setEye(a,c,b)},setEye:function(a,c,b){this._eyeX=a;this._eyeY=c;this._eyeZ=b;this._dirty=!0},setCenterXYZ:function(a,c,b){this.setCenter(a,c,b)},setCenter:function(a,c,
...
c,b){return{x:this._upX,y:this._upY,z:this._upZ}},getUp:function(){return{x:this._upX,y:this._upY,z:this._upZ}},_DISALLOW_COPY_AND_ASSIGN:function(a){}});cc.Camera.getZEye=function(){return cc.FLT_EPSILON};cc.PRIORITY_NON_SYSTEM=cc.PRIORITY_SYSTEM+1;cc.ListEntry=function(a,c,b,d,e,f){this.prev=a;this.next=c;this.target=b;this.priority=d;this.paused=e;this.markedForDeletion=f};cc.HashUpdateEntry=function(a,c,b,d){this.list=a;this.entry=c;this.target=b;this.hh=d};cc.HashTimerEntry=function(a,c,b,d,e,f,g){this.timers=a;this.target=c;this.timerIndex=b;this.currentTimer=d;this.currentTimerSalvaged=e;this.paused=f;this.hh=g};
cc.Timer=cc.Class.extend({_interval:0,_callback:null,_target:null,_elapsed:0,_runForever:!1,_useDelay:!1,_timesExecuted:0,_repeat:0,_delay:0,getInterval:function(){return this._interval},setInterval:function(a){this._interval=a},getCallback:function(){return this._callback},ctor:function(a,c,b,d,e){this._target=a;this._callback=c;this._elapsed=-1;this._interval=b||0;this._delay=e||0;this._useDelay=0<this._delay;this._repeat=null==d?cc.REPEAT_FOREVER:d;this._runForever=this._repeat==cc.REPEAT_FOREVER},
_doCallback:function(){if(cc.isString(this._callback))this._target[this._callback](this._elapsed);else this._callback.call(this._target,this._elapsed)},update:function(a){if(-1==this._elapsed)this._timesExecuted=this._elapsed=0;else{var c=this._target,b=this._callback;this._elapsed+=a;this._runForever&&!this._useDelay?this._elapsed>=this._interval&&(c&&b&&this._doCallback(),this._elapsed=0):(this._useDelay?this._elapsed>=this._delay&&(c&&b&&this._doCallback(),this._elapsed-=this._delay,this._timesExecuted+=
1,this._useDelay=!1):this._elapsed>=this._interval&&(c&&b&&this._doCallback(),this._elapsed=0,this._timesExecuted+=1),this._timesExecuted>this._repeat&&cc.director.getScheduler().unscheduleCallbackForTarget(c,b))}}});
...
cc.arrayRemoveObject(this._arrayForTimers,a);a.Timer=null;a.target=null},_removeUpdateFromHash:function(a){if(a=this._hashForUpdates[a.target.__instanceId])cc.arrayRemoveObject(a.list,a.entry),delete this._hashForUpdates[a.target.__instanceId],cc.arrayRemoveObject(this._arrayForUpdates,a),a.entry=null,a.target=null},_priorityIn:function(a,c,b,d){d=new cc.ListEntry(null,null,c,b,d,!1);if(a){for(var e=a.length-1,f=0;f<=e&&!(b<a[f].priority);f++);a.splice(f,0,d)}else a=[],a.push(d);b=new cc.HashUpdateEntry(a,
d,c,null);this._arrayForUpdates.push(b);this._hashForUpdates[c.__instanceId]=b;return a},_appendIn:function(a,c,b){b=new cc.ListEntry(null,null,c,0,b,!1);a.push(b);a=new cc.HashUpdateEntry(a,b,c,null);this._arrayForUpdates.push(a);this._hashForUpdates[c.__instanceId]=a},setTimeScale:function(a){this._timeScale=a},getTimeScale:function(){return this._timeScale},update:function(a){var c=this._updates,b=this._arrayForTimers,d,e,f;this._updateHashLocked=!0;1!=this._timeScale&&(a*=this._timeScale);e=0;
for(f=c.length;e<f&&0<=e;e++)for(var g=this._updates[e],h=0,k=g.length;h<k;h++)d=g[h],!d.paused&&!d.markedForDeletion&&d.target.update(a);e=0;for(f=b.length;e<f;e++){d=b[e];if(!d)break;this._currentTarget=d;this._currentTargetSalvaged=!1;if(!d.paused)for(d.timerIndex=0;d.timerIndex<d.timers.length;d.timerIndex++)d.currentTimer=d.timers[d.timerIndex],d.currentTimerSalvaged=!1,d.currentTimer.update(a),d.currentTimer=null;this._currentTargetSalvaged&&0==d.timers.length&&(this._removeHashElement(d),e--)}e=
0;for(f=c.length;e<f;e++){g=this._updates[e];h=0;for(k=g.length;h<k;){d=g[h];if(!d)break;d.markedForDeletion?this._removeUpdateFromHash(d):h++}}this._updateHashLocked=!1;this._currentTarget=null},scheduleCallbackForTarget:function(a,c,b,d,e,f){cc.assert(c,cc._LogInfos.Scheduler_scheduleCallbackForTarget_2);cc.assert(a,cc._LogInfos.Scheduler_scheduleCallbackForTarget_3);b=b||0;d=null==d?cc.REPEAT_FOREVER:d;e=e||0;f=f||!1;var g=this._hashForTimers[a.__instanceId];g||(g=new cc.HashTimerEntry(null,a,
0,null,null,f,null),this._arrayForTimers.push(g),this._hashForTimers[a.__instanceId]=g);if(null==g.timers)g.timers=[];else for(var h=0;h<g.timers.length;h++)if(f=g.timers[h],c==f._callback){cc.log(cc._LogInfos.Scheduler_scheduleCallbackForTarget,f.getInterval().toFixed(4),b.toFixed(4));f._interval=b;return}f=new cc.Timer(a,c,b,d,e);g.timers.push(f)},scheduleUpdateForTarget:function(a,c,b){if(null!==a){var d=this._updates,e=this._hashForUpdates[a.__instanceId];e?e.entry.markedForDeletion=!1:0==c?this._appendIn(d[1],
a,b):0>c?d[0]=this._priorityIn(d[0],a,c,b):d[2]=this._priorityIn(d[2],a,c,b)}},unscheduleCallbackForTarget:function(a,c){if(!(null==a||null==c)){var b=this._hashForTimers[a.__instanceId];if(b)for(var d=b.timers,e=0,f=d.length;e<f;e++){var g=d[e];if(c==g._callback){g==b.currentTimer&&!b.currentTimerSalvaged&&(b.currentTimerSalvaged=!0);d.splice(e,1);b.timerIndex>=e&&b.timerIndex--;0==d.length&&(this._currentTarget==b?this._currentTargetSalvaged=!0:this._removeHashElement(b));break}}}},unscheduleUpdateForTarget:function(a){null!=
a&&(a=this._hashForUpdates[a.__instanceId],null!=a&&(this._updateHashLocked?a.entry.markedForDeletion=!0:this._removeUpdateFromHash(a.entry)))},unscheduleAllCallbacksForTarget:function(a){if(null!=a){var c=this._hashForTimers[a.__instanceId];if(c){var b=c.timers;!c.currentTimerSalvaged&&0<=b.indexOf(c.currentTimer)&&(c.currentTimerSalvaged=!0);b.length=0;this._currentTarget==c?this._currentTargetSalvaged=!0:this._removeHashElement(c)}this.unscheduleUpdateForTarget(a)}},unscheduleAllCallbacks:function(){this.unscheduleAllCallbacksWithMinPriority(cc.Scheduler.PRIORITY_SYSTEM)},
unscheduleAllCallbacksWithMinPriority:function(a){for(var c=this._arrayForTimers,b=this._updates,d=0,e=c.length;d<e;d++)this.unscheduleAllCallbacksForTarget(c[d].target);for(d=2;0<=d;d--)if(!(1==d&&0<a||0==d&&0<=a))for(var c=b[d],e=0,f=c.length;e<f;e++)this.unscheduleUpdateForTarget(c[e].target)},pauseAllTargets:function(){return this.pauseAllTargetsWithMinPriority(cc.Scheduler.PRIORITY_SYSTEM)},pauseAllTargetsWithMinPriority:function(a){a=[];for(var c,b=this._arrayForTimers,d=this._updates,e=0,f=
b.length;e<f;e++)if(c=b[e])c.paused=!0,a.push(c.target);e=0;for(f=d.length;e<f;e++)for(var b=d[e],g=0,h=b.length;g<h;g++)if(c=b[g])c.paused=!0,a.push(c.target);return a},resumeTargets:function(a){if(a)for(var c=0;c<a.length;c++)this.resumeTarget(a[c])},pauseTarget:function(a){cc.assert(a,cc._LogInfos.Scheduler_pauseTarget);var c=this._hashForTimers[a.__instanceId];c&&(c.paused=!0);if(a=this._hashForUpdates[a.__instanceId])a.entry.paused=!0},resumeTarget:function(a){cc.assert(a,cc._LogInfos.Scheduler_resumeTarget);
var c=this._hashForTimers[a.__instanceId];c&&(c.paused=!1);if(a=this._hashForUpdates[a.__instanceId])a.entry.paused=!1},isTargetPaused:function(a){cc.assert(a,cc._LogInfos.Scheduler_isTargetPaused);return(a=this._hashForTimers[a.__instanceId])?a.paused:!1}});cc.Scheduler.PRIORITY_SYSTEM=-2147483648;cc.PI2=2*Math.PI;
...
a._getShadowOffsetX,a._setShadowOffsetX);cc.defineGetterSetter(a,"shadowOffsetY",a._getShadowOffsetY,a._setShadowOffsetY);cc.defineGetterSetter(a,"shadowOpacity",a._getShadowOpacity,a._setShadowOpacity);cc.defineGetterSetter(a,"shadowBlur",a._getShadowBlur,a._setShadowBlur)};cc.LabelTTF=cc.Sprite.extend({_dimensions:null,_hAlignment:cc.TEXT_ALIGNMENT_CENTER,_vAlignment:cc.VERTICAL_TEXT_ALIGNMENT_TOP,_fontName:null,_fontSize:0,_string:"",_originalText:null,_shadowEnabled:!1,_shadowOffset:null,_shadowOpacity:0,_shadowBlur:0,_shadowColor:null,_strokeEnabled:!1,_strokeColor:null,_strokeSize:0,_textFillColor:null,_strokeShadowOffsetX:0,_strokeShadowOffsetY:0,_needUpdateTexture:!1,_lineWidths:null,_className:"LabelTTF",_lineHeight:0,initWithString:function(a,c,b,d,e,f){a=a?
a+"":"";b=b||16;d=d||cc.size(0,0);e=e||cc.TEXT_ALIGNMENT_LEFT;f=f||cc.VERTICAL_TEXT_ALIGNMENT_TOP;this._opacityModifyRGB=!1;this._dimensions=cc.size(d.width,d.height);this._fontName=c||"Arial";this._hAlignment=e;this._vAlignment=f;this._fontSize=b;this._renderCmd._setFontStyle(this._fontName,b);this.string=a;this._renderCmd._setColorsString();this._renderCmd._updateTexture();this._setUpdateTextureDirty();return!0},_setUpdateTextureDirty:function(){this._needUpdateTexture=!0;this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.textDirty)},
ctor:function(a,c,b,d,e,f){cc.Sprite.prototype.ctor.call(this);this._dimensions=cc.size(0,0);this._hAlignment=cc.TEXT_ALIGNMENT_LEFT;this._vAlignment=cc.VERTICAL_TEXT_ALIGNMENT_TOP;this._opacityModifyRGB=!1;this._fontName="Arial";this._shadowEnabled=!1;this._shadowOffset=cc.p(0,0);this._shadowBlur=this._shadowOpacity=0;this._strokeEnabled=!1;this._strokeColor=cc.color(255,255,255,255);this._strokeSize=0;this._textFillColor=cc.color(255,255,255,255);this._strokeShadowOffsetY=this._strokeShadowOffsetX=
0;this._needUpdateTexture=!1;this._lineWidths=[];this._renderCmd._setColorsString();c&&c instanceof cc.FontDefinition?this.initWithStringAndTextDefinition(a,c):cc.LabelTTF.prototype.initWithString.call(this,a,c,b,d,e,f)},init:function(){return this.initWithString(" ",this._fontName,this._fontSize)},description:function(){return"\x3ccc.LabelTTF | FontName \x3d"+this._fontName+" FontSize \x3d "+this._fontSize.toFixed(1)+"\x3e"},getLineHeight:function(){return this._lineHeight||this._renderCmd._getFontClientHeight()},
...
!0)},getTextDefinition:function(){return this._prepareTextDefinition(!1)},enableShadow:function(a,c,b,d){null!=a.r&&null!=a.g&&null!=a.b&&null!=a.a?this._enableShadow(a,c,b):this._enableShadowNoneColor(a,c,b,d)},_enableShadowNoneColor:function(a,c,b,d){b=b||0.5;!1===this._shadowEnabled&&(this._shadowEnabled=!0);var e=this._shadowOffset;if(e&&e.x!=a||e._y!=c)e.x=a,e.y=c;this._shadowOpacity!=b&&(this._shadowOpacity=b);this._renderCmd._setColorsString();this._shadowBlur!=d&&(this._shadowBlur=d);this._setUpdateTextureDirty()},
_enableShadow:function(a,c,b){this._shadowColor||(this._shadowColor=cc.color(255,255,255,128));this._shadowColor.r=a.r;this._shadowColor.g=a.g;this._shadowColor.b=a.b;this._enableShadowNoneColor(c.width||c.x||0,c.height||c.y||0,null!=a.a?a.a/255:0.5,b)},_getShadowOffsetX:function(){return this._shadowOffset.x},_setShadowOffsetX:function(a){!1===this._shadowEnabled&&(this._shadowEnabled=!0);this._shadowOffset.x!=a&&(this._shadowOffset.x=a,this._setUpdateTextureDirty())},_getShadowOffsetY:function(){return this._shadowOffset._y},
...
c){!1===this._strokeEnabled&&(this._strokeEnabled=!0);var b=this._strokeColor;if(b.r!==a.r||b.g!==a.g||b.b!==a.b)b.r=a.r,b.g=a.g,b.b=a.b,this._renderCmd._setColorsString();this._strokeSize!==c&&(this._strokeSize=c||0);this._setUpdateTextureDirty()},_getStrokeStyle:function(){return this._strokeColor},_setStrokeStyle:function(a){!1===this._strokeEnabled&&(this._strokeEnabled=!0);var c=this._strokeColor;if(c.r!==a.r||c.g!==a.g||c.b!==a.b)c.r=a.r,c.g=a.g,c.b=a.b,this._renderCmd._setColorsString(),this._setUpdateTextureDirty()},
...
a.lineWidth);this.setFontFillColor(a.fillStyle);c&&this._renderCmd._updateTexture();var b=cc.Node._dirtyFlags;this._renderCmd.setDirtyFlag(b.colorDirty|b.opacityDirty|b.textDirty)},_prepareTextDefinition:function(a){var c=new cc.FontDefinition;a?(c.fontSize=this._fontSize,c.boundingWidth=cc.contentScaleFactor()*this._dimensions.width,c.boundingHeight=cc.contentScaleFactor()*this._dimensions.height):(c.fontSize=this._fontSize,c.boundingWidth=this._dimensions.width,c.boundingHeight=this._dimensions.height);
c.fontName=this._fontName;c.textAlign=this._hAlignment;c.verticalAlign=this._vAlignment;if(this._strokeEnabled){c.strokeEnabled=!0;var b=this._strokeColor;c.strokeStyle=cc.color(b.r,b.g,b.b);c.lineWidth=this._strokeSize}else c.strokeEnabled=!1;this._shadowEnabled?(c.shadowEnabled=!0,c.shadowBlur=this._shadowBlur,c.shadowOpacity=this._shadowOpacity,c.shadowOffsetX=(a?cc.contentScaleFactor():1)*this._shadowOffset.x,c.shadowOffsetY=(a?cc.contentScaleFactor():1)*this._shadowOffset.y):c._shadowEnabled=
!1;a=this._textFillColor;c.fillStyle=cc.color(a.r,a.g,a.b);return c},setString:function(a){a=String(a);this._originalText!=a&&(this._originalText=a+"",this._updateString(),this._setUpdateTextureDirty(),this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty))},_updateString:function(){if((!this._string||""===this._string)&&this._string!==this._originalText)cc.renderer.childrenOrderDirty=!0;this._string=this._originalText},setHorizontalAlignment:function(a){a!==this._hAlignment&&(this._hAlignment=
...
cc._tmp.PrototypeLabelTTF();delete cc._tmp.PrototypeLabelTTF;cc.LabelTTF._fontStyleRE=/^(\d+)px\s+['"]?([\w\s\d]+)['"]?$/;cc.LabelTTF.create=function(a,c,b,d,e,f){return new cc.LabelTTF(a,c,b,d,e,f)};cc.LabelTTF.createWithFontDefinition=cc.LabelTTF.create;cc.LabelTTF._SHADER_PROGRAM=cc.USE_LA88_LABELS?cc.SHADER_POSITION_TEXTURECOLOR:cc.SHADER_POSITION_TEXTUREA8COLOR;cc.LabelTTF.__labelHeightDiv=cc.newElement("div");cc.LabelTTF.__labelHeightDiv.style.fontFamily="Arial";
...
cc.newElement("canvas"),d=new cc.Texture2D;d.initWithElement(b);a.setTexture(d);this._labelCanvas=b}return this._labelContext=this._labelCanvas.getContext("2d")};a._setFontStyle=function(a,b){this._fontStyleStr=b+"px '"+a+"'";this._fontClientHeight=cc.LabelTTF.__getFontHeightByDiv(a,b)};a._getFontStyle=function(){return this._fontStyleStr};a._getFontClientHeight=function(){return this._fontClientHeight};a._updateTexture=function(){this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.textDirty;var a=
this._node,b=this._getLabelContext(),d=this._labelCanvas,e=a._contentSize;if(0===a._string.length)return d.width=1,d.height=e.height||1,a._texture&&a._texture.handleLoadedTexture(),a.setTextureRect(cc.rect(0,0,1,e.height)),!0;b.font=this._fontStyleStr;this._updateTTF();var f=e.width,e=e.height,g=d.width==f&&d.height==e;d.width=f;d.height=e;g&&b.clearRect(0,0,f,e);this._drawTTFInCanvas(b);a._texture&&a._texture.handleLoadedTexture();a.setTextureRect(cc.rect(0,0,f,e));return!0};a._measureConfig=function(){this._getLabelContext().font=
this._fontStyleStr};a._measure=function(a){return this._getLabelContext().measureText(a).width};a._updateTTF=function(){var a=this._node,b=a._dimensions.width,d,e,f=this._lineWidths;f.length=0;this._isMultiLine=!1;this._measureConfig();if(0!==b){this._strings=a._string.split("\n");for(d=0;d<this._strings.length;d++)this._checkWarp(this._strings,d,b)}else{this._strings=a._string.split("\n");d=0;for(e=this._strings.length;d<e;d++)f.push(this._measure(this._strings[d]))}0<this._strings.length&&(this._isMultiLine=
!0);e=d=0;a._strokeEnabled&&(d=e=2*a._strokeSize);if(a._shadowEnabled){var g=a._shadowOffset;d+=2*Math.abs(g.x);e+=2*Math.abs(g.y)}b=0===b?this._isMultiLine?cc.size(0|Math.max.apply(Math,f)+d,0|this._fontClientHeight*this._strings.length+e):cc.size(0|this._measure(a._string)+d,0|this._fontClientHeight+e):0===a._dimensions.height?this._isMultiLine?cc.size(0|b+d,0|a.getLineHeight()*this._strings.length+e):cc.size(0|b+d,0|a.getLineHeight()+e):cc.size(0|b+d,0|a._dimensions.height+e);a.setContentSize(b);
a._strokeShadowOffsetX=d;a._strokeShadowOffsetY=e;a=a._anchorPoint;this._anchorPointInPoints.x=0.5*d+(b.width-d)*a.x;this._anchorPointInPoints.y=0.5*e+(b.height-e)*a.y};a._drawTTFInCanvas=function(a){if(a){var b=this._node,d=b._strokeShadowOffsetX,e=b._strokeShadowOffsetY,f=b._contentSize.height-e,g=b._vAlignment,h=b._hAlignment,k=b._strokeSize;a.setTransform(1,0,0,1,0+0.5*d,f+0.5*e);a.font!=this._fontStyleStr&&(a.font=this._fontStyleStr);a.fillStyle=this._fillColorStr;var m=e=0,p=b._strokeEnabled;
p&&(a.lineWidth=2*k,a.strokeStyle=this._strokeColorStr);b._shadowEnabled&&(k=b._shadowOffset,a.shadowColor=this._shadowColorStr,a.shadowOffsetX=k.x,a.shadowOffsetY=-k.y,a.shadowBlur=b._shadowBlur);a.textBaseline=cc.LabelTTF._textBaseline[g];a.textAlign=cc.LabelTTF._textAlign[h];var n=b._contentSize.width-d,d=b.getLineHeight(),k=(d-this._fontClientHeight)/2,e=h===cc.TEXT_ALIGNMENT_RIGHT?e+n:h===cc.TEXT_ALIGNMENT_CENTER?e+n/2:e+0;if(this._isMultiLine){b=this._strings.length;g===cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM?
m=d-2*k+f-d*b:g===cc.VERTICAL_TEXT_ALIGNMENT_CENTER&&(m=(d-2*k)/2+(f-d*b)/2);for(g=0;g<b;g++)h=this._strings[g],n=-f+(d*g+k)+m,p&&a.strokeText(h,e,n),a.fillText(h,e,n)}else g!==cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM&&(m=g===cc.VERTICAL_TEXT_ALIGNMENT_TOP?m-f:m-0.5*f),p&&a.strokeText(b._string,e,m),a.fillText(b._string,e,m)}};a._checkWarp=function(a,b,d){var e=a[b],f=this._measure(e);if(f>d&&1<e.length){for(var g=e.length*(d/f)|0,h=e.substr(g),k=f-this._measure(h),m,p=0,n=0;k>d&&100>n++;)g*=d/k,g|=0,h=
e.substr(g),k=f-this._measure(h);for(n=0;k<d&&100>n++;)h&&(p=(m=cc.LabelTTF._wordRex.exec(h))?m[0].length:1,m=h),g+=p,h=e.substr(g),k=f-this._measure(h);g-=p;0===g&&(g=1,m=m.substr(1));d=e.substr(0,g);if(cc.LabelTTF.wrapInspection&&cc.LabelTTF._symbolRex.test(m||h))f=cc.LabelTTF._lastWordRex.exec(d),g-=f?f[0].length:0,m=e.substr(g),d=e.substr(0,g);if(cc.LabelTTF._firsrEnglish.test(m)&&(f=cc.LabelTTF._lastEnglish.exec(d))&&d!==f[0])g-=f[0].length,m=e.substr(g),d=e.substr(0,g);a[b]=m||h;a.splice(b,
0,d)}}})();
...
this._shadowColorStr="rgba(128,128,128,"+a._shadowOpacity+")";this._fillColorStr="rgba("+(0|d.r)+","+(0|d.g)+","+(0|d.b)+", 1)";this._strokeColorStr="rgba("+(0|b.r)+","+(0|b.g)+","+(0|b.b)+", 1)"};a.updateStatus=function(){var a=cc.Node._dirtyFlags,b=this._dirtyFlag,d=b&a.colorDirty,e=b&a.opacityDirty;d&&this._updateDisplayColor();e&&this._updateDisplayOpacity();d||e?(this._setColorsString(),this._updateColor(),this._updateTexture()):b&a.textDirty&&this._updateTexture();this._dirtyFlag&a.transformDirty&&
(this.transform(this.getParentRenderCmd(),!0),this._dirtyFlag^=this._dirtyFlag&cc.Node._dirtyFlags.transformDirty)};a._syncStatus=function(a){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,e=a?a._node:null;e&&(e._cascadeColorEnabled&&a._dirtyFlag&b.colorDirty)&&(d|=b.colorDirty);e&&(e._cascadeOpacityEnabled&&a._dirtyFlag&b.opacityDirty)&&(d|=b.opacityDirty);a&&a._dirtyFlag&b.transformDirty&&(d|=b.transformDirty);var e=d&b.colorDirty,f=d&b.opacityDirty;this._dirtyFlag=d;e&&this._syncDisplayColor();f&&
this._syncDisplayOpacity();e||f?(this._setColorsString(),this._updateColor(),this._updateTexture()):d&b.textDirty&&this._updateTexture();this.transform(a)}})();cc.HashElement=cc.Class.extend({actions:null,target:null,actionIndex:0,currentAction:null,currentActionSalvaged:!1,paused:!1,hh:null,ctor:function(){this.actions=[];this.target=null;this.actionIndex=0;this.currentAction=null;this.paused=this.currentActionSalvaged=!1;this.hh=null}});
cc.ActionManager=cc.Class.extend({_hashTargets:null,_arrayTargets:null,_currentTarget:null,_currentTargetSalvaged:!1,_searchElementByTarget:function(a,c){for(var b=0;b<a.length;b++)if(c==a[b].target)return a[b];return null},ctor:function(){this._hashTargets={};this._arrayTargets=[];this._currentTarget=null;this._currentTargetSalvaged=!1},addAction:function(a,c,b){if(!a)throw"cc.ActionManager.addAction(): action must be non-null";if(!c)throw"cc.ActionManager.addAction(): action must be non-null";var d=
this._hashTargets[c.__instanceId];d||(d=new cc.HashElement,d.paused=b,d.target=c,this._hashTargets[c.__instanceId]=d,this._arrayTargets.push(d));this._actionAllocWithHashElement(d);d.actions.push(a);a.startWithTarget(c)},removeAllActions:function(){for(var a=this._arrayTargets,c=0;c<a.length;c++){var b=a[c];b&&this.removeAllActionsFromTarget(b.target,!0)}},removeAllActionsFromTarget:function(a,c){if(null!=a){var b=this._hashTargets[a.__instanceId];b&&(-1!==b.actions.indexOf(b.currentAction)&&!b.currentActionSalvaged&&
(b.currentActionSalvaged=!0),b.actions.length=0,this._currentTarget==b&&!c?this._currentTargetSalvaged=!0:this._deleteHashElement(b))}},removeAction:function(a){if(null!=a){var c=a.getOriginalTarget();if(c=this._hashTargets[c.__instanceId])for(var b=0;b<c.actions.length;b++){if(c.actions[b]==a){c.actions.splice(b,1);break}}else cc.log(cc._LogInfos.ActionManager_removeAction)}},removeActionByTag:function(a,c){a==cc.ACTION_TAG_INVALID&&cc.log(cc._LogInfos.ActionManager_addAction);cc.assert(c,cc._LogInfos.ActionManager_addAction);
var b=this._hashTargets[c.__instanceId];if(b)for(var d=b.actions.length,e=0;e<d;++e){var f=b.actions[e];if(f&&f.getTag()===a&&f.getOriginalTarget()==c){this._removeActionAtIndex(e,b);break}}},getActionByTag:function(a,c){a==cc.ACTION_TAG_INVALID&&cc.log(cc._LogInfos.ActionManager_getActionByTag);var b=this._hashTargets[c.__instanceId];if(b){if(null!=b.actions)for(var d=0;d<b.actions.length;++d){var e=b.actions[d];if(e&&e.getTag()===a)return e}cc.log(cc._LogInfos.ActionManager_getActionByTag_2,a)}return null},
numberOfRunningActionsInTarget:function(a){return(a=this._hashTargets[a.__instanceId])?a.actions?a.actions.length:0:0},pauseTarget:function(a){if(a=this._hashTargets[a.__instanceId])a.paused=!0},resumeTarget:function(a){if(a=this._hashTargets[a.__instanceId])a.paused=!1},pauseAllRunningActions:function(){for(var a=[],c=this._arrayTargets,b=0;b<c.length;b++){var d=c[b];d&&!d.paused&&(d.paused=!0,a.push(d.target))}return a},resumeTargets:function(a){if(a)for(var c=0;c<a.length;c++)a[c]&&this.resumeTarget(a[c])},
purgeSharedManager:function(){cc.director.getScheduler().unscheduleUpdateForTarget(this)},_removeActionAtIndex:function(a,c){c.actions[a]==c.currentAction&&!c.currentActionSalvaged&&(c.currentActionSalvaged=!0);c.actions.splice(a,1);c.actionIndex>=a&&c.actionIndex--;0==c.actions.length&&(this._currentTarget==c?this._currentTargetSalvaged=!0:this._deleteHashElement(c))},_deleteHashElement:function(a){a&&(delete this._hashTargets[a.target.__instanceId],cc.arrayRemoveObject(this._arrayTargets,a),a.actions=
null,a.target=null)},_actionAllocWithHashElement:function(a){null==a.actions&&(a.actions=[])},update:function(a){for(var c=this._arrayTargets,b,d=0;d<c.length;d++){b=this._currentTarget=c[d];if(!b.paused)for(b.actionIndex=0;b.actionIndex<b.actions.length;b.actionIndex++)if(b.currentAction=b.actions[b.actionIndex],b.currentAction){b.currentActionSalvaged=!1;b.currentAction.step(a*(b.currentAction._speedMethod?b.currentAction._speed:1));if(b.currentActionSalvaged)b.currentAction=null;else if(b.currentAction.isDone()){b.currentAction.stop();
var e=b.currentAction;b.currentAction=null;this.removeAction(e)}b.currentAction=null}this._currentTargetSalvaged&&0===b.actions.length&&this._deleteHashElement(b)}}});cc.LabelAtlas=cc.AtlasNode.extend({_string:null,_mapStartChar:null,_textureLoaded:!1,_className:"LabelAtlas",ctor:function(a,c,b,d,e){cc.AtlasNode.prototype.ctor.call(this);this._renderCmd.setCascade();c&&cc.LabelAtlas.prototype.initWithString.call(this,a,c,b,d,e)},_createRenderCmd:function(){return cc._renderType===cc._RENDER_TYPE_WEBGL?new cc.LabelAtlas.WebGLRenderCmd(this):new cc.LabelAtlas.CanvasRenderCmd(this)},textureLoaded:function(){return this._textureLoaded},addLoadedEventListener:function(a,
c){this.addEventListener("load",a,c)},initWithString:function(a,c,b,d,e){var f=a+"",g,h;if(void 0===b){b=cc.loader.getRes(c);if(1!==parseInt(b.version,10))return cc.log("cc.LabelAtlas.initWithString(): Unsupported version. Upgrade cocos2d version"),!1;c=cc.path.changeBasename(c,b.textureFilename);d=cc.contentScaleFactor();g=parseInt(b.itemWidth,10)/d;h=parseInt(b.itemHeight,10)/d;b=String.fromCharCode(parseInt(b.firstChar,10))}else g=b||0,h=d||0,b=e||" ";var k=null,k=c instanceof cc.Texture2D?c:cc.textureCache.addImage(c);
(this._textureLoaded=c=k.isLoaded())||k.addEventListener("load",function(a){this.initWithTexture(k,g,h,f.length);this.string=f;this.dispatchEvent("load")},this);return this.initWithTexture(k,g,h,f.length)?(this._mapStartChar=b,this.string=f,!0):!1},setColor:function(a){cc.AtlasNode.prototype.setColor.call(this,a);this._renderCmd.updateAtlasValues()},getString:function(){return this._string},addChild:function(a,c,b){this._renderCmd._addChild(a);cc.Node.prototype.addChild.call(this,a,c,b)},updateAtlasValues:function(){this._renderCmd.updateAtlasValues()},
setString:function(a){a=String(a);var c=a.length;this._string=a;this.setContentSize(c*this._itemWidth,this._itemHeight);this._renderCmd.setString(a);this._renderCmd.updateAtlasValues();this.quadsToDraw=c}});(function(){var a=cc.LabelAtlas.prototype;cc.defineGetterSetter(a,"opacity",a.getOpacity,a.setOpacity);cc.defineGetterSetter(a,"color",a.getColor,a.setColor);cc.defineGetterSetter(a,"string",a.getString,a.setString)})();
cc.LabelAtlas.create=function(a,c,b,d,e){return new cc.LabelAtlas(a,c,b,d,e)};(function(){cc.LabelAtlas.CanvasRenderCmd=function(a){cc.AtlasNode.CanvasRenderCmd.call(this,a);this._needDraw=!1};var a=cc.LabelAtlas.CanvasRenderCmd.prototype=Object.create(cc.AtlasNode.CanvasRenderCmd.prototype);a.constructor=cc.LabelAtlas.CanvasRenderCmd;a.setCascade=function(){var a=this._node;a._cascadeOpacityEnabled=!0;a._cascadeColorEnabled=!1};a.updateAtlasValues=function(){for(var a=this._node,b=a._string||"",d=b.length,e=this._texture,f=a._itemWidth,g=a._itemHeight,h=0;h<d;h++){var k=b.charCodeAt(h)-
a._mapStartChar.charCodeAt(0),m=parseInt(k%a._itemsPerRow,10),k=parseInt(k/a._itemsPerRow,10),m=cc.rect(m*f,k*g,f,g),k=b.charCodeAt(h),p=a.getChildByTag(h);p?32==k?(p.init(),p.setTextureRect(cc.rect(0,0,10,10),!1,cc.size(0,0))):(p.initWithTexture(e,m),p.visible=!0):(p=new cc.Sprite,32==k?(p.init(),p.setTextureRect(cc.rect(0,0,10,10),!1,cc.size(0,0))):p.initWithTexture(e,m),cc.Node.prototype.addChild.call(a,p,0,h));p.setPosition(h*f+f/2,g/2)}};a.setString=function(a){a=this._node;if(a._children){a=
a._children;for(var b=a.length,d=0;d<b;d++){var e=a[d];e&&!e._lateChild&&(e.visible=!1)}}};a._addChild=function(){child._lateChild=!0}})();(function(){cc.LabelAtlas.WebGLRenderCmd=function(a){cc.AtlasNode.WebGLRenderCmd.call(this,a);this._needDraw=!0};var a=cc.LabelAtlas.WebGLRenderCmd.prototype=Object.create(cc.AtlasNode.WebGLRenderCmd.prototype);a.constructor=cc.LabelAtlas.WebGLRenderCmd;a.setCascade=function(){var a=this._node;a._cascadeOpacityEnabled=!0;a._cascadeColorEnabled=!0};a.rendering=function(a){cc.AtlasNode.WebGLRenderCmd.prototype.rendering.call(this,a);cc.LABELATLAS_DEBUG_DRAW&&(a=this._node.getContentSize(),a=[cc.p(0,
0),cc.p(a.width,0),cc.p(a.width,a.height),cc.p(0,a.height)],cc._drawingUtil.drawPoly(a,4,!0))};a.updateAtlasValues=function(){var a=this._node,b=a._string,d=b.length,e=this._textureAtlas,f=e.texture,g=f.pixelsWidth,f=f.pixelsHeight,h=a._itemWidth,k=a._itemHeight;a._ignoreContentScaleFactor||(h=a._itemWidth*cc.contentScaleFactor(),k=a._itemHeight*cc.contentScaleFactor());d>e.getCapacity()&&cc.log("cc.LabelAtlas._updateAtlasValues(): Invalid String length");for(var m=e.quads,p=this._displayedColor,
p={r:p.r,g:p.g,b:p.b,a:a._displayedOpacity},n=a._itemWidth,r=0;r<d;r++){var s=b.charCodeAt(r)-a._mapStartChar.charCodeAt(0),u=s%a._itemsPerRow,t=0|s/a._itemsPerRow,v;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(u=(2*u*h+1)/(2*g),s=u+(2*h-2)/(2*g),t=(2*t*k+1)/(2*f),v=t+(2*k-2)/(2*f)):(u=u*h/g,s=u+h/g,t=t*k/f,v=t+k/f);var w=m[r],q=w.tl,y=w.tr,A=w.bl,w=w.br;q.texCoords.u=u;q.texCoords.v=t;y.texCoords.u=s;y.texCoords.v=t;A.texCoords.u=u;A.texCoords.v=v;w.texCoords.u=s;w.texCoords.v=v;A.vertices.x=r*n;A.vertices.y=
0;A.vertices.z=0;w.vertices.x=r*n+n;w.vertices.y=0;w.vertices.z=0;q.vertices.x=r*n;q.vertices.y=a._itemHeight;q.vertices.z=0;y.vertices.x=r*n+n;y.vertices.y=a._itemHeight;y.vertices.z=0;q.colors=p;y.colors=p;A.colors=p;w.colors=p}0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.setString=function(a){a=a.length;a>this._textureAtlas.totalQuads&&this._textureAtlas.resizeCapacity(a)};a._addChild=function(){}})();cc.LABEL_AUTOMATIC_WIDTH=-1;
...
null==b?-1:b,this._realOpacity=255,this._realColor=cc.color(255,255,255,255),this._contentSize.width=0,this._contentSize.height=0,this.setAnchorPoint(0.5,0.5),this._renderCmd._initBatchTexture(),this.setString(a,!0),!0):!1},createFontChars:function(){var a=this._renderCmd._texture||this.textureAtlas.texture,c=0,b=cc.size(0,0),d=0,e=1,f=this._string,g=f?f.length:0;if(0!==g){var h,k=this._config,m=k.kerningDict,p=k.commonHeight,n=k.fontDefDictionary;for(h=0;h<g-1;h++)10==f.charCodeAt(h)&&e++;var r=
p*e,e=-(p-p*e),s=-1;for(h=0;h<g;h++)if(p=f.charCodeAt(h),0!=p)if(10===p)c=0,e-=k.commonHeight;else{var u=m[s<<16|p&65535]||0,t=n[p];if(t){var v=cc.rect(t.rect.x,t.rect.y,t.rect.width,t.rect.height),v=cc.rectPixelsToPoints(v);v.x+=this._imageOffset.x;v.y+=this._imageOffset.y;(s=this.getChildByTag(h))?this._renderCmd._updateCharTexture(s,v,p):(s=new cc.Sprite,s.initWithTexture(a,v,!1),s._newTextureWhenChangeColor=!0,this.addChild(s,0,h));s.opacityModifyRGB=this._opacityModifyRGB;this._renderCmd._updateCharColorAndOpacity(s);
v=cc.p(c+t.xOffset+0.5*t.rect.width+u,e+(k.commonHeight-t.yOffset)-0.5*v.height*cc.contentScaleFactor());s.setPosition(cc.pointPixelsToPoints(v));c+=t.xAdvance+u;s=p;d<c&&(d=c)}else cc.log("cocos2d: LabelBMFont: character not found "+f[h])}b.width=t&&t.xAdvance<t.rect.width?d-t.xAdvance+t.rect.width:d;b.height=r;this.setContentSize(cc.sizePixelsToPoints(b))}},updateString:function(a){var c=this._children;if(c)for(var b=0,d=c.length;b<d;b++){var e=c[b];e&&(e.visible=!1)}this._config&&this.createFontChars();
a||this.updateLabel()},getString:function(){return this._initialString},setString:function(a,c){a=String(a);null==c&&(c=!0);if(null==a||!cc.isString(a))a+="";this._initialString=a;this._setString(a,c)},_setStringForSetter:function(a){this.setString(a,!1)},setCString:function(a){this.setString(a,!0)},updateLabel:function(){this.string=this._initialString;if(0<this._width){for(var a=this._string.length,c=[],b=[],d=1,e=0,f=!1,g=!1,h=-1,k=-1,m=0,p,n=0,r=this._children.length;n<r;n++){for(var s=0;!(p=
this.getChildByTag(n+m+s));)s++;m+=s;if(e>=a)break;var u=this._string[e];g||(k=this._getLetterPosXLeft(p),g=!0);f||(h=k,f=!0);if(10==u.charCodeAt(0)){b.push("\n");c=c.concat(b);b.length=0;f=g=!1;h=k=-1;n--;m-=s;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(p),g=!0);h||(h=k,f=!0);e++}else if(this._isspace_unicode(u))b.push(u),c=c.concat(b),b.length=0,g=!1,k=-1,e++;else if(this._getLetterPosXRight(p)-h>this._width)if(this._lineBreakWithoutSpaces){this._utf8_trim_ws(b);b.push("\n");c=c.concat(b);b.length=
0;f=g=!1;h=k=-1;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(p),g=!0);h||(h=k,f=!0);n--}else b.push(u),-1!=c.lastIndexOf(" ")?this._utf8_trim_ws(c):c=[],0<c.length&&c.push("\n"),d++,f=!1,h=-1,e++;else b.push(u),e++}c=c.concat(b);n=c.length;p="";for(e=0;e<n;++e)p+=c[e];p+=String.fromCharCode(0);this._setString(p,!1)}if(this._alignment!=cc.TEXT_ALIGNMENT_LEFT){c=e=0;a=this._string.length;b=[];for(d=0;d<a;d++)if(10==this._string[d].charCodeAt(0)||0==this._string[d].charCodeAt(0))if(n=0,f=b.length,
0==f)c++;else{if(p=e+f-1+c,!(0>p)&&(n=this.getChildByTag(p),null!=n)){n=n.getPositionX()+n._getWidth()/2;g=0;switch(this._alignment){case cc.TEXT_ALIGNMENT_CENTER:g=this.width/2-n/2;break;case cc.TEXT_ALIGNMENT_RIGHT:g=this.width-n}if(0!=g)for(n=0;n<f;n++)if(p=e+n+c,!(0>p)&&(p=this.getChildByTag(p)))p.x+=g;e+=f;c++;b.length=0}}else b.push(this._string[e])}},setAlignment:function(a){this._alignment=a;this.updateLabel()},_getAlignment:function(){return this._alignment},setBoundingWidth:function(a){this._width=
a;this.updateLabel()},_getBoundingWidth:function(){return this._width},setLineBreakWithoutSpace:function(a){this._lineBreakWithoutSpaces=a;this.updateLabel()},setScale:function(a,c){cc.Node.prototype.setScale.call(this,a,c);this.updateLabel()},setScaleX:function(a){cc.Node.prototype.setScaleX.call(this,a);this.updateLabel()},setScaleY:function(a){cc.Node.prototype.setScaleY.call(this,a);this.updateLabel()},setFntFile:function(a){if(null!=a&&a!=this._fntFile){var c=cc.loader.getRes(a);c?(this._fntFile=
a,this._config=c,a=cc.textureCache.addImage(c.atlasName),this._textureLoaded=c=a.isLoaded(),this.texture=a,this._renderCmd._updateFntFileTexture(),c?this.createFontChars():a.addEventListener("load",function(a){this._textureLoaded=!0;this.texture=a;this.createFontChars();this._changeTextureColor();this.updateLabel();this.dispatchEvent("load")},this)):cc.log("cc.LabelBMFont.setFntFile() : Impossible to create font. Please check file")}},getFntFile:function(){return this._fntFile},setTexture:function(a){this._renderCmd.setTexture(a)},
setAnchorPoint:function(a,c){cc.Node.prototype.setAnchorPoint.call(this,a,c);this.updateLabel()},_setAnchorX:function(a){cc.Node.prototype._setAnchorX.call(this,a);this.updateLabel()},_setAnchorY:function(a){cc.Node.prototype._setAnchorY.call(this,a);this.updateLabel()},_atlasNameFromFntFile:function(a){},_kerningAmountForFirst:function(a,c){var b=0;if(this._configuration.kerningDictionary){var d=this._configuration.kerningDictionary[(a<<16|c&65535).toString()];d&&(b=d.amount)}return b},_getLetterPosXLeft:function(a){return a.getPositionX()*
this._scaleX-a._getWidth()*this._scaleX*a._getAnchorX()},_getLetterPosXRight:function(a){return a.getPositionX()*this._scaleX+a._getWidth()*this._scaleX*a._getAnchorX()},_isspace_unicode:function(a){a=a.charCodeAt(0);return 9<=a&&13>=a||32==a||133==a||160==a||5760==a||8192<=a&&8202>=a||8232==a||8233==a||8239==a||8287==a||12288==a},_utf8_trim_ws:function(a){var c=a.length;if(!(0>=c)&&(c-=1,this._isspace_unicode(a[c]))){for(var b=c-1;0<=b;--b)if(this._isspace_unicode(a[b]))c=b;else break;this._utf8_trim_from(a,
c)}},_utf8_trim_from:function(a,c){var b=a.length;c>=b||0>c||a.splice(c,b)}});(function(){var a=cc.LabelBMFont.prototype;cc.EventHelper.prototype.apply(a);cc.defineGetterSetter(a,"string",a.getString,a._setStringForSetter);cc.defineGetterSetter(a,"boundingWidth",a._getBoundingWidth,a.setBoundingWidth);cc.defineGetterSetter(a,"textAlign",a._getAlignment,a.setAlignment)})();cc.LabelBMFont.create=function(a,c,b,d,e){return new cc.LabelBMFont(a,c,b,d,e)};
cc._fntLoader={INFO_EXP:/info [^\n]*(\n|$)/gi,COMMON_EXP:/common [^\n]*(\n|$)/gi,PAGE_EXP:/page [^\n]*(\n|$)/gi,CHAR_EXP:/char [^\n]*(\n|$)/gi,KERNING_EXP:/kerning [^\n]*(\n|$)/gi,ITEM_EXP:/\w+=[^ \r\n]+/gi,INT_EXP:/^[\-]?\d+$/,_parseStrToObj:function(a){a=a.match(this.ITEM_EXP);var c={};if(a)for(var b=0,d=a.length;b<d;b++){var e=a[b],f=e.indexOf("\x3d"),g=e.substring(0,f),e=e.substring(f+1);e.match(this.INT_EXP)?e=parseInt(e):'"'==e[0]&&(e=e.substring(1,e.length-1));c[g]=e}return c},parseFnt:function(a,
c){var b={},d=this._parseStrToObj(a.match(this.INFO_EXP)[0]).padding.split(",");parseInt(d[0]);parseInt(d[1]);parseInt(d[2]);parseInt(d[3]);d=this._parseStrToObj(a.match(this.COMMON_EXP)[0]);b.commonHeight=d.lineHeight;if(cc._renderType===cc._RENDER_TYPE_WEBGL){var e=cc.configuration.getMaxTextureSize();(d.scaleW>e.width||d.scaleH>e.height)&&cc.log("cc.LabelBMFont._parseCommonArguments(): page can't be larger than supported")}1!==d.pages&&cc.log("cc.LabelBMFont._parseCommonArguments(): only supports 1 page");
d=this._parseStrToObj(a.match(this.PAGE_EXP)[0]);0!==d.id&&cc.log("cc.LabelBMFont._parseImageFileName() : file could not be found");b.atlasName=cc.path.changeBasename(c,d.file);for(var f=a.match(this.CHAR_EXP),g=b.fontDefDictionary={},d=0,e=f.length;d<e;d++){var h=this._parseStrToObj(f[d]);g[h.id]={rect:{x:h.x,y:h.y,width:h.width,height:h.height},xOffset:h.xoffset,yOffset:h.yoffset,xAdvance:h.xadvance}}f=b.kerningDict={};if(g=a.match(this.KERNING_EXP)){d=0;for(e=g.length;d<e;d++)h=this._parseStrToObj(g[d]),
f[h.first<<16|h.second&65535]=h.amount}return b},load:function(a,c,b,d){var e=this;cc.loader.loadTxt(a,function(a,b){if(a)return d(a);d(null,e.parseFnt(b,c))})}};cc.loader.register(["fnt"],cc._fntLoader);(function(){cc.LabelBMFont.CanvasRenderCmd=function(a){cc.SpriteBatchNode.CanvasRenderCmd.call(this,a);this._needDraw=!0};var a=cc.LabelBMFont.CanvasRenderCmd.prototype=Object.create(cc.SpriteBatchNode.CanvasRenderCmd.prototype);a.constructor=cc.LabelBMFont.CanvasRenderCmd;a.rendering=function(){void 0};a._updateCharTexture=function(a,b,d){32===d?a.setTextureRect(b,!1,cc.size(0,0)):(a.setTextureRect(b,!1),a.visible=!0)};a._updateCharColorAndOpacity=function(a){a._displayedColor=this._displayedColor;
a._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.colorDirty);a._displayedOpacity=this._displayedOpacity;a._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.opacityDirty)};a._updateFntFileTexture=function(){var a=this._node;a._originalTexture=a.texture};a.setTexture=function(a){for(var b=this._node,d=b._children,b=b._displayedColor,e=0;e<d.length;e++){var f=d[e],g=f._renderCmd,h=g._displayedColor;this._texture!=g._texture&&(h.r!==b.r||h.g!==b.g||h.b!==b.b)||(f.texture=a)}this._texture=a};a._changeTextureColor=
cc.sys._supportCanvasNewBlendModes?function(){var a=this._node,b=a.getTexture();if(b&&0<b.getContentSize().width){var d=this._originalTexture.getHtmlElementObj();if(d){var e=b.getHtmlElementObj(),f=cc.rect(0,0,d.width,d.height);e instanceof HTMLCanvasElement&&!a._rectRotated?cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply(d,this._displayedColor,f,e):(e=cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply(d,this._displayedColor,f),b=new cc.Texture2D,b.initWithElement(e),b.handleLoadedTexture());
a.setTexture(b)}}}:function(){var a=this._node,b,d=a.getTexture();if(d&&0<d.getContentSize().width&&(b=d.getHtmlElementObj())){var e=cc.textureCache.getTextureColors(this._originalTexture.getHtmlElementObj());e&&(b instanceof HTMLCanvasElement&&!this._rectRotated?(cc.Sprite.CanvasRenderCmd._generateTintImage(b,e,this._displayedColor,null,b),this.setTexture(d)):(b=cc.Sprite.CanvasRenderCmd._generateTintImage(b,e,this._displayedColor),d=new cc.Texture2D,d.initWithElement(b),d.handleLoadedTexture(),
a.setTexture(d)))}};a._updateChildrenDisplayedOpacity=function(a){cc.Node.prototype.updateDisplayedOpacity.call(a,this._displayedOpacity)};a._updateChildrenDisplayedColor=function(a){cc.Node.prototype.updateDisplayedColor.call(a,this._displayedColor)};a._initBatchTexture=function(){}})();(function(){cc.LabelBMFont.WebGLRenderCmd=function(a){cc.SpriteBatchNode.WebGLRenderCmd.call(this,a);this._needDraw=!0};var a=cc.LabelBMFont.WebGLRenderCmd.prototype=Object.create(cc.SpriteBatchNode.WebGLRenderCmd.prototype);a.constructor=cc.LabelBMFont.WebGLRenderCmd;a._updateCharTexture=function(a,b,d){a.setTextureRect(b,!1);a.visible=!0};a._updateFntFileTexture=function(){};a._changeTextureColor=function(){};a._updateChildrenDisplayedOpacity=function(a){a.updateDisplayedOpacity(this._displayedOpacity)};
a._updateChildrenDisplayedColor=function(a){a.updateDisplayedColor(this._displayedColor)};a._initBatchTexture=function(){var a=this._node,b=a.textureAtlas.texture;a._opacityModifyRGB=b.hasPremultipliedAlpha();var d=a._reusedChar=new cc.Sprite;d.initWithTexture(b,cc.rect(0,0,0,0),!1);d.batchNode=a};a.rendering=function(a){cc.SpriteBatchNode.WebGLRenderCmd.prototype.rendering.call(this,a);a=this._node;if(cc.LABELBMFONT_DEBUG_DRAW){a=a.getContentSize();var b=cc.p(0|-this._anchorPointInPoints.x,0|-this._anchorPointInPoints.y);
a=[cc.p(b.x,b.y),cc.p(b.x+a.width,b.y),cc.p(b.x+a.width,b.y+a.height),cc.p(b.x,b.y+a.height)];cc._drawingUtil.setDrawColor(0,255,0,255);cc._drawingUtil.drawPoly(a,4,!0)}};a._updateCharColorAndOpacity=function(){}})();cc.IMEKeyboardNotificationInfo=function(a,c,b){this.begin=a||cc.rect(0,0,0,0);this.end=c||cc.rect(0,0,0,0);this.duration=b||0};
...
0),this._domInputControl.style.opacity="0",this._domInputControl.style.fontSize="1px",this._domInputControl.setAttribute("tabindex",2),this._domInputControl.style.position="absolute",this._domInputControl.style.top=0,this._domInputControl.style.left=0,document.body.appendChild(this._domInputControl));var a=this;cc._addEventListener(this._domInputControl,"input",function(){a._processDomInputString(a._domInputControl.value)},!1);cc._addEventListener(this._domInputControl,"keydown",function(c){c.keyCode===
cc.KEY.tab?(c.stopPropagation(),c.preventDefault()):c.keyCode==cc.KEY.enter&&(a.dispatchInsertText("\n",1),c.stopPropagation(),c.preventDefault())},!1);/msie/i.test(navigator.userAgent)&&cc._addEventListener(this._domInputControl,"keyup",function(c){c.keyCode==cc.KEY.backspace&&a._processDomInputString(a._domInputControl.value)},!1);cc._addEventListener(window,"mousedown",function(c){var b=c.pageY||0;a._lastClickPosition.x=c.pageX||0;a._lastClickPosition.y=b},!1)}},_processDomInputString:function(a){var c,
b;c=this._currentInputString.length<a.length?this._currentInputString.length:a.length;for(b=0;b<c&&a[b]===this._currentInputString[b];b++);var d=this._currentInputString.length-b,e=a.length-b;for(c=0;c<d;c++)this.dispatchDeleteBackward();for(c=0;c<e;c++)this.dispatchInsertText(a[b+c],1);this._currentInputString=a},dispatchInsertText:function(a,c){this.impl&&a&&!(0>=c)&&this.impl._delegateWithIme&&this.impl._delegateWithIme.insertText(a,c)},dispatchDeleteBackward:function(){this.impl&&this.impl._delegateWithIme&&
this.impl._delegateWithIme.deleteBackward()},getContentText:function(){if(this.impl&&this.impl._delegateWithIme){var a=this.impl._delegateWithIme.getContentText();return a?a:""}return""},dispatchKeyboardWillShow:function(a){if(this.impl)for(var c=0;c<this.impl._delegateList.length;c++){var b=this.impl._delegateList[c];b&&b.keyboardWillShow(a)}},dispatchKeyboardDidShow:function(a){if(this.impl)for(var c=0;c<this.impl._delegateList.length;c++){var b=this.impl._delegateList[c];b&&b.keyboardDidShow(a)}},
dispatchKeyboardWillHide:function(a){if(this.impl)for(var c=0;c<this.impl._delegateList.length;c++){var b=this.impl._delegateList[c];b&&b.keyboardWillHide(a)}},dispatchKeyboardDidHide:function(a){if(this.impl)for(var c=0;c<this.impl._delegateList.length;c++){var b=this.impl._delegateList[c];b&&b.keyboardDidHide(a)}},addDelegate:function(a){a&&this.impl&&(-1<this.impl._delegateList.indexOf(a)||this.impl._delegateList.splice(0,0,a))},attachDelegateWithIME:function(a){if(!this.impl||!a||-1==this.impl._delegateList.indexOf(a))return!1;
...
a==cc.KEY.enter&&this.dispatchInsertText("\n",1):255>a&&this.dispatchInsertText(String.fromCharCode(a),1)}});cc.IMEDispatcher.Impl=cc.Class.extend({_delegateWithIme:null,_delegateList:null,ctor:function(){this._delegateList=[]},findDelegate:function(a){for(var c=0;c<this._delegateList.length;c++)if(this._delegateList[c]==a)return c;return null}});cc.imeDispatcher=new cc.IMEDispatcher;document.body?cc.imeDispatcher.init():cc._addEventListener(window,"load",function(){cc.imeDispatcher.init()},!1);cc.TextFieldDelegate=cc.Class.extend({onTextFieldAttachWithIME:function(a){return!1},onTextFieldDetachWithIME:function(a){return!1},onTextFieldInsertText:function(a,c,b){return!1},onTextFieldDeleteBackward:function(a,c,b){return!1},onDraw:function(a){return!1}});
cc.TextFieldTTF=cc.LabelTTF.extend({delegate:null,colorSpaceHolder:null,_colorText:null,_lens:null,_inputText:"",_placeHolder:"",_charCount:0,_className:"TextFieldTTF",ctor:function(a,c,b,d,e){this.colorSpaceHolder=cc.color(127,127,127);this._colorText=cc.color(255,255,255,255);cc.imeDispatcher.addDelegate(this);cc.LabelTTF.prototype.ctor.call(this);void 0!==e?(this.initWithPlaceHolder("",c,b,d,e),a&&this.setPlaceHolder(a)):void 0===d&&void 0!==b&&(this.initWithString("",c,b),a&&this.setPlaceHolder(a))},
...
255:a.a},initWithPlaceHolder:function(a,c,b,d,e){switch(arguments.length){case 5:return a&&this.setPlaceHolder(a),this.initWithString(this._placeHolder,d,e,c,b);case 3:return a&&this.setPlaceHolder(a),this.initWithString(this._placeHolder,arguments[1],arguments[2]);default:throw"Argument must be non-nil ";}},setString:function(a){this._inputText=(a=String(a))||"";this._inputText.length?(cc.LabelTTF.prototype.setString.call(this,this._inputText),this.setColor(this._colorText)):(cc.LabelTTF.prototype.setString.call(this,
...
deleteBackward:function(){var a=this._inputText.length;if(0!=a&&(!this.delegate||!this.delegate.onTextFieldDeleteBackward(this,this._inputText[a-1],1)))1>=a?(this._inputText="",this._charCount=0,cc.LabelTTF.prototype.setString.call(this,this._placeHolder),this.setColor(this.colorSpaceHolder)):this.string=this._inputText.substring(0,a-1)},removeDelegate:function(){cc.imeDispatcher.removeDelegate(this)},insertText:function(a,c){var b=a,d=b.indexOf("\n");-1<d&&(b=b.substring(0,d));if(0<b.length){if(this.delegate&&
this.delegate.onTextFieldInsertText(this,b,b.length))return;b=this._inputText+b;this._charCount=b.length;this.string=b}-1!=d&&(!this.delegate||!this.delegate.onTextFieldInsertText(this,"\n",1))&&this.detachWithIME()},getContentText:function(){return this._inputText},keyboardWillShow:function(a){},keyboardDidShow:function(a){},keyboardWillHide:function(a){},keyboardDidHide:function(a){}});_p=cc.TextFieldTTF.prototype;cc.defineGetterSetter(_p,"charCount",_p.getCharCount);
cc.defineGetterSetter(_p,"placeHolder",_p.getPlaceHolder,_p.setPlaceHolder);cc.TextFieldTTF.create=function(a,c,b,d,e){return new cc.TextFieldTTF(a,c,b,d,e)};cc.ACTION_TAG_INVALID=-1;
...
c)},isDone:function(){return!this._followedNode.running},stop:function(){this.target=null;cc.Action.prototype.stop.call(this)}});cc.follow=function(a,c){return new cc.Follow(a,c)};cc.Follow.create=cc.follow;cc.ActionInterval=cc.FiniteTimeAction.extend({_elapsed:0,_firstTick:!1,_easeList:null,_times:1,_repeatForever:!1,_repeatMethod:!1,_speed:1,_speedMethod:!1,ctor:function(a){this._times=this._speed=1;this._repeatForever=!1;this.MAX_VALUE=2;this._speedMethod=this._repeatMethod=!1;cc.FiniteTimeAction.prototype.ctor.call(this);void 0!==a&&this.initWithDuration(a)},getElapsed:function(){return this._elapsed},initWithDuration:function(a){this._duration=0===a?cc.FLT_EPSILON:a;this._elapsed=0;return this._firstTick=
!0},isDone:function(){return this._elapsed>=this._duration},_cloneDecoration:function(a){a._repeatForever=this._repeatForever;a._speed=this._speed;a._times=this._times;a._easeList=this._easeList;a._speedMethod=this._speedMethod;a._repeatMethod=this._repeatMethod},_reverseEaseList:function(a){if(this._easeList){a._easeList=[];for(var c=0;c<this._easeList.length;c++)a._easeList.push(this._easeList[c].reverse())}},clone:function(){var a=new cc.ActionInterval(this._duration);this._cloneDecoration(a);
return a},easing:function(a){this._easeList?this._easeList.length=0:this._easeList=[];for(var c=0;c<arguments.length;c++)this._easeList.push(arguments[c]);return this},_computeEaseTime:function(a){var c=this._easeList;if(!c||0===c.length)return a;for(var b=0,d=c.length;b<d;b++)a=c[b].easing(a);return a},step:function(a){this._firstTick?(this._firstTick=!1,this._elapsed=0):this._elapsed+=a;a=this._elapsed/(1.192092896E-7<this._duration?this._duration:1.192092896E-7);a=1>a?a:1;this.update(0<a?a:0);
...
cc.Sequence=cc.ActionInterval.extend({_actions:null,_split:null,_last:0,ctor:function(a){cc.ActionInterval.prototype.ctor.call(this);this._actions=[];var c=a instanceof Array?a:arguments,b=c.length-1;0<=b&&null==c[b]&&cc.log("parameters should not be ending with null in Javascript");if(0<=b){for(var d=c[0],e=1;e<b;e++)c[e]&&(d=cc.Sequence._actionOneTwo(d,c[e]));this.initWithTwoActions(d,c[b])}},initWithTwoActions:function(a,c){if(!a||!c)throw"cc.Sequence.initWithTwoActions(): arguments must all be non nil";
...
0,b=this._split,d=this._actions,e=this._last;a=this._computeEaseTime(a);a<b?(a=0!==b?a/b:1,0===c&&1===e&&(d[1].update(0),d[1].stop())):(c=1,a=1===b?1:(a-b)/(1-b),-1===e&&(d[0].startWithTarget(this.target),d[0].update(1),d[0].stop()),e||(d[0].update(1),d[0].stop()));d=d[c];e===c&&d.isDone()||(e!==c&&d.startWithTarget(this.target),a*=d._times,d.update(1<a?a%1:a),this._last=c)},reverse:function(){var a=cc.Sequence._actionOneTwo(this._actions[1].reverse(),this._actions[0].reverse());this._cloneDecoration(a);
this._reverseEaseList(a);return a}});cc.sequence=function(a){var c=a instanceof Array?a:arguments;0<c.length&&null==c[c.length-1]&&cc.log("parameters should not be ending with null in Javascript");for(var b=c[0],d=1;d<c.length;d++)c[d]&&(b=cc.Sequence._actionOneTwo(b,c[d]));return b};cc.Sequence.create=cc.sequence;cc.Sequence._actionOneTwo=function(a,c){var b=new cc.Sequence;b.initWithTwoActions(a,c);return b};
...
cc.Spawn=cc.ActionInterval.extend({_one:null,_two:null,ctor:function(a){cc.ActionInterval.prototype.ctor.call(this);this._two=this._one=null;var c=a instanceof Array?a:arguments,b=c.length-1;0<=b&&null==c[b]&&cc.log("parameters should not be ending with null in Javascript");if(0<=b){for(var d=c[0],e=1;e<b;e++)c[e]&&(d=cc.Spawn._actionOneTwo(d,c[e]));this.initWithTwoActions(d,c[b])}},initWithTwoActions:function(a,c){if(!a||!c)throw"cc.Spawn.initWithTwoActions(): arguments must all be non null";var b=
!1,d=a._duration,e=c._duration;this.initWithDuration(Math.max(d,e))&&(this._one=a,this._two=c,d>e?this._two=cc.Sequence._actionOneTwo(c,cc.delayTime(d-e)):d<e&&(this._one=cc.Sequence._actionOneTwo(a,cc.delayTime(e-d))),b=!0);return b},clone:function(){var a=new cc.Spawn;this._cloneDecoration(a);a.initWithTwoActions(this._one.clone(),this._two.clone());return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);this._one.startWithTarget(a);this._two.startWithTarget(a)},
...
cc.spawn=function(a){var c=a instanceof Array?a:arguments;0<c.length&&null==c[c.length-1]&&cc.log("parameters should not be ending with null in Javascript");for(var b=c[0],d=1;d<c.length;d++)null!=c[d]&&(b=cc.Spawn._actionOneTwo(b,c[d]));return b};cc.Spawn.create=cc.spawn;cc.Spawn._actionOneTwo=function(a,c){var b=new cc.Spawn;b.initWithTwoActions(a,c);return b};
cc.RotateTo=cc.ActionInterval.extend({_dstAngleX:0,_startAngleX:0,_diffAngleX:0,_dstAngleY:0,_startAngleY:0,_diffAngleY:0,ctor:function(a,c,b){cc.ActionInterval.prototype.ctor.call(this);void 0!==c&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._dstAngleX=c||0,this._dstAngleY=b||this._dstAngleX,!0):!1},clone:function(){var a=new cc.RotateTo;this._cloneDecoration(a);a.initWithDuration(this._duration,this._dstAngleX,
this._dstAngleY);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);var c=a.rotationX%360,b=this._dstAngleX-c;180<b&&(b-=360);-180>b&&(b+=360);this._startAngleX=c;this._diffAngleX=b;this._startAngleY=a.rotationY%360;a=this._dstAngleY-this._startAngleY;180<a&&(a-=360);-180>a&&(a+=360);this._diffAngleY=a},reverse:function(){cc.log("cc.RotateTo.reverse(): it should be overridden in subclass.")},update:function(a){a=this._computeEaseTime(a);this.target&&(this.target.rotationX=
this._startAngleX+this._diffAngleX*a,this.target.rotationY=this._startAngleY+this._diffAngleY*a)}});cc.rotateTo=function(a,c,b){return new cc.RotateTo(a,c,b)};cc.RotateTo.create=cc.rotateTo;
cc.RotateBy=cc.ActionInterval.extend({_angleX:0,_startAngleX:0,_angleY:0,_startAngleY:0,ctor:function(a,c,b){cc.ActionInterval.prototype.ctor.call(this);void 0!==c&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._angleX=c||0,this._angleY=b||this._angleX,!0):!1},clone:function(){var a=new cc.RotateBy;this._cloneDecoration(a);a.initWithDuration(this._duration,this._angleX,this._angleY);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,
a);this._startAngleX=a.rotationX;this._startAngleY=a.rotationY},update:function(a){a=this._computeEaseTime(a);this.target&&(this.target.rotationX=this._startAngleX+this._angleX*a,this.target.rotationY=this._startAngleY+this._angleY*a)},reverse:function(){var a=new cc.RotateBy(this._duration,-this._angleX,-this._angleY);this._cloneDecoration(a);this._reverseEaseList(a);return a}});cc.rotateBy=function(a,c,b){return new cc.RotateBy(a,c,b)};cc.RotateBy.create=cc.rotateBy;
cc.MoveBy=cc.ActionInterval.extend({_positionDelta:null,_startPosition:null,_previousPosition:null,ctor:function(a,c,b){cc.ActionInterval.prototype.ctor.call(this);this._positionDelta=cc.p(0,0);this._startPosition=cc.p(0,0);this._previousPosition=cc.p(0,0);void 0!==c&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(void 0!==c.x&&(b=c.y,c=c.x),this._positionDelta.x=c,this._positionDelta.y=b,!0):!1},clone:function(){var a=
new cc.MoveBy;this._cloneDecoration(a);a.initWithDuration(this._duration,this._positionDelta);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);var c=a.getPositionX();a=a.getPositionY();this._previousPosition.x=c;this._previousPosition.y=a;this._startPosition.x=c;this._startPosition.y=a},update:function(a){a=this._computeEaseTime(a);if(this.target){var c=this._positionDelta.x*a;a*=this._positionDelta.y;var b=this._startPosition;if(cc.ENABLE_STACKABLE_ACTIONS){var d=
this.target.getPositionX(),e=this.target.getPositionY(),f=this._previousPosition;b.x=b.x+d-f.x;b.y=b.y+e-f.y;c+=b.x;a+=b.y;f.x=c;f.y=a;this.target.setPosition(c,a)}else this.target.setPosition(b.x+c,b.y+a)}},reverse:function(){var a=new cc.MoveBy(this._duration,cc.p(-this._positionDelta.x,-this._positionDelta.y));this._cloneDecoration(a);this._reverseEaseList(a);return a}});cc.moveBy=function(a,c,b){return new cc.MoveBy(a,c,b)};cc.MoveBy.create=cc.moveBy;
cc.MoveTo=cc.MoveBy.extend({_endPosition:null,ctor:function(a,c,b){cc.MoveBy.prototype.ctor.call(this);this._endPosition=cc.p(0,0);void 0!==c&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){return cc.MoveBy.prototype.initWithDuration.call(this,a,c,b)?(void 0!==c.x&&(b=c.y,c=c.x),this._endPosition.x=c,this._endPosition.y=b,!0):!1},clone:function(){var a=new cc.MoveTo;this._cloneDecoration(a);a.initWithDuration(this._duration,this._endPosition);return a},startWithTarget:function(a){cc.MoveBy.prototype.startWithTarget.call(this,
a);this._positionDelta.x=this._endPosition.x-a.getPositionX();this._positionDelta.y=this._endPosition.y-a.getPositionY()}});cc.moveTo=function(a,c,b){return new cc.MoveTo(a,c,b)};cc.MoveTo.create=cc.moveTo;
cc.SkewTo=cc.ActionInterval.extend({_skewX:0,_skewY:0,_startSkewX:0,_startSkewY:0,_endSkewX:0,_endSkewY:0,_deltaX:0,_deltaY:0,ctor:function(a,c,b){cc.ActionInterval.prototype.ctor.call(this);void 0!==b&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){var d=!1;cc.ActionInterval.prototype.initWithDuration.call(this,a)&&(this._endSkewX=c,this._endSkewY=b,d=!0);return d},clone:function(){var a=new cc.SkewTo;this._cloneDecoration(a);a.initWithDuration(this._duration,this._endSkewX,this._endSkewY);
...
this._startSkewY+this._deltaY*a}});cc.skewTo=function(a,c,b){return new cc.SkewTo(a,c,b)};cc.SkewTo.create=cc.skewTo;
cc.SkewBy=cc.SkewTo.extend({ctor:function(a,c,b){cc.SkewTo.prototype.ctor.call(this);void 0!==b&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){var d=!1;cc.SkewTo.prototype.initWithDuration.call(this,a,c,b)&&(this._skewX=c,this._skewY=b,d=!0);return d},clone:function(){var a=new cc.SkewBy;this._cloneDecoration(a);a.initWithDuration(this._duration,this._skewX,this._skewY);return a},startWithTarget:function(a){cc.SkewTo.prototype.startWithTarget.call(this,a);this._deltaX=this._skewX;
this._deltaY=this._skewY;this._endSkewX=this._startSkewX+this._deltaX;this._endSkewY=this._startSkewY+this._deltaY},reverse:function(){var a=new cc.SkewBy(this._duration,-this._skewX,-this._skewY);this._cloneDecoration(a);this._reverseEaseList(a);return a}});cc.skewBy=function(a,c,b){return new cc.SkewBy(a,c,b)};cc.SkewBy.create=cc.skewBy;
cc.JumpBy=cc.ActionInterval.extend({_startPosition:null,_delta:null,_height:0,_jumps:0,_previousPosition:null,ctor:function(a,c,b,d,e){cc.ActionInterval.prototype.ctor.call(this);this._startPosition=cc.p(0,0);this._previousPosition=cc.p(0,0);this._delta=cc.p(0,0);void 0!==d&&this.initWithDuration(a,c,b,d,e)},initWithDuration:function(a,c,b,d,e){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(void 0===e&&(e=d,d=b,b=c.y,c=c.x),this._delta.x=c,this._delta.y=b,this._height=d,this._jumps=
...
a;a*=this._delta.x;var b=this._startPosition;if(cc.ENABLE_STACKABLE_ACTIONS){var d=this.target.getPositionX(),e=this.target.getPositionY(),f=this._previousPosition;b.x=b.x+d-f.x;b.y=b.y+e-f.y;a+=b.x;c+=b.y;f.x=a;f.y=c;this.target.setPosition(a,c)}else this.target.setPosition(b.x+a,b.y+c)}},reverse:function(){var a=new cc.JumpBy(this._duration,cc.p(-this._delta.x,-this._delta.y),this._height,this._jumps);this._cloneDecoration(a);this._reverseEaseList(a);return a}});
cc.jumpBy=function(a,c,b,d,e){return new cc.JumpBy(a,c,b,d,e)};cc.JumpBy.create=cc.jumpBy;
cc.JumpTo=cc.JumpBy.extend({_endPosition:null,ctor:function(a,c,b,d,e){cc.JumpBy.prototype.ctor.call(this);this._endPosition=cc.p(0,0);void 0!==d&&this.initWithDuration(a,c,b,d,e)},initWithDuration:function(a,c,b,d,e){return cc.JumpBy.prototype.initWithDuration.call(this,a,c,b,d,e)?(void 0===e&&(b=c.y,c=c.x),this._endPosition.x=c,this._endPosition.y=b,!0):!1},startWithTarget:function(a){cc.JumpBy.prototype.startWithTarget.call(this,a);this._delta.x=this._endPosition.x-this._startPosition.x;this._delta.y=
this._endPosition.y-this._startPosition.y},clone:function(){var a=new cc.JumpTo;this._cloneDecoration(a);a.initWithDuration(this._duration,this._endPosition,this._height,this._jumps);return a}});cc.jumpTo=function(a,c,b,d,e){return new cc.JumpTo(a,c,b,d,e)};cc.JumpTo.create=cc.jumpTo;cc.bezierAt=function(a,c,b,d,e){return Math.pow(1-e,3)*a+3*e*Math.pow(1-e,2)*c+3*Math.pow(e,2)*(1-e)*b+Math.pow(e,3)*d};
cc.BezierBy=cc.ActionInterval.extend({_config:null,_startPosition:null,_previousPosition:null,ctor:function(a,c){cc.ActionInterval.prototype.ctor.call(this);this._config=[];this._startPosition=cc.p(0,0);this._previousPosition=cc.p(0,0);c&&this.initWithDuration(a,c)},initWithDuration:function(a,c){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._config=c,!0):!1},clone:function(){var a=new cc.BezierBy;this._cloneDecoration(a);for(var c=[],b=0;b<this._config.length;b++){var d=
this._config[b];c.push(cc.p(d.x,d.y))}a.initWithDuration(this._duration,c);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);var c=a.getPositionX();a=a.getPositionY();this._previousPosition.x=c;this._previousPosition.y=a;this._startPosition.x=c;this._startPosition.y=a},update:function(a){a=this._computeEaseTime(a);if(this.target){var c=this._config,b=c[0].y,d=c[1].y,e=c[2].y,c=cc.bezierAt(0,c[0].x,c[1].x,c[2].x,a);a=cc.bezierAt(0,b,d,e,a);b=this._startPosition;
if(cc.ENABLE_STACKABLE_ACTIONS){var d=this.target.getPositionX(),e=this.target.getPositionY(),f=this._previousPosition;b.x=b.x+d-f.x;b.y=b.y+e-f.y;c+=b.x;a+=b.y;f.x=c;f.y=a;this.target.setPosition(c,a)}else this.target.setPosition(b.x+c,b.y+a)}},reverse:function(){var a=this._config,a=[cc.pAdd(a[1],cc.pNeg(a[2])),cc.pAdd(a[0],cc.pNeg(a[2])),cc.pNeg(a[2])],a=new cc.BezierBy(this._duration,a);this._cloneDecoration(a);this._reverseEaseList(a);return a}});
...
this._endScaleY);return a}});cc.scaleBy=function(a,c,b){return new cc.ScaleBy(a,c,b)};cc.ScaleBy.create=cc.scaleBy;
...
cc.TintTo=cc.ActionInterval.extend({_to:null,_from:null,ctor:function(a,c,b,d){cc.ActionInterval.prototype.ctor.call(this);this._to=cc.color(0,0,0);this._from=cc.color(0,0,0);void 0!==d&&this.initWithDuration(a,c,b,d)},initWithDuration:function(a,c,b,d){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._to=cc.color(c,b,d),!0):!1},clone:function(){var a=new cc.TintTo;this._cloneDecoration(a);var c=this._to;a.initWithDuration(this._duration,c.r,c.g,c.b);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,
a);this._from=this.target.color},update:function(a){a=this._computeEaseTime(a);var c=this._from,b=this._to;c&&(this.target.color=cc.color(c.r+(b.r-c.r)*a,c.g+(b.g-c.g)*a,c.b+(b.b-c.b)*a))}});cc.tintTo=function(a,c,b,d){return new cc.TintTo(a,c,b,d)};cc.TintTo.create=cc.tintTo;
cc.TintBy=cc.ActionInterval.extend({_deltaR:0,_deltaG:0,_deltaB:0,_fromR:0,_fromG:0,_fromB:0,ctor:function(a,c,b,d){cc.ActionInterval.prototype.ctor.call(this);void 0!==d&&this.initWithDuration(a,c,b,d)},initWithDuration:function(a,c,b,d){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._deltaR=c,this._deltaG=b,this._deltaB=d,!0):!1},clone:function(){var a=new cc.TintBy;this._cloneDecoration(a);a.initWithDuration(this._duration,this._deltaR,this._deltaG,this._deltaB);return a},
...
cc.Animate=cc.ActionInterval.extend({_animation:null,_nextFrame:0,_origFrame:null,_executedLoops:0,_splitTimes:null,ctor:function(a){cc.ActionInterval.prototype.ctor.call(this);this._splitTimes=[];a&&this.initWithAnimation(a)},getAnimation:function(){return this._animation},setAnimation:function(a){this._animation=a},initWithAnimation:function(a){if(!a)throw"cc.Animate.initWithAnimation(): animation must be non-NULL";var c=a.getDuration();if(this.initWithDuration(c*a.getLoops())){this._nextFrame=
0;this.setAnimation(a);this._origFrame=null;this._executedLoops=0;var b=this._splitTimes,d=b.length=0,e=c/a.getTotalDelayUnits();a=a.getFrames();cc.arrayVerifyType(a,cc.AnimationFrame);for(var f=0;f<a.length;f++){var g=d*e/c,d=d+a[f].getDelayUnits();b.push(g)}return!0}return!1},clone:function(){var a=new cc.Animate;this._cloneDecoration(a);a.initWithAnimation(this._animation.clone());return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);this._animation.getRestoreOriginalFrame()&&
(this._origFrame=a.displayFrame());this._executedLoops=this._nextFrame=0},update:function(a){a=this._computeEaseTime(a);1>a&&(a*=this._animation.getLoops(),(0|a)>this._executedLoops&&(this._nextFrame=0,this._executedLoops++),a%=1);for(var c=this._animation.getFrames(),b=c.length,d=this._splitTimes,e=this._nextFrame;e<b;e++)if(d[e]<=a)this.target.setSpriteFrame(c[e].getSpriteFrame()),this._nextFrame=e+1;else break},reverse:function(){var a=this._animation,c=a.getFrames(),b=[];cc.arrayVerifyType(c,
cc.AnimationFrame);if(0<c.length)for(var d=c.length-1;0<=d;d--){var e=c[d];if(!e)break;b.push(e.clone())}c=new cc.Animation(b,a.getDelayPerUnit(),a.getLoops());c.setRestoreOriginalFrame(a.getRestoreOriginalFrame());a=new cc.Animate(c);this._cloneDecoration(a);this._reverseEaseList(a);return a},stop:function(){this._animation.getRestoreOriginalFrame()&&this.target&&this.target.setSpriteFrame(this._origFrame);cc.Action.prototype.stop.call(this)}});cc.animate=function(a){return new cc.Animate(a)};
...
this._centerYOrig=c.y;this._centerZOrig=c.z;c=a.getEye();this._eyeXOrig=c.x;this._eyeYOrig=c.y;this._eyeZOrig=c.z;a=a.getUp();this._upXOrig=a.x;this._upYOrig=a.y;this._upZOrig=a.z},clone:function(){return new cc.ActionCamera},reverse:function(){return new cc.ReverseTime(this)}});
cc.OrbitCamera=cc.ActionCamera.extend({_radius:0,_deltaRadius:0,_angleZ:0,_deltaAngleZ:0,_angleX:0,_deltaAngleX:0,_radZ:0,_radDeltaZ:0,_radX:0,_radDeltaX:0,ctor:function(a,c,b,d,e,f,g){cc.ActionCamera.prototype.ctor.call(this);void 0!==g&&this.initWithDuration(a,c,b,d,e,f,g)},initWithDuration:function(a,c,b,d,e,f,g){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._radius=c,this._deltaRadius=b,this._angleZ=d,this._deltaAngleZ=e,this._angleX=f,this._deltaAngleX=g,this._radDeltaZ=
cc.degreesToRadians(e),this._radDeltaX=cc.degreesToRadians(g),!0):!1},sphericalRadius:function(){var a,c;c=this.target.getCamera();var b=c.getEye();a=c.getCenter();c=b.x-a.x;var d=b.y-a.y;a=b.z-a.z;var b=Math.sqrt(Math.pow(c,2)+Math.pow(d,2)+Math.pow(a,2)),e=Math.sqrt(Math.pow(c,2)+Math.pow(d,2));0===e&&(e=cc.FLT_EPSILON);0===b&&(b=cc.FLT_EPSILON);a=Math.acos(a/b);c=0>c?Math.PI-Math.asin(d/e):Math.asin(d/e);return{newRadius:b/cc.Camera.getZEye(),zenith:a,azimuth:c}},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,
...
this._period);return a}});cc.EaseElastic.create=function(a,c){return new cc.EaseElastic(a,c)};cc.EaseElasticIn=cc.EaseElastic.extend({update:function(a){var c=0;0===a||1===a?c=a:(c=this._period/4,a-=1,c=-Math.pow(2,10*a)*Math.sin(2*(a-c)*Math.PI/this._period));this._inner.update(c)},reverse:function(){return new cc.EaseElasticOut(this._inner.reverse(),this._period)},clone:function(){var a=new cc.EaseElasticIn;a.initWithAction(this._inner.clone(),this._period);return a}});
...
cc.EaseElasticOut=cc.EaseElastic.extend({update:function(a){var c=0;0===a||1==a?c=a:(c=this._period/4,c=Math.pow(2,-10*a)*Math.sin(2*(a-c)*Math.PI/this._period)+1);this._inner.update(c)},reverse:function(){return new cc.EaseElasticIn(this._inner.reverse(),this._period)},clone:function(){var a=new cc.EaseElasticOut;a.initWithAction(this._inner.clone(),this._period);return a}});cc.EaseElasticOut.create=function(a,c){return new cc.EaseElasticOut(a,c)};
...
cc.EaseElasticInOut=cc.EaseElastic.extend({update:function(a){var c=0,c=this._period;if(0===a||1==a)c=a;else{c||(c=this._period=0.3*1.5);var b=c/4;a=2*a-1;c=0>a?-0.5*Math.pow(2,10*a)*Math.sin(2*(a-b)*Math.PI/c):0.5*Math.pow(2,-10*a)*Math.sin(2*(a-b)*Math.PI/c)+1}this._inner.update(c)},reverse:function(){return new cc.EaseElasticInOut(this._inner.reverse(),this._period)},clone:function(){var a=new cc.EaseElasticInOut;a.initWithAction(this._inner.clone(),this._period);return a}});
cc.EaseElasticInOut.create=function(a,c){return new cc.EaseElasticInOut(a,c)};cc.easeElasticInOut=function(a){return{_period:a||0.3,easing:function(a){var b=0,b=this._period;if(0===a||1===a)b=a;else{b||(b=this._period=0.3*1.5);var d=b/4;a=2*a-1;b=0>a?-0.5*Math.pow(2,10*a)*Math.sin(2*(a-d)*Math.PI/b):0.5*Math.pow(2,-10*a)*Math.sin(2*(a-d)*Math.PI/b)+1}return b},reverse:function(){return cc.easeElasticInOut(this._period)}}};
...
cc.EaseBezierAction=cc.ActionEase.extend({_p0:null,_p1:null,_p2:null,_p3:null,ctor:function(a){cc.ActionEase.prototype.ctor.call(this,a)},_updateTime:function(a,c,b,d,e){return Math.pow(1-e,3)*a+3*e*Math.pow(1-e,2)*c+3*Math.pow(e,2)*(1-e)*b+Math.pow(e,3)*d},update:function(a){a=this._updateTime(this._p0,this._p1,this._p2,this._p3,a);this._inner.update(a)},clone:function(){var a=new cc.EaseBezierAction;a.initWithAction(this._inner.clone());a.setBezierParamer(this._p0,this._p1,this._p2,this._p3);return a},
reverse:function(){var a=new cc.EaseBezierAction(this._inner.reverse());a.setBezierParamer(this._p3,this._p2,this._p1,this._p0);return a},setBezierParamer:function(a,c,b,d){this._p0=a||0;this._p1=c||0;this._p2=b||0;this._p3=d||0}});cc.EaseBezierAction.create=function(a){return new cc.EaseBezierAction(a)};cc.easeBezierAction=function(a,c,b,d){return{easing:function(e){return cc.EaseBezierAction.prototype._updateTime(a,c,b,d,e)},reverse:function(){return cc.easeBezierAction(d,b,c,a)}}};
...
cc._easeCubicActionInOut={easing:cc.EaseCubicActionInOut.prototype._updateTime,reverse:function(){return cc._easeCubicActionInOut}};cc.easeCubicActionInOut=function(){return cc._easeCubicActionInOut};cc.cardinalSplineAt=function(a,c,b,d,e,f){var g=f*f,h=g*f,k=(1-e)/2;e=k*(-h+2*g-f);var m=k*(-h+g)+(2*h-3*g+1);f=k*(h-2*g+f)+(-2*h+3*g);g=k*(h-g);return cc.p(a.x*e+c.x*m+b.x*f+d.x*g,a.y*e+c.y*m+b.y*f+d.y*g)};cc.reverseControlPoints=function(a){for(var c=[],b=a.length-1;0<=b;b--)c.push(cc.p(a[b].x,a[b].y));return c};cc.cloneControlPoints=function(a){for(var c=[],b=0;b<a.length;b++)c.push(cc.p(a[b].x,a[b].y));return c};cc.copyControlPoints=cc.cloneControlPoints;
cc.getControlPointAt=function(a,c){var b=Math.min(a.length-1,Math.max(c,0));return a[b]};cc.reverseControlPointsInline=function(a){for(var c=a.length,b=0|c/2,d=0;d<b;++d){var e=a[d];a[d]=a[c-d-1];a[c-d-1]=e}};
cc.CardinalSplineTo=cc.ActionInterval.extend({_points:null,_deltaT:0,_tension:0,_previousPosition:null,_accumulatedDiff:null,ctor:function(a,c,b){cc.ActionInterval.prototype.ctor.call(this);this._points=[];void 0!==b&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){if(!c||0==c.length)throw"Invalid configuration. It must at least have one control point";return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this.setPoints(c),this._tension=b,!0):!1},clone:function(){var a=
new cc.CardinalSplineTo;a.initWithDuration(this._duration,cc.copyControlPoints(this._points),this._tension);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);this._deltaT=1/(this._points.length-1);this._previousPosition=cc.p(this.target.getPositionX(),this.target.getPositionY());this._accumulatedDiff=cc.p(0,0)},update:function(a){a=this._computeEaseTime(a);var c,b=this._points;if(1==a)c=b.length-1,a=1;else{var d=this._deltaT;c=0|a/d;a=(a-d*c)/d}c=cc.cardinalSplineAt(cc.getControlPointAt(b,
c-1),cc.getControlPointAt(b,c-0),cc.getControlPointAt(b,c+1),cc.getControlPointAt(b,c+2),this._tension,a);if(cc.ENABLE_STACKABLE_ACTIONS&&(b=this.target.getPositionX()-this._previousPosition.x,a=this.target.getPositionY()-this._previousPosition.y,0!=b||0!=a))d=this._accumulatedDiff,b=d.x+b,a=d.y+a,d.x=b,d.y=a,c.x+=b,c.y+=a;this.updatePosition(c)},reverse:function(){var a=cc.reverseControlPoints(this._points);return cc.cardinalSplineTo(this._duration,a,this._tension)},updatePosition:function(a){this.target.setPosition(a);
this._previousPosition=a},getPoints:function(){return this._points},setPoints:function(a){this._points=a}});cc.cardinalSplineTo=function(a,c,b){return new cc.CardinalSplineTo(a,c,b)};cc.CardinalSplineTo.create=cc.cardinalSplineTo;
cc.CardinalSplineBy=cc.CardinalSplineTo.extend({_startPosition:null,ctor:function(a,c,b){cc.CardinalSplineTo.prototype.ctor.call(this);this._startPosition=cc.p(0,0);void 0!==b&&this.initWithDuration(a,c,b)},startWithTarget:function(a){cc.CardinalSplineTo.prototype.startWithTarget.call(this,a);this._startPosition.x=a.getPositionX();this._startPosition.y=a.getPositionY()},reverse:function(){for(var a=this._points.slice(),c,b=a[0],d=1;d<a.length;++d)c=a[d],a[d]=cc.pSub(c,b),b=c;a=cc.reverseControlPoints(a);
b=a[a.length-1];a.pop();b.x=-b.x;b.y=-b.y;a.unshift(b);for(d=1;d<a.length;++d)c=a[d],c.x=-c.x,c.y=-c.y,c.x+=b.x,c.y+=b.y,b=a[d]=c;return cc.cardinalSplineBy(this._duration,a,this._tension)},updatePosition:function(a){var c=this._startPosition,b=a.x+c.x;a=a.y+c.y;this._previousPosition.x=b;this._previousPosition.y=a;this.target.setPosition(b,a)},clone:function(){var a=new cc.CardinalSplineBy;a.initWithDuration(this._duration,cc.copyControlPoints(this._points),this._tension);return a}});
cc.cardinalSplineBy=function(a,c,b){return new cc.CardinalSplineBy(a,c,b)};cc.CardinalSplineBy.create=cc.cardinalSplineBy;cc.CatmullRomTo=cc.CardinalSplineTo.extend({ctor:function(a,c){c&&this.initWithDuration(a,c)},initWithDuration:function(a,c){return cc.CardinalSplineTo.prototype.initWithDuration.call(this,a,c,0.5)},clone:function(){var a=new cc.CatmullRomTo;a.initWithDuration(this._duration,cc.copyControlPoints(this._points));return a}});
...
cc.ActionTween=cc.ActionInterval.extend({key:"",from:0,to:0,delta:0,ctor:function(a,c,b,d){cc.ActionInterval.prototype.ctor.call(this);this.key="";void 0!==d&&this.initWithDuration(a,c,b,d)},initWithDuration:function(a,c,b,d){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this.key=c,this.to=d,this.from=b,!0):!1},startWithTarget:function(a){if(!a||!a.updateTweenAction)throw"cc.ActionTween.startWithTarget(): target must be non-null, and target must implement updateTweenAction function";cc.ActionInterval.prototype.startWithTarget.call(this,
a);this.delta=this.to-this.from},update:function(a){this.target.updateTweenAction(this.to-this.delta*(1-a),this.key)},reverse:function(){return new cc.ActionTween(this.duration,this.key,this.to,this.from)},clone:function(){var a=new cc.ActionTween;a.initWithDuration(this._duration,this.key,this.from,this.to);return a}});cc.actionTween=function(a,c,b,d){return new cc.ActionTween(a,c,b,d)};cc.ActionTween.create=cc.actionTween;cc._globalFontSize=cc.ITEM_SIZE;cc._globalFontName="Arial";cc._globalFontNameRelease=!1;
cc.MenuItem=cc.Node.extend({_enabled:!1,_target:null,_callback:null,_isSelected:!1,_className:"MenuItem",ctor:function(a,c){var b=cc.Node.prototype;b.ctor.call(this);this._callback=this._target=null;this._enabled=this._isSelected=!1;b.setAnchorPoint.call(this,0.5,0.5);this._target=c||null;if(this._callback=a||null)this._enabled=!0},isSelected:function(){return this._isSelected},setOpacityModifyRGB:function(a){},isOpacityModifyRGB:function(){return!1},setTarget:function(a,c){this._target=c;this._callback=
a},isEnabled:function(){return this._enabled},setEnabled:function(a){this._enabled=a},initWithCallback:function(a,c){this.anchorY=this.anchorX=0.5;this._target=c;this._callback=a;this._enabled=!0;this._isSelected=!1;return!0},rect:function(){var a=this._position,c=this._contentSize,b=this._anchorPoint;return cc.rect(a.x-c.width*b.x,a.y-c.height*b.y,c.width,c.height)},selected:function(){this._isSelected=!0},unselected:function(){this._isSelected=!1},setCallback:function(a,c){this._target=c;this._callback=
a},activate:function(){if(this._enabled){var a=this._target,c=this._callback;if(c)if(a&&cc.isString(c))a[c](this);else a&&cc.isFunction(c)?c.call(a,this):c(this)}}});_p=cc.MenuItem.prototype;cc.defineGetterSetter(_p,"enabled",_p.isEnabled,_p.setEnabled);cc.MenuItem.create=function(a,c){return new cc.MenuItem(a,c)};
cc.MenuItemLabel=cc.MenuItem.extend({_disabledColor:null,_label:null,_originalScale:0,_colorBackup:null,ctor:function(a,c,b){cc.MenuItem.prototype.ctor.call(this,c,b);this._colorBackup=this._label=this._disabledColor=null;a&&(this._originalScale=1,this._colorBackup=cc.color.WHITE,this._disabledColor=cc.color(126,126,126),this.setLabel(a),this.cascadeOpacity=this.cascadeColor=!0)},getDisabledColor:function(){return this._disabledColor},setDisabledColor:function(a){this._disabledColor=a},getLabel:function(){return this._label},
setLabel:function(a){a&&(this.addChild(a),a.anchorX=0,a.anchorY=0,this.width=a.width,this.height=a.height);this._label&&this.removeChild(this._label,!0);this._label=a},setEnabled:function(a){if(this._enabled!=a){var c=this._label;a?c.color=this._colorBackup:(this._colorBackup=c.color,c.color=this._disabledColor)}cc.MenuItem.prototype.setEnabled.call(this,a)},setOpacity:function(a){this._label.opacity=a},getOpacity:function(){return this._label.opacity},setColor:function(a){this._label.color=a},getColor:function(){return this._label.color},
initWithLabel:function(a,c,b){this.initWithCallback(c,b);this._originalScale=1;this._colorBackup=cc.color.WHITE;this._disabledColor=cc.color(126,126,126);this.setLabel(a);return this.cascadeOpacity=this.cascadeColor=!0},setString:function(a){this._label.string=a;this.width=this._label.width;this.height=this._label.height},getString:function(){return this._label.string},activate:function(){this._enabled&&(this.stopAllActions(),this.scale=this._originalScale,cc.MenuItem.prototype.activate.call(this))},
...
cc.defineGetterSetter(_p,"string",_p.getString,_p.setString);cc.defineGetterSetter(_p,"disabledColor",_p.getDisabledColor,_p.setDisabledColor);cc.defineGetterSetter(_p,"label",_p.getLabel,_p.setLabel);cc.MenuItemLabel.create=function(a,c,b){return new cc.MenuItemLabel(a,c,b)};
cc.MenuItemAtlasFont=cc.MenuItemLabel.extend({ctor:function(a,c,b,d,e,f,g){var h;a&&0<a.length&&(h=new cc.LabelAtlas(a,c,b,d,e));cc.MenuItemLabel.prototype.ctor.call(this,h,f,g)},initWithString:function(a,c,b,d,e,f,g){if(!a||0==a.length)throw"cc.MenuItemAtlasFont.initWithString(): value should be non-null and its length should be greater than 0";var h=new cc.LabelAtlas;h.initWithString(a,c,b,d,e);this.initWithLabel(h,f,g);return!0}});
cc.MenuItemAtlasFont.create=function(a,c,b,d,e,f,g){return new cc.MenuItemAtlasFont(a,c,b,d,e,f,g)};
cc.MenuItemFont=cc.MenuItemLabel.extend({_fontSize:null,_fontName:null,ctor:function(a,c,b){var d;a&&0<a.length?(this._fontName=cc._globalFontName,this._fontSize=cc._globalFontSize,d=new cc.LabelTTF(a,this._fontName,this._fontSize)):(this._fontSize=0,this._fontName="");cc.MenuItemLabel.prototype.ctor.call(this,d,c,b)},initWithString:function(a,c,b){if(!a||0==a.length)throw"Value should be non-null and its length should be greater than 0";this._fontName=cc._globalFontName;this._fontSize=cc._globalFontSize;
a=new cc.LabelTTF(a,this._fontName,this._fontSize);this.initWithLabel(a,c,b);return!0},setFontSize:function(a){this._fontSize=a;this._recreateLabel()},getFontSize:function(){return this._fontSize},setFontName:function(a){this._fontName=a;this._recreateLabel()},getFontName:function(){return this._fontName},_recreateLabel:function(){var a=new cc.LabelTTF(this._label.string,this._fontName,this._fontSize);this.setLabel(a)}});cc.MenuItemFont.setFontSize=function(a){cc._globalFontSize=a};
...
cc.MenuItemFont.create=function(a,c,b){return new cc.MenuItemFont(a,c,b)};
cc.MenuItemSprite=cc.MenuItem.extend({_normalImage:null,_selectedImage:null,_disabledImage:null,ctor:function(a,c,b,d,e){cc.MenuItem.prototype.ctor.call(this);this._disabledImage=this._selectedImage=this._normalImage=null;if(void 0!==c){var f,g,h;void 0!==e?(f=b,h=d,g=e):void 0!==d&&cc.isFunction(d)?(f=b,h=d):void 0!==d&&cc.isFunction(b)?(g=d,h=b,f=new cc.Sprite(c.getTexture(),c.getTextureRect())):void 0===b&&(f=new cc.Sprite(c.getTexture(),c.getTextureRect()));this.initWithNormalSprite(a,c,f,h,g)}},
...
!1,this._selectedImage.visible=!0):this._normalImage.visible=!0)},unselected:function(){cc.MenuItem.prototype.unselected.call(this);this._normalImage&&(this._normalImage.visible=!0,this._selectedImage&&(this._selectedImage.visible=!1),this._disabledImage&&(this._disabledImage.visible=!1))},setEnabled:function(a){this._enabled!=a&&(cc.MenuItem.prototype.setEnabled.call(this,a),this._updateImagesVisibility())},_updateImagesVisibility:function(){var a=this._normalImage,c=this._selectedImage,b=this._disabledImage;
this._enabled?(a&&(a.visible=!0),c&&(c.visible=!1),b&&(b.visible=!1)):b?(a&&(a.visible=!1),c&&(c.visible=!1),b&&(b.visible=!0)):(a&&(a.visible=!0),c&&(c.visible=!1))}});_p=cc.MenuItemSprite.prototype;cc.defineGetterSetter(_p,"normalImage",_p.getNormalImage,_p.setNormalImage);cc.defineGetterSetter(_p,"selectedImage",_p.getSelectedImage,_p.setSelectedImage);cc.defineGetterSetter(_p,"disabledImage",_p.getDisabledImage,_p.setDisabledImage);
cc.MenuItemSprite.create=function(a,c,b,d,e){return new cc.MenuItemSprite(a,c,b,d,e||void 0)};
cc.MenuItemImage=cc.MenuItemSprite.extend({ctor:function(a,c,b,d,e){var f=null,g=null,h=null,k=null,m=null;void 0===a?cc.MenuItemSprite.prototype.ctor.call(this):(f=new cc.Sprite(a),c&&(g=new cc.Sprite(c)),void 0===d?k=b:void 0===e?(k=b,m=d):e&&(h=new cc.Sprite(b),k=d,m=e),cc.MenuItemSprite.prototype.ctor.call(this,f,g,h,k,m))},setNormalSpriteFrame:function(a){this.setNormalImage(new cc.Sprite(a))},setSelectedSpriteFrame:function(a){this.setSelectedImage(new cc.Sprite(a))},setDisabledSpriteFrame:function(a){this.setDisabledImage(new cc.Sprite(a))},
initWithNormalImage:function(a,c,b,d,e){var f=null,g=null,h=null;a&&(f=new cc.Sprite(a));c&&(g=new cc.Sprite(c));b&&(h=new cc.Sprite(b));return this.initWithNormalSprite(f,g,h,d,e)}});cc.MenuItemImage.create=function(a,c,b,d,e){return new cc.MenuItemImage(a,c,b,d,e)};
cc.MenuItemToggle=cc.MenuItem.extend({subItems:null,_selectedIndex:0,_opacity:null,_color:null,ctor:function(){cc.MenuItem.prototype.ctor.call(this);this._selectedIndex=0;this.subItems=[];this._opacity=0;this._color=cc.color.WHITE;0<arguments.length&&this.initWithItems(Array.prototype.slice.apply(arguments))},getOpacity:function(){return this._opacity},setOpacity:function(a){this._opacity=a;if(this.subItems&&0<this.subItems.length)for(var c=0;c<this.subItems.length;c++)this.subItems[c].opacity=a;
this._color.a=a},getColor:function(){var a=this._color;return cc.color(a.r,a.g,a.b,a.a)},setColor:function(a){var c=this._color;c.r=a.r;c.g=a.g;c.b=a.b;if(this.subItems&&0<this.subItems.length)for(c=0;c<this.subItems.length;c++)this.subItems[c].setColor(a);void 0!==a.a&&!a.a_undefined&&this.setOpacity(a.a)},getSelectedIndex:function(){return this._selectedIndex},setSelectedIndex:function(a){if(a!=this._selectedIndex){this._selectedIndex=a;(a=this.getChildByTag(cc.CURRENT_ITEM))&&a.removeFromParent(!1);
a=this.subItems[this._selectedIndex];this.addChild(a,0,cc.CURRENT_ITEM);var c=a.width,b=a.height;this.width=c;this.height=b;a.setPosition(c/2,b/2)}},getSubItems:function(){return this.subItems},setSubItems:function(a){this.subItems=a},initWithItems:function(a){var c=a.length;cc.isFunction(a[a.length-2])?(this.initWithCallback(a[a.length-2],a[a.length-1]),c-=2):cc.isFunction(a[a.length-1])?(this.initWithCallback(a[a.length-1],null),c-=1):this.initWithCallback(null,null);for(var b=this.subItems,d=b.length=
0;d<c;d++)a[d]&&b.push(a[d]);this._selectedIndex=cc.UINT_MAX;this.setSelectedIndex(0);return this.cascadeOpacity=this.cascadeColor=!0},addSubItem:function(a){this.subItems.push(a)},activate:function(){this._enabled&&this.setSelectedIndex((this._selectedIndex+1)%this.subItems.length);cc.MenuItem.prototype.activate.call(this)},selected:function(){cc.MenuItem.prototype.selected.call(this);this.subItems[this._selectedIndex].selected()},unselected:function(){cc.MenuItem.prototype.unselected.call(this);
this.subItems[this._selectedIndex].unselected()},setEnabled:function(a){if(this._enabled!=a){cc.MenuItem.prototype.setEnabled.call(this,a);var c=this.subItems;if(c&&0<c.length)for(var b=0;b<c.length;b++)c[b].enabled=a}},selectedItem:function(){return this.subItems[this._selectedIndex]},onEnter:function(){cc.Node.prototype.onEnter.call(this);this.setSelectedIndex(this._selectedIndex)}});_p=cc.MenuItemToggle.prototype;cc.defineGetterSetter(_p,"selectedIndex",_p.getSelectedIndex,_p.setSelectedIndex);
...
null==arguments[arguments.length-1]&&cc.log("parameters should not be ending with null in Javascript");var c=arguments.length,b;if(0==c)b=[];else if(1==c)b=a instanceof Array?a:[a];else if(1<c){b=[];for(var d=0;d<c;d++)arguments[d]&&b.push(arguments[d])}this.initWithArray(b)},onEnter:function(){var a=this._touchListener;a._isRegistered()||cc.eventManager.addListener(a,this);cc.Node.prototype.onEnter.call(this)},isEnabled:function(){return this.enabled},setEnabled:function(a){this.enabled=a},initWithItems:function(a){var c=
[];if(a)for(var b=0;b<a.length;b++)a[b]&&c.push(a[b]);return this.initWithArray(c)},initWithArray:function(a){if(cc.Layer.prototype.init.call(this)){this.enabled=!0;var c=cc.winSize;this.setPosition(c.width/2,c.height/2);this.setContentSize(c);this.setAnchorPoint(0.5,0.5);this.ignoreAnchorPointForPosition(!0);if(a)for(c=0;c<a.length;c++)this.addChild(a[c],c);this._selectedItem=null;this._state=cc.MENU_STATE_WAITING;return this.cascadeOpacity=this.cascadeColor=!0}return!1},addChild:function(a,c,b){if(!(a instanceof
cc.MenuItem))throw"cc.Menu.addChild() : Menu only supports MenuItem objects as children";cc.Layer.prototype.addChild.call(this,a,c,b)},alignItemsVertically:function(){this.alignItemsVerticallyWithPadding(cc.DEFAULT_PADDING)},alignItemsVerticallyWithPadding:function(a){var c=-a,b=this._children,d,e,f,g;if(b&&0<b.length){e=0;for(d=b.length;e<d;e++)c+=b[e].height*b[e].scaleY+a;var h=c/2;e=0;for(d=b.length;e<d;e++)g=b[e],f=g.height,c=g.scaleY,g.setPosition(0,h-f*c/2),h-=f*c+a}},alignItemsHorizontally:function(){this.alignItemsHorizontallyWithPadding(cc.DEFAULT_PADDING)},
alignItemsHorizontallyWithPadding:function(a){var c=-a,b=this._children,d,e,f,g;if(b&&0<b.length){d=0;for(e=b.length;d<e;d++)c+=b[d].width*b[d].scaleX+a;var h=-c/2;d=0;for(e=b.length;d<e;d++)g=b[d],c=g.scaleX,f=b[d].width,g.setPosition(h+f*c/2,0),h+=f*c+a}},alignItemsInColumns:function(){0<arguments.length&&null==arguments[arguments.length-1]&&cc.log("parameters should not be ending with null in Javascript");for(var a=[],c=0;c<arguments.length;c++)a.push(arguments[c]);var b=-5,d=0,e=0,f=0,g,h,k,m=
this._children;if(m&&0<m.length){c=0;for(k=m.length;c<k;c++)if(!(d>=a.length)&&(g=a[d]))h=m[c].height,e=e>=h||isNaN(h)?e:h,++f,f>=g&&(b+=e+5,e=f=0,++d)}var p=cc.director.getWinSize(),n=g=e=d=0,r=0,b=b/2;if(m&&0<m.length){c=0;for(k=m.length;c<k;c++){var s=m[c];0==g&&(g=a[d],r=n=p.width/(1+g));h=s._getHeight();e=e>=h||isNaN(h)?e:h;s.setPosition(r-p.width/2,b-h/2);r+=n;++f;f>=g&&(b-=e+5,e=g=f=0,++d)}}},alignItemsInRows:function(){0<arguments.length&&null==arguments[arguments.length-1]&&cc.log("parameters should not be ending with null in Javascript");
var a=[],c;for(c=0;c<arguments.length;c++)a.push(arguments[c]);var b=[],d=[],e=-10,f=-5,g=0,h=0,k=0,m,p,n,r,s=this._children;if(s&&0<s.length){c=0;for(n=s.length;c<n;c++)if(p=s[c],!(g>=a.length)&&(m=a[g]))r=p.width,h=h>=r||isNaN(r)?h:r,f+=p.height+5,++k,k>=m&&(b.push(h),d.push(f),e+=h+10,h=k=0,f=-5,++g)}f=cc.director.getWinSize();m=h=g=0;var e=-e/2,u=0;if(s&&0<s.length){c=0;for(n=s.length;c<n;c++)p=s[c],0==m&&(m=a[g],u=d[g]),r=p._getWidth(),h=h>=r||isNaN(r)?h:r,p.setPosition(e+b[g]/2,u-f.height/2),
u-=p.height+10,++k,k>=m&&(e+=h+5,h=m=k=0,++g)}},removeChild:function(a,c){null!=a&&(a instanceof cc.MenuItem?(this._selectedItem==a&&(this._selectedItem=null),cc.Node.prototype.removeChild.call(this,a,c)):cc.log("cc.Menu.removeChild():Menu only supports MenuItem objects as children"))},_onTouchBegan:function(a,c){var b=c.getCurrentTarget();if(b._state!=cc.MENU_STATE_WAITING||!b._visible||!b.enabled)return!1;for(var d=b.parent;null!=d;d=d.parent)if(!d.isVisible())return!1;b._selectedItem=b._itemForTouch(a);
return b._selectedItem?(b._state=cc.MENU_STATE_TRACKING_TOUCH,b._selectedItem.selected(),b._selectedItem.setNodeDirty(),!0):!1},_onTouchEnded:function(a,c){var b=c.getCurrentTarget();b._state!==cc.MENU_STATE_TRACKING_TOUCH?cc.log("cc.Menu.onTouchEnded(): invalid state"):(b._selectedItem&&(b._selectedItem.unselected(),b._selectedItem.setNodeDirty(),b._selectedItem.activate()),b._state=cc.MENU_STATE_WAITING)},_onTouchCancelled:function(a,c){var b=c.getCurrentTarget();b._state!==cc.MENU_STATE_TRACKING_TOUCH?
cc.log("cc.Menu.onTouchCancelled(): invalid state"):(this._selectedItem&&(b._selectedItem.unselected(),b._selectedItem.setNodeDirty()),b._state=cc.MENU_STATE_WAITING)},_onTouchMoved:function(a,c){var b=c.getCurrentTarget();if(b._state!==cc.MENU_STATE_TRACKING_TOUCH)cc.log("cc.Menu.onTouchMoved(): invalid state");else{var d=b._itemForTouch(a);d!=b._selectedItem&&(b._selectedItem&&(b._selectedItem.unselected(),b._selectedItem.setNodeDirty()),b._selectedItem=d,b._selectedItem&&(b._selectedItem.selected(),
b._selectedItem.setNodeDirty()))}},onExit:function(){this._state==cc.MENU_STATE_TRACKING_TOUCH&&(this._selectedItem&&(this._selectedItem.unselected(),this._selectedItem=null),this._state=cc.MENU_STATE_WAITING);cc.Node.prototype.onExit.call(this)},setOpacityModifyRGB:function(a){},isOpacityModifyRGB:function(){return!1},_itemForTouch:function(a){a=a.getLocation();var c=this._children,b;if(c&&0<c.length)for(var d=c.length-1;0<=d;d--)if(b=c[d],b.isVisible()&&b.isEnabled()){var e=b.convertToNodeSpace(a),
f=b.rect();f.x=0;f.y=0;if(cc.rectContainsPoint(f,e))return b}return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var c=arguments.length;0<c&&null==arguments[c-1]&&cc.log("parameters should not be ending with null in Javascript");return 0==c?new cc.Menu:1==c?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};(function(){var a=cc.sys,c={common:{multichannel:!0,webAudio:cc.sys._supportWebAudio,auto:!0}};c[a.BROWSER_TYPE_IE]={multichannel:!0,webAudio:cc.sys._supportWebAudio,auto:!0,emptied:!0};c[a.BROWSER_TYPE_ANDROID]={multichannel:!1,webAudio:!1,auto:!1};c[a.BROWSER_TYPE_CHROME]={multichannel:!0,webAudio:!0,auto:!1};c[a.BROWSER_TYPE_FIREFOX]={multichannel:!0,webAudio:!0,auto:!0};c[a.BROWSER_TYPE_UC]={multichannel:!0,webAudio:!1,auto:!1};c[a.BROWSER_TYPE_QQ]={multichannel:!1,webAudio:!1,auto:!0};c[a.BROWSER_TYPE_OUPENG]=
{multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_WECHAT]={multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_360]={multichannel:!1,webAudio:!1,auto:!0};c[a.BROWSER_TYPE_MIUI]={multichannel:!1,webAudio:!1,auto:!0};c[a.BROWSER_TYPE_BAIDU]={multichannel:!1,webAudio:!1,auto:!0,emptied:!0};c[a.BROWSER_TYPE_BAIDU_APP]={multichannel:!1,webAudio:!1,auto:!0,emptied:!0};c[a.BROWSER_TYPE_LIEBAO]={multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_SOUGOU]=
{multichannel:!1,webAudio:!1,auto:!1,replay:!0,emptied:!0};c[a.BROWSER_TYPE_SAFARI]={multichannel:!0,webAudio:!0,auto:!1,webAudioCallback:function(a){document.createElement("audio").src=a}};var b,d;try{var e=navigator.userAgent.toLowerCase();switch(a.browserType){case a.BROWSER_TYPE_IE:d=e.match(/(msie |rv:)([\d.]+)/);break;case a.BROWSER_TYPE_FIREFOX:d=e.match(/(firefox\/|rv:)([\d.]+)/);break;case a.BROWSER_TYPE_CHROME:d=e.match(/chrome\/([\d.]+)/);break;case a.BROWSER_TYPE_BAIDU:d=e.match(/baidubrowser\/([\d.]+)/);
break;case a.BROWSER_TYPE_UC:d=e.match(/ucbrowser\/([\d.]+)/);break;case a.BROWSER_TYPE_QQ:d=e.match(/qqbrowser\/([\d.]+)/);break;case a.BROWSER_TYPE_OUPENG:d=e.match(/oupeng\/([\d.]+)/);break;case a.BROWSER_TYPE_WECHAT:d=e.match(/micromessenger\/([\d.]+)/);break;case a.BROWSER_TYPE_SAFARI:d=e.match(/safari\/([\d.]+)/);break;case a.BROWSER_TYPE_MIUI:d=e.match(/miuibrowser\/([\d.]+)/)}b=d?d[1]:""}catch(f){console.log(f)}if(b)switch(a.browserType){case a.BROWSER_TYPE_CHROME:30>parseInt(b)&&(c[a.BROWSER_TYPE_CHROME]=
{multichannel:!1,webAudio:!0,auto:!1});break;case a.BROWSER_TYPE_MIUI:if(b=b.match(/\d+/g),2>b[0]||2==b[0]&&0==b[1]&&1>=b[2])c[a.BROWSER_TYPE_MIUI].auto=!1}cc.__audioSupport=cc.sys.isMobile?cc.sys.os!=cc.sys.OS_IOS?c[a.browserType]||c.common:c[a.BROWSER_TYPE_SAFARI]:cc.sys.browserType!=cc.sys.BROWSER_TYPE_IE?c.common:c[a.BROWSER_TYPE_IE]})();
cc.Audio=cc.Class.extend({volume:1,loop:!1,src:null,_touch:!1,_playing:!1,_AUDIO_TYPE:"AUDIO",_pause:!1,_buffer:null,_currentSource:null,_startTime:null,_currentTime:null,_context:null,_volume:null,_element:null,ctor:function(a,c,b){a&&(this._context=a);c&&(this._volume=c);a&&c&&(this._AUDIO_TYPE="WEBAUDIO");this.src=b},_setBufferCallback:null,setBuffer:function(a){if(a){var c=this._playing;this._AUDIO_TYPE="WEBAUDIO";this._buffer&&(this._buffer!=a&&this.getPlaying())&&this.stop();this._buffer=a;
c&&this.play();this._volume.gain.value=this.volume;this._setBufferCallback&&this._setBufferCallback(a)}},_setElementCallback:null,setElement:function(a){if(a){var c=this._playing;this._AUDIO_TYPE="AUDIO";this._element&&(this._element!=a&&this.getPlaying())&&this.stop();this._element=a;c&&this.play();a.volume=this.volume;a.loop=this.loop;this._setElementCallback&&this._setElementCallback(a)}},play:function(a,c){this._playing=!0;this.loop=void 0===c?this.loop:c;"AUDIO"===this._AUDIO_TYPE?this._playOfAudio(a):
this._playOfWebAudio(a)},getPlaying:function(){if(!this._playing)return this._playing;if("AUDIO"===this._AUDIO_TYPE){var a=this._element;return!a||this._pause||a.ended?this._playing=!1:!0}a=this._currentSource;return!this._playing&&!a?!0:null==a.playbackState?this._playing:this._currentTime+this._context.currentTime-this._startTime<this._currentSource.buffer.duration},_playOfWebAudio:function(a){var c=this._currentSource;if(this._buffer){if(!this._pause&&c)if(0===this._context.currentTime||this._currentTime+
this._context.currentTime-this._startTime>this._currentSource.buffer.duration)this._stopOfWebAudio();else return;c=this._context.createBufferSource();c.buffer=this._buffer;c.connect(this._volume);c.loop=this.loop;this._startTime=this._context.currentTime;this._currentTime=0;if(c.start)c.start(0,a||0);else if(c.noteGrainOn){var b=c.buffer.duration;this.loop?c.noteGrainOn(0,a,b):c.noteGrainOn(0,a,b-a)}else c.noteOn(0);this._currentSource=c;var d=this;c.onended=function(){d._playing=!1}}},_playOfAudio:function(){var a=
...
window.mozAudioContext)}catch(g){c=!1,cc.log("browser don't support webAudio")}var h={cache:{},load:function(a,b,d,g){if(0===e.length)return g("can not support audio!");var k=cc.path.extname(a);b=[k];for(d=0;d<e.length;d++)k!==e[d]&&b.push(e[d]);if(h.cache[a])return g(null,h.cache[a]);c?(d=f.createGain(),d.gain.value=1,d.connect(f.destination),d=new cc.Audio(f,d,a)):d=new cc.Audio(null,null,a);this.loadAudioFromExtList(a,b,d,g);h.cache[a]=d},loadAudioFromExtList:function(b,d,g,k){if(0===d.length){var s=
"can not found the resource of audio! Last match url is : ",s=s+b.replace(/\.(.*)?$/,"(");e.forEach(function(a){s+=a+"|"});s=s.replace(/\|$/,")");return k(s)}b=cc.path.changeExtname(b,d.splice(0,1));if(c){a.webAudioCallback&&a.webAudioCallback(b);var u=new XMLHttpRequest;u.open("GET",b,!0);u.responseType="arraybuffer";u.onload=function(){f.decodeAudioData(u.response,function(a){g.setBuffer(a);k(null,g)},function(){h.loadAudioFromExtList(b,d,g,k)})};u.send()}else{var t=document.createElement("audio"),
v=!1,w=!1,q=setTimeout(function(){0==t.readyState?C():(w=!0,k("audio load timeout : "+b,g))},1E4),y=function(){v||(g.setElement(t),t.removeEventListener("canplaythrough",y,!1),t.removeEventListener("error",A,!1),t.removeEventListener("emptied",C,!1),!w&&k(null,g),v=!0,clearTimeout(q))},A=function(){v&&(t.removeEventListener("canplaythrough",y,!1),t.removeEventListener("error",A,!1),t.removeEventListener("emptied",C,!1),!w&&h.loadAudioFromExtList(b,d,g,k),v=!0,clearTimeout(q))},C=function(){w=!0;y();
k(null,g)};cc._addEventListener(t,"canplaythrough",y,!1);cc._addEventListener(t,"error",A,!1);a.emptied&&cc._addEventListener(t,"emptied",C,!1);t.src=b;t.load()}}};cc.loader.register(["mp3","ogg","wav","mp4","m4a"],h);cc.audioEngine={_currMusic:null,_musicVolume:1,willPlayMusic:function(){return!1},playMusic:function(a,b){var c=this._currMusic;c&&(c.src!==a&&c.getPlaying())&&c.stop();c=h.cache[a];c||(cc.loader.load(a),c=h.cache[a]);c.play(0,b);c.setVolume(this._musicVolume);this._currMusic=c},stopMusic:function(a){var b=
...
k,!1)},150)}cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()})})(cc.__audioSupport);var Zepto=function(){function a(a){return null==a?String(a):I[R.call(a)]||"object"}function c(b){return"function"==a(b)}function b(a){return null!=a&&a==a.window}function d(a){return null!=a&&a.nodeType==a.DOCUMENT_NODE}function e(b){return"object"==a(b)}function f(a){return e(a)&&!b(a)&&Object.getPrototypeOf(a)==Object.prototype}function g(a){return F.call(a,function(a){return null!=a})}function h(a){return a.replace(/::/g,"/").replace(/([A-Z]+)([A-Z][a-z])/g,"$1_$2").replace(/([a-z\d])([A-Z])/g,
"$1_$2").replace(/_/g,"-").toLowerCase()}function k(a){return a in G?G[a]:G[a]=RegExp("(^|\\s)"+a+"(\\s|$)")}function m(a){return"children"in a?E.call(a.children):q.map(a.childNodes,function(a){return 1==a.nodeType?a:void 0})}function p(a,b,c){for(w in b)c&&(f(b[w])||H(b[w]))?(f(b[w])&&!f(a[w])&&(a[w]={}),H(b[w])&&!H(a[w])&&(a[w]=[]),p(a[w],b[w],c)):b[w]!==v&&(a[w]=b[w])}function n(a,b){return null==b?q(a):q(a).filter(b)}function r(a,b,d,e){return c(b)?b.call(a,d,e):b}function s(a,b){var c=a.className||
"",d=c&&c.baseVal!==v;return b===v?d?c.baseVal:c:void(d?c.baseVal=b:a.className=b)}function u(a){try{return a?"true"==a||("false"==a?!1:"null"==a?null:+a+""==a?+a:/^[\[\{]/.test(a)?q.parseJSON(a):a):a}catch(b){return a}}function t(a,b){b(a);for(var c=0,d=a.childNodes.length;d>c;c++)t(a.childNodes[c],b)}var v,w,q,y,A,C,D=[],E=D.slice,F=D.filter,B=window.document,J={},G={},M={"column-count":1,columns:1,"font-weight":1,"line-height":1,opacity:1,"z-index":1,zoom:1},K=/^\s*<(\w+|!)[^>]*>/,S=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,
T=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,N=/^(?:body|html)$/i,x=/([A-Z])/g,U="val css html text data width height offset".split(" "),L=B.createElement("table"),O=B.createElement("tr"),P={tr:B.createElement("tbody"),tbody:L,thead:L,tfoot:L,td:O,th:O,"*":B.createElement("div")},V=/complete|loaded|interactive/,W=/^[\w-]*$/,I={},R=I.toString,z={},Q=B.createElement("div"),X={tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",
cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},H=Array.isArray||function(a){return a instanceof Array};return z.matches=function(a,b){if(!b||!a||1!==a.nodeType)return!1;var c=a.webkitMatchesSelector||a.mozMatchesSelector||a.oMatchesSelector||a.matchesSelector;if(c)return c.call(a,b);var d,c=a.parentNode,e=!c;return e&&(c=Q).appendChild(a),d=~z.qsa(c,b).indexOf(a),e&&Q.removeChild(a),
d},A=function(a){return a.replace(/-+(.)?/g,function(a,b){return b?b.toUpperCase():""})},C=function(a){return F.call(a,function(b,c){return a.indexOf(b)==c})},z.fragment=function(a,b,c){var d,e,g;return S.test(a)&&(d=q(B.createElement(RegExp.$1))),d||(a.replace&&(a=a.replace(T,"\x3c$1\x3e\x3c/$2\x3e")),b===v&&(b=K.test(a)&&RegExp.$1),b in P||(b="*"),g=P[b],g.innerHTML=""+a,d=q.each(E.call(g.childNodes),function(){g.removeChild(this)})),f(c)&&(e=q(d),q.each(c,function(a,b){-1<U.indexOf(a)?e[a](b):
e.attr(a,b)})),d},z.Z=function(a,b){return a=a||[],a.__proto__=q.fn,a.selector=b||"",a},z.isZ=function(a){return a instanceof z.Z},z.init=function(a,b){var d;if(!a)return z.Z();if("string"==typeof a)if(a=a.trim(),"\x3c"==a[0]&&K.test(a))d=z.fragment(a,RegExp.$1,b),a=null;else{if(b!==v)return q(b).find(a);d=z.qsa(B,a)}else{if(c(a))return q(B).ready(a);if(z.isZ(a))return a;if(H(a))d=g(a);else if(e(a))d=[a],a=null;else if(K.test(a))d=z.fragment(a.trim(),RegExp.$1,b),a=null;else{if(b!==v)return q(b).find(a);
d=z.qsa(B,a)}}return z.Z(d,a)},q=function(a,b){return z.init(a,b)},q.extend=function(a){var b,c=E.call(arguments,1);return"boolean"==typeof a&&(b=a,a=c.shift()),c.forEach(function(c){p(a,c,b)}),a},z.qsa=function(a,b){var c,e="#"==b[0],f=!e&&"."==b[0],g=e||f?b.slice(1):b,h=W.test(g);return d(a)&&h&&e?(c=a.getElementById(g))?[c]:[]:1!==a.nodeType&&9!==a.nodeType?[]:E.call(h&&!e?f?a.getElementsByClassName(g):a.getElementsByTagName(b):a.querySelectorAll(b))},q.contains=B.documentElement.contains?function(a,
b){return a!==b&&a.contains(b)}:function(a,b){for(;b&&(b=b.parentNode);)if(b===a)return!0;return!1},q.type=a,q.isFunction=c,q.isWindow=b,q.isArray=H,q.isPlainObject=f,q.isEmptyObject=function(a){for(var b in a)return!1;return!0},q.inArray=function(a,b,c){return D.indexOf.call(b,a,c)},q.camelCase=A,q.trim=function(a){return null==a?"":String.prototype.trim.call(a)},q.uuid=0,q.support={},q.expr={},q.map=function(a,b){var c,d,e=[];if("number"==typeof a.length)for(d=0;d<a.length;d++)c=b(a[d],d),null!=
c&&e.push(c);else for(d in a)c=b(a[d],d),null!=c&&e.push(c);return 0<e.length?q.fn.concat.apply([],e):e},q.each=function(a,b){var c;if("number"==typeof a.length)for(c=0;c<a.length&&!1!==b.call(a[c],c,a[c]);c++);else for(c in a)if(!1===b.call(a[c],c,a[c]))break;return a},q.grep=function(a,b){return F.call(a,b)},window.JSON&&(q.parseJSON=JSON.parse),q.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(a,b){I["[object "+b+"]"]=b.toLowerCase()}),q.fn={forEach:D.forEach,
reduce:D.reduce,push:D.push,sort:D.sort,indexOf:D.indexOf,concat:D.concat,map:function(a){return q(q.map(this,function(b,c){return a.call(b,c,b)}))},slice:function(){return q(E.apply(this,arguments))},ready:function(a){return V.test(B.readyState)&&B.body?a(q):B.addEventListener("DOMContentLoaded",function(){a(q)},!1),this},get:function(a){return a===v?E.call(this):this[0<=a?a:a+this.length]},toArray:function(){return this.get()},size:function(){return this.length},remove:function(){return this.each(function(){null!=
this.parentNode&&this.parentNode.removeChild(this)})},each:function(a){return D.every.call(this,function(b,c){return!1!==a.call(b,c,b)}),this},filter:function(a){return c(a)?this.not(this.not(a)):q(F.call(this,function(b){return z.matches(b,a)}))},add:function(a,b){return q(C(this.concat(q(a,b))))},is:function(a){return 0<this.length&&z.matches(this[0],a)},not:function(a){var b=[];if(c(a)&&a.call!==v)this.each(function(c){a.call(this,c)||b.push(this)});else{var d="string"==typeof a?this.filter(a):
"number"==typeof a.length&&c(a.item)?E.call(a):q(a);this.forEach(function(a){0>d.indexOf(a)&&b.push(a)})}return q(b)},has:function(a){return this.filter(function(){return e(a)?q.contains(this,a):q(this).find(a).size()})},eq:function(a){return-1===a?this.slice(a):this.slice(a,+a+1)},first:function(){var a=this[0];return a&&!e(a)?a:q(a)},last:function(){var a=this[this.length-1];return a&&!e(a)?a:q(a)},find:function(a){var b=this;return a?"object"==typeof a?q(a).filter(function(){var a=this;return D.some.call(b,
function(b){return q.contains(b,a)})}):1==this.length?q(z.qsa(this[0],a)):this.map(function(){return z.qsa(this,a)}):q()},closest:function(a,b){var c=this[0],e=!1;for("object"==typeof a&&(e=q(a));c&&!(e?0<=e.indexOf(c):z.matches(c,a));)c=c!==b&&!d(c)&&c.parentNode;return q(c)},parents:function(a){for(var b=[],c=this;0<c.length;)c=q.map(c,function(a){return(a=a.parentNode)&&!d(a)&&0>b.indexOf(a)?(b.push(a),a):void 0});return n(b,a)},parent:function(a){return n(C(this.pluck("parentNode")),a)},children:function(a){return n(this.map(function(){return m(this)}),
a)},contents:function(){return this.map(function(){return E.call(this.childNodes)})},siblings:function(a){return n(this.map(function(a,b){return F.call(m(b.parentNode),function(a){return a!==b})}),a)},empty:function(){return this.each(function(){this.innerHTML=""})},pluck:function(a){return q.map(this,function(b){return b[a]})},show:function(){return this.each(function(){"none"==this.style.display&&(this.style.display="");if("none"==getComputedStyle(this,"").getPropertyValue("display")){var a=this.style,
b;b=this.nodeName;var c,d;b=(J[b]||(c=B.createElement(b),B.body.appendChild(c),d=getComputedStyle(c,"").getPropertyValue("display"),c.parentNode.removeChild(c),"none"==d&&(d="block"),J[b]=d),J[b]);a.display=b}})},replaceWith:function(a){return this.before(a).remove()},wrap:function(a){var b=c(a);if(this[0]&&!b)var d=q(a).get(0),e=d.parentNode||1<this.length;return this.each(function(c){q(this).wrapAll(b?a.call(this,c):e?d.cloneNode(!0):d)})},wrapAll:function(a){if(this[0]){q(this[0]).before(a=q(a));
for(var b;(b=a.children()).length;)a=b.first();q(a).append(this)}return this},wrapInner:function(a){var b=c(a);return this.each(function(c){var d=q(this),e=d.contents();c=b?a.call(this,c):a;e.length?e.wrapAll(c):d.append(c)})},unwrap:function(){return this.parent().each(function(){q(this).replaceWith(q(this).children())}),this},clone:function(){return this.map(function(){return this.cloneNode(!0)})},hide:function(){return this.css("display","none")},toggle:function(a){return this.each(function(){var b=
q(this);(a===v?"none"==b.css("display"):a)?b.show():b.hide()})},prev:function(a){return q(this.pluck("previousElementSibling")).filter(a||"*")},next:function(a){return q(this.pluck("nextElementSibling")).filter(a||"*")},html:function(a){return 0 in arguments?this.each(function(b){var c=this.innerHTML;q(this).empty().append(r(this,a,b,c))}):0 in this?this[0].innerHTML:null},text:function(a){return 0 in arguments?this.each(function(b){b=r(this,a,b,this.textContent);this.textContent=null==b?"":""+b}):
0 in this?this[0].textContent:null},attr:function(a,b){var c;return"string"!=typeof a||1 in arguments?this.each(function(c){if(1===this.nodeType)if(e(a))for(w in a){var d=w;c=a[w];null==c?this.removeAttribute(d):this.setAttribute(d,c)}else d=a,c=r(this,b,c,this.getAttribute(a)),null==c?this.removeAttribute(d):this.setAttribute(d,c)}):this.length&&1===this[0].nodeType?!(c=this[0].getAttribute(a))&&a in this[0]?this[0][a]:c:v},removeAttr:function(a){return this.each(function(){1===this.nodeType&&a.split(" ").forEach(function(a){this.removeAttribute(a)},
this)})},prop:function(a,b){return a=X[a]||a,1 in arguments?this.each(function(c){this[a]=r(this,b,c,this[a])}):this[0]&&this[0][a]},data:function(a,b){var c="data-"+a.replace(x,"-$1").toLowerCase(),c=1 in arguments?this.attr(c,b):this.attr(c);return null!==c?u(c):v},val:function(a){return 0 in arguments?this.each(function(b){this.value=r(this,a,b,this.value)}):this[0]&&(this[0].multiple?q(this[0]).find("option").filter(function(){return this.selected}).pluck("value"):this[0].value)},offset:function(a){if(a)return this.each(function(b){var c=
q(this);b=r(this,a,b,c.offset());var d=c.offsetParent().offset();b={top:b.top-d.top,left:b.left-d.left};"static"==c.css("position")&&(b.position="relative");c.css(b)});if(!this.length)return null;var b=this[0].getBoundingClientRect();return{left:b.left+window.pageXOffset,top:b.top+window.pageYOffset,width:Math.round(b.width),height:Math.round(b.height)}},css:function(b,c){if(2>arguments.length){var d,e=this[0];if(!e)return;if(d=getComputedStyle(e,""),"string"==typeof b)return e.style[A(b)]||d.getPropertyValue(b);
if(H(b)){var f={};return q.each(b,function(a,b){f[b]=e.style[A(b)]||d.getPropertyValue(b)}),f}}var g="";if("string"==a(b))c||0===c?g=h(b)+":"+("number"!=typeof c||M[h(b)]?c:c+"px"):this.each(function(){this.style.removeProperty(h(b))});else for(w in b)b[w]||0===b[w]?g+=h(w)+":"+("number"!=typeof b[w]||M[h(w)]?b[w]:b[w]+"px")+";":this.each(function(){this.style.removeProperty(h(w))});return this.each(function(){this.style.cssText+=";"+g})},index:function(a){return a?this.indexOf(q(a)[0]):this.parent().children().indexOf(this[0])},
hasClass:function(a){return a?D.some.call(this,function(a){return this.test(s(a))},k(a)):!1},addClass:function(a){return a?this.each(function(b){if("className"in this){y=[];var c=s(this);r(this,a,b,c).split(/\s+/g).forEach(function(a){q(this).hasClass(a)||y.push(a)},this);y.length&&s(this,c+(c?" ":"")+y.join(" "))}}):this},removeClass:function(a){return this.each(function(b){if("className"in this){if(a===v)return s(this,"");y=s(this);r(this,a,b,y).split(/\s+/g).forEach(function(a){y=y.replace(k(a),
" ")});s(this,y.trim())}})},toggleClass:function(a,b){return a?this.each(function(c){var d=q(this);r(this,a,c,s(this)).split(/\s+/g).forEach(function(a){(b===v?!d.hasClass(a):b)?d.addClass(a):d.removeClass(a)})}):this},scrollTop:function(a){if(this.length){var b="scrollTop"in this[0];return a===v?b?this[0].scrollTop:this[0].pageYOffset:this.each(b?function(){this.scrollTop=a}:function(){this.scrollTo(this.scrollX,a)})}},scrollLeft:function(a){if(this.length){var b="scrollLeft"in this[0];return a===
v?b?this[0].scrollLeft:this[0].pageXOffset:this.each(b?function(){this.scrollLeft=a}:function(){this.scrollTo(a,this.scrollY)})}},position:function(){if(this.length){var a=this[0],b=this.offsetParent(),c=this.offset(),d=N.test(b[0].nodeName)?{top:0,left:0}:b.offset();return c.top-=parseFloat(q(a).css("margin-top"))||0,c.left-=parseFloat(q(a).css("margin-left"))||0,d.top+=parseFloat(q(b[0]).css("border-top-width"))||0,d.left+=parseFloat(q(b[0]).css("border-left-width"))||0,{top:c.top-d.top,left:c.left-
d.left}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||B.body;a&&!N.test(a.nodeName)&&"static"==q(a).css("position");)a=a.offsetParent;return a})}},q.fn.detach=q.fn.remove,["width","height"].forEach(function(a){var c=a.replace(/./,function(a){return a[0].toUpperCase()});q.fn[a]=function(e){var f,g=this[0];return e===v?b(g)?g["inner"+c]:d(g)?g.documentElement["scroll"+c]:(f=this.offset())&&f[a]:this.each(function(b){g=q(this);g.css(a,r(this,e,b,g[a]()))})}}),["after",
"prepend","before","append"].forEach(function(b,c){var d=c%2;q.fn[b]=function(){var b,e,f=q.map(arguments,function(c){return b=a(c),"object"==b||"array"==b||null==c?c:z.fragment(c)}),g=1<this.length;return 1>f.length?this:this.each(function(a,b){e=d?b:b.parentNode;b=0==c?b.nextSibling:1==c?b.firstChild:2==c?b:null;var h=q.contains(B.documentElement,e);f.forEach(function(a){if(g)a=a.cloneNode(!0);else if(!e)return q(a).remove();e.insertBefore(a,b);h&&t(a,function(a){null==a.nodeName||"SCRIPT"!==a.nodeName.toUpperCase()||
a.type&&"text/javascript"!==a.type||a.src||window.eval.call(window,a.innerHTML)})})})};q.fn[d?b+"To":"insert"+(c?"Before":"After")]=function(a){return q(a)[b](this),this}}),z.Z.prototype=q.fn,z.uniq=C,z.deserializeValue=u,q.zepto=z,q}();window.Zepto=Zepto;void 0===window.$&&(window.$=Zepto);
(function(a){function c(a){return a._zid||(a._zid=m++)}function b(a,b,e,f){if(b=d(b),b.ns)var g=RegExp("(?:^| )"+b.ns.replace(" "," .* ?")+"(?: |$)");return(s[c(a)]||[]).filter(function(a){return!(!a||b.e&&a.e!=b.e||b.ns&&!g.test(a.ns)||e&&c(a.fn)!==c(e)||f&&a.sel!=f)})}function d(a){a=(""+a).split(".");return{e:a[0],ns:a.slice(1).sort().join(" ")}}function e(b,e,f,h,m,p,n){var r=c(b),q=s[r]||(s[r]=[]);e.split(/\s/).forEach(function(c){if("ready"==c)return a(document).ready(f);var e=d(c);e.fn=f;e.sel=
m;e.e in w&&(f=function(b){var c=b.relatedTarget;return!c||c!==this&&!a.contains(this,c)?e.fn.apply(this,arguments):void 0});var r=(e.del=p)||f;e.proxy=function(a){if(a=g(a),!a.isImmediatePropagationStopped()){a.data=h;var c=r.apply(b,a._args==k?[a]:[a].concat(a._args));return!1===c&&(a.preventDefault(),a.stopPropagation()),c}};e.i=q.length;q.push(e);"addEventListener"in b&&b.addEventListener(w[e.e]||t&&v[e.e]||e.e,e.proxy,e.del&&!t&&e.e in v||!!n)})}function f(a,d,e,f,g){var h=c(a);(d||"").split(/\s/).forEach(function(c){b(a,
c,e,f).forEach(function(b){delete s[h][b.i];"removeEventListener"in a&&a.removeEventListener(w[b.e]||t&&v[b.e]||b.e,b.proxy,b.del&&!t&&b.e in v||!!g)})})}function g(b,c){return(c||!b.isDefaultPrevented)&&(c||(c=b),a.each(C,function(a,d){var e=c[a];b[a]=function(){return this[d]=q,e&&e.apply(c,arguments)};b[d]=y}),(c.defaultPrevented!==k?c.defaultPrevented:"returnValue"in c?!1===c.returnValue:c.getPreventDefault&&c.getPreventDefault())&&(b.isDefaultPrevented=q)),b}function h(a){var b,c={originalEvent:a};
for(b in a)A.test(b)||a[b]===k||(c[b]=a[b]);return g(c,a)}var k,m=1,p=Array.prototype.slice,n=a.isFunction,r=function(a){return"string"==typeof a},s={},u={},t="onfocusin"in window,v={focus:"focusin",blur:"focusout"},w={mouseenter:"mouseover",mouseleave:"mouseout"};u.click=u.mousedown=u.mouseup=u.mousemove="MouseEvents";a.event={add:e,remove:f};a.proxy=function(b,d){var e=2 in arguments&&p.call(arguments,2);if(n(b)){var f=function(){return b.apply(d,e?e.concat(p.call(arguments)):arguments)};return f._zid=
c(b),f}if(r(d))return e?(e.unshift(b[d],b),a.proxy.apply(null,e)):a.proxy(b[d],b);throw new TypeError("expected function");};a.fn.bind=function(a,b,c){return this.on(a,b,c)};a.fn.unbind=function(a,b){return this.off(a,b)};a.fn.one=function(a,b,c,d){return this.on(a,b,c,d,1)};var q=function(){return!0},y=function(){return!1},A=/^([A-Z]|returnValue$|layer[XY]$)/,C={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};a.fn.delegate=
function(a,b,c){return this.on(b,a,c)};a.fn.undelegate=function(a,b,c){return this.off(b,a,c)};a.fn.live=function(b,c){return a(document.body).delegate(this.selector,b,c),this};a.fn.die=function(b,c){return a(document.body).undelegate(this.selector,b,c),this};a.fn.on=function(b,c,d,g,m){var G,s,q=this;return b&&!r(b)?(a.each(b,function(a,b){q.on(a,c,d,b,m)}),q):(r(c)||n(g)||!1===g||(g=d,d=c,c=k),(n(d)||!1===d)&&(g=d,d=k),!1===g&&(g=y),q.each(function(k,n){m&&(G=function(a){return f(n,a.type,g),g.apply(this,
arguments)});c&&(s=function(b){var d,e=a(b.target).closest(c,n).get(0);return e&&e!==n?(d=a.extend(h(b),{currentTarget:e,liveFired:n}),(G||g).apply(e,[d].concat(p.call(arguments,1)))):void 0});e(n,b,g,d,c,s||G)}))};a.fn.off=function(b,c,d){var e=this;return b&&!r(b)?(a.each(b,function(a,b){e.off(a,c,b)}),e):(r(c)||n(d)||!1===d||(d=c,c=k),!1===d&&(d=y),e.each(function(){f(this,b,d,c)}))};a.fn.trigger=function(b,c){return b=r(b)||a.isPlainObject(b)?a.Event(b):g(b),b._args=c,this.each(function(){b.type in
v&&"function"==typeof this[b.type]?this[b.type]():"dispatchEvent"in this?this.dispatchEvent(b):a(this).triggerHandler(b,c)})};a.fn.triggerHandler=function(c,d){var e,f;return this.each(function(g,k){e=h(r(c)?a.Event(c):c);e._args=d;e.target=k;a.each(b(k,c.type||c),function(a,b){return f=b.proxy(e),e.isImmediatePropagationStopped()?!1:void 0})}),f};"focusin focusout focus blur load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select keydown keypress keyup error".split(" ").forEach(function(b){a.fn[b]=
function(a){return 0 in arguments?this.bind(b,a):this.trigger(b)}});a.Event=function(a,b){r(a)||(b=a,a=b.type);var c=document.createEvent(u[a]||"Events"),d=!0;if(b)for(var e in b)"bubbles"==e?d=!!b[e]:c[e]=b[e];return c.initEvent(a,d,!0),g(c)}})(Zepto);
(function(a){function c(b,c,d,e){b.global?(b=c||v,d=a.Event(d),e=(a(b).trigger(d,e),!d.isDefaultPrevented())):e=void 0;return e}function b(b){b.global&&0===a.active++&&c(b,null,"ajaxStart")}function d(a,b){var d=b.context;return!1===b.beforeSend.call(d,a,b)||!1===c(b,d,"ajaxBeforeSend",[a,b])?!1:void c(b,d,"ajaxSend",[a,b])}function e(a,b,d,e){var f=d.context;d.success.call(f,a,"success",b);e&&e.resolveWith(f,[a,"success",b]);c(d,f,"ajaxSuccess",[b,d,a]);g("success",b,d)}function f(a,b,d,e,f){var h=
e.context;e.error.call(h,d,b,a);f&&f.rejectWith(h,[d,b,a]);c(e,h,"ajaxError",[d,e,a||b]);g(b,d,e)}function g(b,d,e){var f=e.context;e.complete.call(f,d,b);c(e,f,"ajaxComplete",[d,e]);e.global&&!--a.active&&c(e,null,"ajaxStop")}function h(){}function k(a){return a&&(a=a.split(";",2)[0]),a&&(a==C?"html":a==A?"json":q.test(a)?"script":y.test(a)&&"xml")||"text"}function m(a,b){return""==b?a:(a+"\x26"+b).replace(/[&?]{1,2}/,"?")}function p(b){b.processData&&b.data&&"string"!=a.type(b.data)&&(b.data=a.param(b.data,
b.traditional));!b.data||b.type&&"GET"!=b.type.toUpperCase()||(b.url=m(b.url,b.data),b.data=void 0)}function n(b,c,d,e){return a.isFunction(c)&&(e=d,d=c,c=void 0),a.isFunction(d)||(e=d,d=void 0),{url:b,data:c,success:d,dataType:e}}function r(b,c,d,e){var f,g=a.isArray(c),h=a.isPlainObject(c);a.each(c,function(c,k){f=a.type(k);e&&(c=d?e:e+"["+(h||"object"==f||"array"==f?c:"")+"]");!e&&g?b.add(k.name,k.value):"array"==f||!d&&"object"==f?r(b,k,d,c):b.add(c,k)})}var s,u,t=0,v=window.document,w=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
q=/^(?:text|application)\/javascript/i,y=/^(?:text|application)\/xml/i,A="application/json",C="text/html",D=/^\s*$/,E=v.createElement("a");E.href=window.location.href;a.active=0;a.ajaxJSONP=function(b,c){if(!("type"in b))return a.ajax(b);var g,h,k=b.jsonpCallback,m=(a.isFunction(k)?k():k)||"jsonp"+ ++t,p=v.createElement("script"),n=window[m],r=function(b){a(p).triggerHandler("error",b||"abort")},q={abort:r};return c&&c.promise(q),a(p).on("load error",function(d,k){clearTimeout(h);a(p).off().remove();
"error"!=d.type&&g?e(g[0],q,b,c):f(null,k||"error",q,b,c);window[m]=n;g&&a.isFunction(n)&&n(g[0]);n=g=void 0}),!1===d(q,b)?(r("abort"),q):(window[m]=function(){g=arguments},p.src=b.url.replace(/\?(.+)=\?/,"?$1\x3d"+m),v.head.appendChild(p),0<b.timeout&&(h=setTimeout(function(){r("timeout")},b.timeout)),q)};a.ajaxSettings={type:"GET",beforeSend:h,success:h,error:h,complete:h,context:null,global:!0,xhr:function(){return new window.XMLHttpRequest},accepts:{script:"text/javascript, application/javascript, application/x-javascript",
json:A,xml:"application/xml, text/xml",html:C,text:"text/plain"},crossDomain:!1,timeout:0,processData:!0,cache:!0};a.ajax=function(c){var g,n=a.extend({},c||{}),r=a.Deferred&&a.Deferred();for(s in a.ajaxSettings)void 0===n[s]&&(n[s]=a.ajaxSettings[s]);b(n);n.crossDomain||(g=v.createElement("a"),g.href=n.url,g.href=g.href,n.crossDomain=E.protocol+"//"+E.host!=g.protocol+"//"+g.host);n.url||(n.url=window.location.toString());p(n);var q=n.dataType;g=/\?.+=\?/.test(n.url);if(g&&(q="jsonp"),!1!==n.cache&&
(c&&!0===c.cache||"script"!=q&&"jsonp"!=q)||(n.url=m(n.url,"_\x3d"+Date.now())),"jsonp"==q)return g||(n.url=m(n.url,n.jsonp?n.jsonp+"\x3d?":!1===n.jsonp?"":"callback\x3d?")),a.ajaxJSONP(n,r);var t;c=n.accepts[q];var w={};g=function(a,b){w[a.toLowerCase()]=[a,b]};var y=/^([\w-]+:)\/\//.test(n.url)?RegExp.$1:window.location.protocol,x=n.xhr(),A=x.setRequestHeader;if(r&&r.promise(x),n.crossDomain||g("X-Requested-With","XMLHttpRequest"),g("Accept",c||"*/*"),(c=n.mimeType||c)&&(-1<c.indexOf(",")&&(c=c.split(",",
2)[0]),x.overrideMimeType&&x.overrideMimeType(c)),(n.contentType||!1!==n.contentType&&n.data&&"GET"!=n.type.toUpperCase())&&g("Content-Type",n.contentType||"application/x-www-form-urlencoded"),n.headers)for(u in n.headers)g(u,n.headers[u]);if(x.setRequestHeader=g,x.onreadystatechange=function(){if(4==x.readyState){x.onreadystatechange=h;clearTimeout(t);var b,c=!1;if(200<=x.status&&300>x.status||304==x.status||0==x.status&&"file:"==y){q=q||k(n.mimeType||x.getResponseHeader("content-type"));b=x.responseText;
try{"script"==q?(0,eval)(b):"xml"==q?b=x.responseXML:"json"==q&&(b=D.test(b)?null:a.parseJSON(b))}catch(d){c=d}c?f(c,"parsererror",x,n,r):e(b,x,n,r)}else f(x.statusText||null,x.status?"error":"abort",x,n,r)}},!1===d(x,n))return x.abort(),f(null,"abort",x,n,r),x;if(n.xhrFields)for(u in n.xhrFields)x[u]=n.xhrFields[u];x.open(n.type,n.url,"async"in n?n.async:!0,n.username,n.password);for(u in w)A.apply(x,w[u]);return 0<n.timeout&&(t=setTimeout(function(){x.onreadystatechange=h;x.abort();f(null,"timeout",
x,n,r)},n.timeout)),x.send(n.data?n.data:null),x};a.get=function(){return a.ajax(n.apply(null,arguments))};a.post=function(){var b=n.apply(null,arguments);return b.type="POST",a.ajax(b)};a.getJSON=function(){var b=n.apply(null,arguments);return b.dataType="json",a.ajax(b)};a.fn.load=function(b,c,d){if(!this.length)return this;var e,f=this,g=b.split(/\s/);b=n(b,c,d);var h=b.success;return 1<g.length&&(b.url=g[0],e=g[1]),b.success=function(b){f.html(e?a("\x3cdiv\x3e").html(b.replace(w,"")).find(e):
b);h&&h.apply(f,arguments)},a.ajax(b),this};var F=encodeURIComponent;a.param=function(b,c){var d=[];return d.add=function(b,c){a.isFunction(c)&&(c=c());null==c&&(c="");this.push(F(b)+"\x3d"+F(c))},r(d,b,c),d.join("\x26").replace(/%20/g,"+")}})(Zepto);
(function(a){a.fn.serializeArray=function(){var c,b,d=[],e=function(a){return a.forEach?a.forEach(e):void d.push({name:c,value:a})};return this[0]&&a.each(this[0].elements,function(d,g){b=g.type;(c=g.name)&&"fieldset"!=g.nodeName.toLowerCase()&&!g.disabled&&"submit"!=b&&"reset"!=b&&"button"!=b&&"file"!=b&&("radio"!=b&&"checkbox"!=b||g.checked)&&e(a(g).val())}),d};a.fn.serialize=function(){var a=[];return this.serializeArray().forEach(function(b){a.push(encodeURIComponent(b.name)+"\x3d"+encodeURIComponent(b.value))}),
a.join("\x26")};a.fn.submit=function(c){if(0 in arguments)this.bind("submit",c);else if(this.length){var b=a.Event("submit");this.eq(0).trigger(b);b.isDefaultPrevented()||this.get(0).submit()}return this}})(Zepto);(function(a){"__proto__"in{}||a.extend(a.zepto,{Z:function(b,c){return b=b||[],a.extend(b,a.fn),b.selector=c||"",b.__Z=!0,b},isZ:function(b){return"array"===a.type(b)&&"__Z"in b}});try{getComputedStyle(void 0)}catch(c){var b=getComputedStyle;window.getComputedStyle=function(a){try{return b(a)}catch(c){return null}}}})(Zepto);var res={Sprites_png:"res/Sprites.png",Sprites_plist:"res/Sprites.plist"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var SERVER_ADD=document.location.host,server={_httpServerAddr:"http://"+SERVER_ADD+"/api",_socketServerAddr:"ws://"+SERVER_ADD+"/socket",_username:null,_sessionId:null,_socket:null,_msgId:0,_callbacks:{},getSessionId:function(){return server._sessionId},validateResult:function(a,c){var b=a.err;if(void 0!==b)return cc.log("ERR: "+b.toString()),!1;for(b=0;b<c.length;b++){var d=c[b];if(void 0===a[d])return cc.log('ERR: not found field "'+d+'" in resultult'),!1}return!0},login:function(a){if(server._sessionId)return cc.log("ALREADY LOGIN"),
!1;server._username="USER"+parseInt(1E7*Math.random()).toString();server.sendHttpRequest("user.login",{username:server._username},function(c){if(!server.validateResult(c,["sid"]))return!1;server._sessionId=c.sid.toString();cc.log("GET SESSION ID: "+server._sessionId);server.connect(a)})},logout:function(a){if(null===server._sessionId)return cc.log("ALREADY LOGOUT"),!1;server.sendHttpRequest("user.logout",function(c){server._sessionId=null;cc.log("LOGOUTED");a&&a()})},connect:function(a){var c="quickserver-"+
server._sessionId;cc.log("CONNECT WEBSOCKET with PROTOCOL: "+c.toString());c=new WebSocket(server._socketServerAddr,c);c.onopen=function(){cc.log("WEBSOCKET CONNECTED");a&&a()};c.onerror=function(a){a instanceof Event?cc.log("ERR: CONNECT FAILED"):cc.log("ERR: "+a.toString())};c.onmessage=function(a){cc.log("SOCKET RECV: "+a.data.toString());if(null!==a.data)if(a=JSON.parse(a.data),void 0!==a.__id){var c=a.__id.toString();if(void 0!==server._callbacks[c]){var e=server._callbacks[c];server._callbacks[c]=
null;e(a)}}else if(c=a.__event,void 0!==c)server["on"+c](a)};c.onclose=function(){cc.log("WEBSOCKET DISCONNECTED");server._socket=null};server._socket=c;server._callbacks={}},disconnect:function(){null===server._socket?cc.log("NOT CONNECTED"):(server._socket.close(),server._socket=null,server._callbacks={});return!1},sendHttpRequest:function(a,c,b){"undefined"==typeof b&&(b=c,c={});c.action=a;$.getJSON(server._httpServerAddr,c,b)},sendSocketMessage:function(a,c,b){null===server._socket?cc.log("NOT CONNECTED"):
(server._msgId++,"undefined"===typeof c&&(c={}),c.__id=server._msgId,c.action=a,a=JSON.stringify(c),null!==b&&(server._callbacks[server._msgId.toString()]=b),server._socket.send(a),cc.log("SOCKET SEND: "+a))}};cc.dist=function(a,c){var b=c.x-a.x,d=c.y-a.y;return Math.sqrt(b*b+d*d)};cc.radiansBetweenPoints=function(a,c){return Math.atan2(a.y-c.y,c.x-a.x)};cc.pointAtCircle=function(a,c,b){return cc.p(a.x+Math.cos(b)*c,a.y-Math.sin(b)*c)};
var Tank=cc.Sprite.extend({ctor:function(a,c){this._super();var b="Tank"+a;this.initWithSpriteFrameName(b+"0001.png");this._animation=cc.animate(cc.animationCache.getAnimation(b));this._id=c;this._speed=60;this._roationSpeed=120;this._rotateoffset=this._dir=this._destr=this._movelen=this._dist=this._dest=this._begin=null;this._state="idle";this._waitMessage=!1},start:function(){this.stop();this._movingAction=this.runAction(new cc.RepeatForever(this._animation))},stop:function(){this._movingAction&&
(this.stopAction(this._movingAction),this._movingAction=null)},trymove:function(a){if(!this.isVisible())return!1;var c=this.getPosition();a={cx:c.x,cy:c.y,cr:this.getRotation(),x:a.x,y:a.y};server.sendSocketMessage("battle.move",a)},_move:function(a){this.start();this._begin=this.getPosition();this._dest=cc.p(a.x,a.y);this._movelen=this._dist=a.dist;this._destr=a.destr;this._dir=a.dir;this._rotateoffset=a.rotateoffset;this._state="rotate";this.setRotation(a.rotation)},_step:function(a){if("idle"!=
this._state)if("rotate"==this._state){var c=this.getRotation();a*=this._roationSpeed;c="right"==this._dir?c+a:c-a;this._rotateoffset-=a;0>=this._rotateoffset&&(c=this._destr,this._state="move");this.setRotation(c)}else if("move"==this._state){var c=cc.degreesToRadians(this.getRotation()),b=this.getPosition();a*=this._speed;this._dist-=a;0>=this._dist?(this._state="idle",b=cc.pointAtCircle(this._begin,this._movelen,c),this.stop()):b=cc.pointAtCircle(b,a,c);this.setPosition(b)}}}),BattleLayer=cc.Layer.extend({ctor:function(){this._super();
var a=new cc.LayerColor(cc.color(83,71,65,255));this.addChild(a);var a=server.getSessionId(),c=new Tank("Red",a);c.setVisible(!1);this.addChild(c);this._tank=c;this._tanks={};this._tanks[a]=c;var b=this;server.onenter=function(a){var c=a.__sid,f=b._tanks[c];"undefined"===typeof f&&(f=new Tank("Red"),b.addChild(f));f.setVisible(!0);f.setPosition(a.x,a.y);f.setRotation(a.rotation);b._tanks[c]=f};server.onmove=function(a){var c=b._tanks[a.__sid];"undefined"!==typeof c&&c._move(a)};server.sendSocketMessage("battle.enter");
a=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,c){b._tank.trymove(a.getLocation());return!1}});cc.eventManager.addListener(a,this);this.scheduleUpdate()},update:function(a){for(key in this._tanks)this._tanks[key]._step(a)}}),BattleScene=cc.Scene.extend({onEnter:function(){this._super();var a=new BattleLayer;this.addChild(a)}});var glview={width:480,height:800};glview.cx=glview.width/2;glview.cy=glview.height/2;
cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(glview.width,glview.height,cc.ResolutionPolicy.EXACT_FIT);cc.view.resizeWithBrowserSize(!1);cc.LoaderScene.preload(g_resources,function(){cc.spriteFrameCache.addSpriteFrames(res.Sprites_plist);for(var a=["Red","Blue","Green","Yellow"],c=0;c<a.length;++c){for(var b=[],d=1;2>=d;++d){var e=cc.spriteFrameCache.getSpriteFrame("Tank"+a[c]+"000"+d.toString()+".png");b.push(e)}b=new cc.Animation(b,0.15);cc.animationCache.addAnimation(b,
"Tank"+a[c])}server.login(function(){cc.director.runScene(new BattleScene)})},this)};cc.game.run();