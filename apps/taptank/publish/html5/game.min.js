...
var Tank=cc.Sprite.extend({ctor:function(a,c){this._super();var b="Tank"+a;this.initWithSpriteFrameName(b+"0001.png");this._animation=cc.animate(cc.animationCache.getAnimation(b));this._uid=c;this._state="idle";this._speed=60;this._rotationSpeed=120},start:function(){this.stop();this._movingAction=this.runAction(new cc.RepeatForever(this._animation))},stop:function(){this._movingAction&&(this.stopAction(this._movingAction),this._movingAction=null)},move:function(a){this.start();this._begin=cc.p(a.x,
a.y);this._dest=cc.p(a.destx,a.desty);this._dist=this._movelen=a.dist;this._destr=a.destr;this._dir=a.dir;this._rotateoffset=a.rotateoffset;this._state="rotate";this.setPosition(a.x,a.y);this.setRotation(a.rotation)},step:function(a){if("idle"!=this._state)if("rotate"==this._state){var c=this.getRotation();a*=this._rotationSpeed;c="right"==this._dir?c+a:c-a;this._rotateoffset-=a;0>=this._rotateoffset&&(c=this._destr,this._state="move");this.setRotation(c)}else if("move"==this._state){var c=cc.degreesToRadians(this.getRotation()),
b=this.getPosition();a*=this._speed;this._dist-=a;0>=this._dist?(this._state="idle",b=cc.pointAtCircle(this._begin,this._movelen,c),this.stop()):b=cc.pointAtCircle(b,a,c);this.setPosition(b)}}}),BattleLayer=cc.Layer.extend({ctor:function(){this._super();var a=new cc.LayerColor(cc.color(83,71,65,255));this.addChild(a);this._tanks={};var c=this,b=server.getUid();server.onenter=function(a){var e=a.__uid,f=c._tanks[e];"undefined"===typeof f&&(f=new Tank(a.color,e),c.addChild(f),b==e?(cc.log("your tank %s enter battle",
e),c._tank=f):cc.log("tank %s enter battle",e));f.setVisible(!0);f.setPosition(a.x,a.y);f.setRotation(a.rotation);c._tanks[e]=f};server.onmove=function(a){var b=c._tanks[a.__uid];"undefined"!==typeof b&&b.move(a)};server.onremove=function(a){a=a.__uid;var b=c._tanks[a];"undefined"!==typeof b&&(b.removeFromParent(),c._tanks[a]=null)};server.sendSocketMessage("battle.enter");a=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){c.move(a.getLocation());
return!1}});cc.eventManager.addListener(a,this);this.scheduleUpdate()},move:function(a){var c=this._tank;if(c&&c.isVisible()){var b=c.getPosition();a={x:b.x,y:b.y,rotation:c.getRotation(),destx:a.x,desty:a.y};server.sendSocketMessage("battle.move",a)}},update:function(a){var c=this._tanks;for(uid in c){var b=c[uid];b&&b.step&&b.step(a)}}}),BattleScene=cc.Scene.extend({onEnter:function(){this._super();var a=new BattleLayer;this.addChild(a)}});var glview={width:480,height:800};glview.cx=glview.width/2;glview.cy=glview.height/2;
