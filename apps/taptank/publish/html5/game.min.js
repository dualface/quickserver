...
b.BROWSER_TYPE_SAFARI],e=[b.OS_IOS,b.OS_WINDOWS,b.OS_OSX,b.OS_LINUX],f=[b.BROWSER_TYPE_BAIDU,b.BROWSER_TYPE_OPERA,b.BROWSER_TYPE_FIREFOX,b.BROWSER_TYPE_CHROME,b.BROWSER_TYPE_BAIDU_APP,b.BROWSER_TYPE_SAFARI,b.BROWSER_TYPE_UC,b.BROWSER_TYPE_QQ,b.BROWSER_TYPE_MOBILE_QQ,b.BROWSER_TYPE_IE],g=window,h=g.navigator,k=document,m=k.documentElement,n=h.userAgent.toLowerCase();b.isMobile=-1!=n.indexOf("mobile")||-1!=n.indexOf("android");b.platform=b.isMobile?b.MOBILE_BROWSER:b.DESKTOP_BROWSER;var p=h.language,
p=(p=p?p:h.browserLanguage)?p.split("-")[0]:b.LANGUAGE_ENGLISH;b.language=p;var p=b.BROWSER_TYPE_UNKNOWN,r=n.match(/sogou|qzone|liebao|micromessenger|qqbrowser|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i)||n.match(/chrome|safari/i);r&&0<r.length&&(p=r[0],"micromessenger"==p?p=b.BROWSER_TYPE_WECHAT:"safari"===p&&n.match(/android.*applewebkit/)?p=b.BROWSER_TYPE_ANDROID:"trident"==p?p=b.BROWSER_TYPE_IE:"360 aphone"==p&&(p=b.BROWSER_TYPE_360));
b.browserType=p;p=n.match(/(iPad|iPhone|iPod)/i)?!0:!1;n=n.match(/android/i)||h.platform.match(/android/i)?!0:!1;r=b.OS_UNKNOWN;-1!=h.appVersion.indexOf("Win")?r=b.OS_WINDOWS:p?r=b.OS_IOS:-1!=h.appVersion.indexOf("Mac")?r=b.OS_OSX:-1!=h.appVersion.indexOf("X11")?r=b.OS_UNIX:n?r=b.OS_ANDROID:-1!=h.appVersion.indexOf("Linux")&&(r=b.OS_LINUX);b.os=r;b._supportMultipleAudio=-1<f.indexOf(b.browserType);f=parseInt(a[c.renderMode]);n=cc._RENDER_TYPE_WEBGL;p=cc.newElement("Canvas");cc._supportRender=!0;d=
!window.WebGLRenderingContext||-1==d.indexOf(b.browserType)||-1==e.indexOf(b.os);if(1===f||0===f&&d||"file://"==location.origin)n=cc._RENDER_TYPE_CANVAS;b._canUseCanvasNewBlendModes=function(){var a=document.createElement("canvas");a.width=1;a.height=1;a=a.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,1,1);a.globalCompositeOperation="multiply";var c=document.createElement("canvas");c.width=1;c.height=1;var b=c.getContext("2d");b.fillStyle="#fff";b.fillRect(0,0,1,1);a.drawImage(c,0,0,1,1);return 0===
a.getImageData(0,0,1,1).data[0]};b._supportCanvasNewBlendModes=b._canUseCanvasNewBlendModes();if(n==cc._RENDER_TYPE_WEBGL&&(!g.WebGLRenderingContext||!cc.create3DContext(p,{stencil:!0,preserveDrawingBuffer:!0})))0==f?n=cc._RENDER_TYPE_CANVAS:cc._supportRender=!1;if(n==cc._RENDER_TYPE_CANVAS)try{p.getContext("2d")}catch(q){cc._supportRender=!1}cc._renderType=n;try{b._supportWebAudio=!(!g.AudioContext&&!g.webkitAudioContext&&!g.mozAudioContext)}catch(t){b._supportWebAudio=!1}try{var s=b.localStorage=
g.localStorage;s.setItem("storage","");s.removeItem("storage");s=null}catch(u){("SECURITY_ERR"===u.name||"QuotaExceededError"===u.name)&&cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"),b.localStorage=function(){}}s=b.capabilities={canvas:!0};cc._renderType==cc._RENDER_TYPE_WEBGL&&(s.opengl=!0);if(void 0!==m.ontouchstart||void 0!==k.ontouchstart||h.msPointerEnabled)s.touches=!0;void 0!==m.onmouseup&&(s.mouse=!0);void 0!==m.onkeyup&&(s.keyboard=!0);if(g.DeviceMotionEvent||
g.DeviceOrientationEvent)s.accelerometer=!0;b.garbageCollect=function(){};b.dumpRoot=function(){};b.restartVM=function(){};b.cleanScript=function(a){};b.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+="language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";a+="os : "+this.os+"\r\n";a+="platform : "+this.platform+"\r\n";cc.log(a)}};cc.ORIENTATION_PORTRAIT=0;cc.ORIENTATION_PORTRAIT_UPSIDE_DOWN=1;
...
b[d.renderMode];c._prepareCalled=!0;var g=b[d.jsList]||[];cc.Class?f.loadJsWithImg("",g,function(b){if(b)throw b;c._prepared=!0;a&&a()}):(d=cc.path.join(e,"moduleConfig.json"),f.loadJson(d,function(d,f){if(d)throw d;var m=b.modules||[],n=f.module,p=[];cc._renderType==cc._RENDER_TYPE_WEBGL?m.splice(0,0,"shaders"):0>m.indexOf("core")&&m.splice(0,0,"core");for(var r=0,q=m.length;r<q;r++){var t=c._getJsListOfModule(n,m[r],e);t&&(p=p.concat(t))}p=p.concat(g);cc.loader.loadJsWithImg(p,function(b){if(b)throw b;
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var n=arguments[k],p;for(p in n){var r="function"===typeof n[p],q="function"===typeof e[p],t=a.test(n[p]);c&&r&&q&&t?(h.value=ClassManager.compileSuper(n[p],p,g),Object.defineProperty(f,p,h)):r&&q&&t?(h.value=function(a,c){return function(){var b=this._super;this._super=e[a];var d=c.apply(this,
arguments);this._super=b;return d}}(p,n[p]),Object.defineProperty(f,p,h)):r?(h.value=n[p],Object.defineProperty(f,p,h)):f[p]=n[p];if(r){var s,u;if(this.__getters__&&this.__getters__[p]){var r=this.__getters__[p],v;for(v in this.__setters__)if(this.__setters__[v]==r){u=v;break}cc.defineGetterSetter(f,r,n[p],n[u]?n[u]:f[u],p,u)}if(this.__setters__&&this.__setters__[p]){r=this.__setters__[p];for(v in this.__getters__)if(this.__getters__[v]==r){s=v;break}cc.defineGetterSetter(f,r,n[s]?n[s]:f[s],n[p],
s,p)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var c in a)f[c]=a[c]};return d}})();
cc.defineGetterSetter=function(a,c,b,d,e,f){if(a.__defineGetter__)b&&a.__defineGetter__(c,b),d&&a.__defineSetter__(c,d);else if(Object.defineProperty){var g={enumerable:!1,configurable:!0};b&&(g.get=b);d&&(g.set=d);Object.defineProperty(a,c,g)}else throw Error("browser does not support getters");if(!e&&!f)for(var g=null!=b,h=void 0!=d,k=Object.getOwnPropertyNames(a),m=0;m<k.length;m++){var n=k[m];if(!((a.__lookupGetter__?a.__lookupGetter__(n):Object.getOwnPropertyDescriptor(a,n))||"function"!==typeof a[n])){var p=
a[n];if(g&&p===b&&(e=n,!h||f))break;if(h&&p===d&&(f=n,!g||e))break}}a=a.constructor;e&&(a.__getters__||(a.__getters__={}),a.__getters__[e]=c);f&&(a.__setters__||(a.__setters__={}),a.__setters__[f]=c)};cc.clone=function(a){var c=a.constructor?new a.constructor:{},b;for(b in a){var d=a[b];c[b]="object"==typeof d&&d&&!(d instanceof cc.Node)&&!(d instanceof HTMLElement)?cc.clone(d):d}return c};cc.inject=function(a,c){for(var b in a)c[b]=a[b]};cc=cc||{};cc._tmp=cc._tmp||{};cc.associateWithNative=function(a,c){};
...
(function(){var a=cc.ContainerStrategy.extend({apply:function(a){this._setupContainer(a,a._frameSize.width,a._frameSize.height)}}),c=cc.ContainerStrategy.extend({apply:function(a,c){var b=a._frameSize.width,d=a._frameSize.height,e=cc.container.style,n=c.width,p=c.height,r=b/n,q=d/p,t,s;r<q?(t=b,s=p*r):(t=n*q,s=d);n=Math.round((b-t)/2);s=Math.round((d-s)/2);this._setupContainer(a,b-2*n,d-2*s);e.marginLeft=n+"px";e.marginRight=n+"px";e.marginTop=s+"px";e.marginBottom=s+"px"}});a.extend({preApply:function(a){this._super(a);
...
c){var b=cc._canvas.width,d=cc._canvas.height;return this._buildResult(b,d,b,d,b/c.width,d/c.height)}}),c=cc.ContentStrategy.extend({apply:function(a,c){var b=cc._canvas.width,d=cc._canvas.height,e=c.width,n=c.height,p=b/e,r=d/n,q=0,t,s;p<r?(q=p,t=b,s=n*q):(q=r,t=e*q,s=d);return this._buildResult(b,d,t,s,q,q)}}),b=cc.ContentStrategy.extend({apply:function(a,c){var b=cc._canvas.width,d=cc._canvas.height,e=c.width,n=c.height,p=b/e,r=d/n,q,t,s;p<r?(q=r,t=e*q,s=d):(q=p,t=b,s=n*q);return this._buildResult(b,
...
cc.pSubIn=function(a,c){a.x-=c.x;a.y-=c.y};cc.pAddIn=function(a,c){a.x+=c.x;a.y+=c.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,c,b,d,e){e+=d;if(!(1>=e)){c*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var n=cc.p(a[2*(h+1)],a[2*(h+1)+1]),p=cc.pNormalize(cc.pSub(n,k)),r=cc.pNormalize(cc.pSub(m,k)),q=Math.acos(cc.pDot(p,r));m=q<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(p,
r))):q<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(p,r)):cc.pPerp(cc.pNormalize(cc.pSub(n,m)))}m=cc.pMult(m,c);b[2*f]=k.x+m.x;b[2*f+1]=k.y+m.y;b[2*(f+1)]=k.x-m.x;b[2*(f+1)+1]=k.y-m.y}for(h=0==d?0:d-1;h<g;h++){f=2*h;a=f+2;c=cc.vertex2(b[2*f],b[2*f+1]);e=cc.vertex2(b[2*(f+1)],b[2*(f+1)+1]);f=cc.vertex2(b[2*a],b[2*a]);d=cc.vertex2(b[2*(a+1)],b[2*(a+1)+1]);c=!cc.vertexLineIntersect(c.x,c.y,d.x,d.y,e.x,e.y,f.x,f.y);if(!c.isSuccess&&(0>c.value||1<c.value))c.isSuccess=!0;c.isSuccess&&(b[2*a]=d.x,
...
var c=cc.Texture2D._B[a];if(null!=c)return c;cc.log(cc._LogInfos.Texture2D_bitsPerPixelForFormat,a);return-1},_initPremultipliedATextureWithImage:function(a,c,b){var d=cc.Texture2D,e=a.getData(),f=null,f=null,g=a.hasAlpha(),h=cc.size(a.getWidth(),a.getHeight()),k=d.defaultPixelFormat,m=a.getBitsPerComponent();g||(8<=m?k=d.PIXEL_FORMAT_RGB888:(cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),k=d.PIXEL_FORMAT_RGB565));var n=c*b;if(k==d.PIXEL_FORMAT_RGB565)if(g){e=new Uint16Array(c*
b);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>2<<5|(f[m]>>16&255)>>3<<0}else{e=new Uint16Array(c*b);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]&255)>>3<<11|(f[m]&255)>>2<<5|(f[m]&255)>>3<<0}else if(k==d.PIXEL_FORMAT_RGBA4444){e=new Uint16Array(c*b);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]>>0&255)>>4<<12|(f[m]>>8&255)>>4<<8|(f[m]>>16&255)>>4<<4|(f[m]>>24&255)>>4<<0}else if(k==d.PIXEL_FORMAT_RGB5A1){e=new Uint16Array(c*b);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]>>0&255)>>3<<
11|(f[m]>>8&255)>>3<<6|(f[m]>>16&255)>>3<<1|(f[m]>>24&255)>>7<<0}else if(k==d.PIXEL_FORMAT_A8){e=new Uint8Array(c*b);f=a.getData();for(m=0;m<n;++m)e[m]=f>>24&255}if(g&&k==d.PIXEL_FORMAT_RGB888){f=a.getData();e=new Uint8Array(3*c*b);for(m=0;m<n;++m)e[3*m]=f>>0&255,e[3*m+1]=f>>8&255,e[3*m+2]=f>>16&255}this.initWithData(e,k,c,b,h);a.getData();this._hasPremultipliedAlpha=a.isPremultipliedAlpha();return!0},addLoadedEventListener:function(a,c){this.addEventListener("load",a,c)},removeLoadedEventListener:function(a){this.removeEventListener("load",
a)}})};
...
f.x-m.x,k.y+f.y-m.y);else{var n=this.getAnchorPointInPoints(),p=m.x-n.x,m=m.y-n.y;g.setOffset(0-f.x,h.canvas.height-f.height+f.y);b.setPosition(k.x+f.x-p,k.y+f.y-m)}cc.renderer._turnToCacheMode(this.__instanceId);if(0<e){a.sortAllChildren();for(a=0;a<e;a++)if(f=d[a],0>f._localZOrder)f._renderCmd.visit(this);else break;for(cc.renderer.pushRenderCommand(this);a<e;a++)d[a]._renderCmd.visit(this)}else cc.renderer.pushRenderCommand(this);cc.renderer._renderingToCacheCanvas(g,this.__instanceId);b.transform(this);
...
h;for(var k=k.getImageData(0,0,e,h).data,m=0;4>m;m++){var n=d[m].getContext("2d");n.getImageData(0,0,e,h).data;b.tempCtx.drawImage(a,0,0);for(var p=b.tempCtx.getImageData(0,0,e,h),r=p.data,q=0;q<k.length;q+=4)r[q]=0===m?k[q]:0,r[q+1]=1===m?k[q+1]:0,r[q+2]=2===m?k[q+2]:0,r[q+3]=k[q+3];n.putImageData(p,0,0)}a.onload=null}if(a.channelCache)return a.channelCache;var d=[cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas")];try{b()}catch(e){a.onload=b}return a.channelCache=
...
h=d+f.width,k=g+f.height,m=e.tx,n=e.ty,p=e.a,r=e.b,q=e.d,t=-e.c,e=d*p-g*t+m,f=d*r+g*q+n,s=h*p-g*t+m,g=h*r+g*q+n,u=h*p-k*t+m,h=h*r+k*q+n,m=d*p-k*t+m,d=d*r+k*q+n,k=a._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(e|=0,f|=0,s|=0,g|=0,u|=0,h|=0,m|=0,d|=0);b.bl.vertices={x:e,y:f,z:k};b.br.vertices={x:s,y:g,z:k};b.tl.vertices={x:m,y:d,z:k};b.tr.vertices={x:u,y:h,z:k}}a.textureAtlas.updateQuad(b,a.atlasIndex);this._dirty=a._recursiveDirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,
...
a._strokeShadowOffsetX=d;a._strokeShadowOffsetY=e;a=a._anchorPoint;this._anchorPointInPoints.x=0.5*d+(b.width-d)*a.x;this._anchorPointInPoints.y=0.5*e+(b.height-e)*a.y};a._drawTTFInCanvas=function(a){if(a){var b=this._node,d=b._strokeShadowOffsetX,e=b._strokeShadowOffsetY,f=b._contentSize.height-e,g=b._vAlignment,h=b._hAlignment,k=b._strokeSize;a.setTransform(1,0,0,1,0+0.5*d,f+0.5*e);a.font!=this._fontStyleStr&&(a.font=this._fontStyleStr);a.fillStyle=this._fillColorStr;var m=e=0,n=b._strokeEnabled;
n&&(a.lineWidth=2*k,a.strokeStyle=this._strokeColorStr);b._shadowEnabled&&(k=b._shadowOffset,a.shadowColor=this._shadowColorStr,a.shadowOffsetX=k.x,a.shadowOffsetY=-k.y,a.shadowBlur=b._shadowBlur);a.textBaseline=cc.LabelTTF._textBaseline[g];a.textAlign=cc.LabelTTF._textAlign[h];var p=b._contentSize.width-d,d=b.getLineHeight(),k=(d-this._fontClientHeight)/2,e=h===cc.TEXT_ALIGNMENT_RIGHT?e+p:h===cc.TEXT_ALIGNMENT_CENTER?e+p/2:e+0;if(this._isMultiLine){b=this._strings.length;g===cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM?
m=d-2*k+f-d*b:g===cc.VERTICAL_TEXT_ALIGNMENT_CENTER&&(m=(d-2*k)/2+(f-d*b)/2);for(g=0;g<b;g++)h=this._strings[g],p=-f+(d*g+k)+m,n&&a.strokeText(h,e,p),a.fillText(h,e,p)}else g!==cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM&&(m=g===cc.VERTICAL_TEXT_ALIGNMENT_TOP?m-f:m-0.5*f),n&&a.strokeText(b._string,e,m),a.fillText(b._string,e,m)}};a._checkWarp=function(a,b,d){var e=a[b],f=this._measure(e);if(f>d&&1<e.length){for(var g=e.length*(d/f)|0,h=e.substr(g),k=f-this._measure(h),m,n=0,p=0;k>d&&100>p++;)g*=d/k,g|=0,h=
...
n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,r=0;r<d;r++){var q=b.charCodeAt(r)-a._mapStartChar.charCodeAt(0),t=q%a._itemsPerRow,s=0|q/a._itemsPerRow,u;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(t=(2*t*h+1)/(2*g),q=t+(2*h-2)/(2*g),s=(2*s*k+1)/(2*f),u=s+(2*k-2)/(2*f)):(t=t*h/g,q=t+h/g,s=s*k/f,u=s+k/f);var v=m[r],y=v.tl,w=v.tr,x=v.bl,v=v.br;y.texCoords.u=t;y.texCoords.v=s;w.texCoords.u=q;w.texCoords.v=s;x.texCoords.u=t;x.texCoords.v=u;v.texCoords.u=q;v.texCoords.v=u;x.vertices.x=r*p;x.vertices.y=
0;x.vertices.z=0;v.vertices.x=r*p+p;v.vertices.y=0;v.vertices.z=0;y.vertices.x=r*p;y.vertices.y=a._itemHeight;y.vertices.z=0;w.vertices.x=r*p+p;w.vertices.y=a._itemHeight;w.vertices.z=0;y.colors=n;w.colors=n;x.colors=n;v.colors=n}0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.setString=function(a){a=a.length;a>this._textureAtlas.totalQuads&&this._textureAtlas.resizeCapacity(a)};a._addChild=function(){}})();cc.LABEL_AUTOMATIC_WIDTH=-1;
...
null==b?-1:b,this._realOpacity=255,this._realColor=cc.color(255,255,255,255),this._contentSize.width=0,this._contentSize.height=0,this.setAnchorPoint(0.5,0.5),this._renderCmd._initBatchTexture(),this.setString(a,!0),!0):!1},createFontChars:function(){var a=this._renderCmd._texture||this.textureAtlas.texture,c=0,b=cc.size(0,0),d=0,e=1,f=this._string,g=f?f.length:0;if(0!==g){var h,k=this._config,m=k.kerningDict,n=k.commonHeight,p=k.fontDefDictionary;for(h=0;h<g-1;h++)10==f.charCodeAt(h)&&e++;var r=
n*e,e=-(n-n*e),q=-1;for(h=0;h<g;h++)if(n=f.charCodeAt(h),0!=n)if(10===n)c=0,e-=k.commonHeight;else{var t=m[q<<16|n&65535]||0,s=p[n];if(s){var u=cc.rect(s.rect.x,s.rect.y,s.rect.width,s.rect.height),u=cc.rectPixelsToPoints(u);u.x+=this._imageOffset.x;u.y+=this._imageOffset.y;(q=this.getChildByTag(h))?this._renderCmd._updateCharTexture(q,u,n):(q=new cc.Sprite,q.initWithTexture(a,u,!1),q._newTextureWhenChangeColor=!0,this.addChild(q,0,h));q.opacityModifyRGB=this._opacityModifyRGB;this._renderCmd._updateCharColorAndOpacity(q);
u=cc.p(c+s.xOffset+0.5*s.rect.width+t,e+(k.commonHeight-s.yOffset)-0.5*u.height*cc.contentScaleFactor());q.setPosition(cc.pointPixelsToPoints(u));c+=s.xAdvance+t;q=n;d<c&&(d=c)}else cc.log("cocos2d: LabelBMFont: character not found "+f[h])}b.width=s&&s.xAdvance<s.rect.width?d-s.xAdvance+s.rect.width:d;b.height=r;this.setContentSize(cc.sizePixelsToPoints(b))}},updateString:function(a){var c=this._children;if(c)for(var b=0,d=c.length;b<d;b++){var e=c[b];e&&(e.visible=!1)}this._config&&this.createFontChars();
a||this.updateLabel()},getString:function(){return this._initialString},setString:function(a,c){a=String(a);null==c&&(c=!0);if(null==a||!cc.isString(a))a+="";this._initialString=a;this._setString(a,c)},_setStringForSetter:function(a){this.setString(a,!1)},setCString:function(a){this.setString(a,!0)},updateLabel:function(){this.string=this._initialString;if(0<this._width){for(var a=this._string.length,c=[],b=[],d=1,e=0,f=!1,g=!1,h=-1,k=-1,m=0,n,p=0,r=this._children.length;p<r;p++){for(var q=0;!(n=
this.getChildByTag(p+m+q));)q++;m+=q;if(e>=a)break;var t=this._string[e];g||(k=this._getLetterPosXLeft(n),g=!0);f||(h=k,f=!0);if(10==t.charCodeAt(0)){b.push("\n");c=c.concat(b);b.length=0;f=g=!1;h=k=-1;p--;m-=q;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(n),g=!0);h||(h=k,f=!0);e++}else if(this._isspace_unicode(t))b.push(t),c=c.concat(b),b.length=0,g=!1,k=-1,e++;else if(this._getLetterPosXRight(n)-h>this._width)if(this._lineBreakWithoutSpaces){this._utf8_trim_ws(b);b.push("\n");c=c.concat(b);b.length=
0;f=g=!1;h=k=-1;d++;if(e>=a)break;k||(k=this._getLetterPosXLeft(n),g=!0);h||(h=k,f=!0);p--}else b.push(t),-1!=c.lastIndexOf(" ")?this._utf8_trim_ws(c):c=[],0<c.length&&c.push("\n"),d++,f=!1,h=-1,e++;else b.push(t),e++}c=c.concat(b);p=c.length;n="";for(e=0;e<p;++e)n+=c[e];n+=String.fromCharCode(0);this._setString(n,!1)}if(this._alignment!=cc.TEXT_ALIGNMENT_LEFT){c=e=0;a=this._string.length;b=[];for(d=0;d<a;d++)if(10==this._string[d].charCodeAt(0)||0==this._string[d].charCodeAt(0))if(p=0,f=b.length,
0==f)c++;else{if(n=e+f-1+c,!(0>n)&&(p=this.getChildByTag(n),null!=p)){p=p.getPositionX()+p._getWidth()/2;g=0;switch(this._alignment){case cc.TEXT_ALIGNMENT_CENTER:g=this.width/2-p/2;break;case cc.TEXT_ALIGNMENT_RIGHT:g=this.width-p}if(0!=g)for(p=0;p<f;p++)if(n=e+p+c,!(0>n)&&(n=this.getChildByTag(n)))n.x+=g;e+=f;c++;b.length=0}}else b.push(this._string[e])}},setAlignment:function(a){this._alignment=a;this.updateLabel()},_getAlignment:function(){return this._alignment},setBoundingWidth:function(a){this._width=
...
this._children;if(m&&0<m.length){c=0;for(k=m.length;c<k;c++)if(!(d>=a.length)&&(g=a[d]))h=m[c].height,e=e>=h||isNaN(h)?e:h,++f,f>=g&&(b+=e+5,e=f=0,++d)}var n=cc.director.getWinSize(),p=g=e=d=0,r=0,b=b/2;if(m&&0<m.length){c=0;for(k=m.length;c<k;c++){var q=m[c];0==g&&(g=a[d],r=p=n.width/(1+g));h=q._getHeight();e=e>=h||isNaN(h)?e:h;q.setPosition(r-n.width/2,b-h/2);r+=p;++f;f>=g&&(b-=e+5,e=g=f=0,++d)}}},alignItemsInRows:function(){0<arguments.length&&null==arguments[arguments.length-1]&&cc.log("parameters should not be ending with null in Javascript");
var a=[],c;for(c=0;c<arguments.length;c++)a.push(arguments[c]);var b=[],d=[],e=-10,f=-5,g=0,h=0,k=0,m,n,p,r,q=this._children;if(q&&0<q.length){c=0;for(p=q.length;c<p;c++)if(n=q[c],!(g>=a.length)&&(m=a[g]))r=n.width,h=h>=r||isNaN(r)?h:r,f+=n.height+5,++k,k>=m&&(b.push(h),d.push(f),e+=h+10,h=k=0,f=-5,++g)}f=cc.director.getWinSize();m=h=g=0;var e=-e/2,t=0;if(q&&0<q.length){c=0;for(p=q.length;c<p;c++)n=q[c],0==m&&(m=a[g],t=d[g]),r=n._getWidth(),h=h>=r||isNaN(r)?h:r,n.setPosition(e+b[g]/2,t-f.height/2),
...
window.mozAudioContext)}catch(g){c=!1,cc.log("browser don't support webAudio")}var h={cache:{},load:function(a,b,d,g){if(0===e.length)return g("can not support audio!");var k=cc.path.extname(a);b=[k];for(d=0;d<e.length;d++)k!==e[d]&&b.push(e[d]);if(h.cache[a])return g(null,h.cache[a]);c?(d=f.createGain(),d.gain.value=1,d.connect(f.destination),d=new cc.Audio(f,d,a)):d=new cc.Audio(null,null,a);this.loadAudioFromExtList(a,b,d,g);h.cache[a]=d},loadAudioFromExtList:function(b,d,g,k){if(0===d.length){var q=
"can not found the resource of audio! Last match url is : ",q=q+b.replace(/\.(.*)?$/,"(");e.forEach(function(a){q+=a+"|"});q=q.replace(/\|$/,")");return k(q)}b=cc.path.changeExtname(b,d.splice(0,1));if(c){a.webAudioCallback&&a.webAudioCallback(b);var t=new XMLHttpRequest;t.open("GET",b,!0);t.responseType="arraybuffer";t.onload=function(){f.decodeAudioData(t.response,function(a){g.setBuffer(a);k(null,g)},function(){h.loadAudioFromExtList(b,d,g,k)})};t.send()}else{var s=document.createElement("audio"),
u=!1,v=!1,y=setTimeout(function(){0==s.readyState?z():(v=!0,k("audio load timeout : "+b,g))},1E4),w=function(){u||(g.setElement(s),s.removeEventListener("canplaythrough",w,!1),s.removeEventListener("error",x,!1),s.removeEventListener("emptied",z,!1),!v&&k(null,g),u=!0,clearTimeout(y))},x=function(){u&&(s.removeEventListener("canplaythrough",w,!1),s.removeEventListener("error",x,!1),s.removeEventListener("emptied",z,!1),!v&&h.loadAudioFromExtList(b,d,g,k),u=!0,clearTimeout(y))},z=function(){v=!0;w();
k(null,g)};cc._addEventListener(s,"canplaythrough",w,!1);cc._addEventListener(s,"error",x,!1);a.emptied&&cc._addEventListener(s,"emptied",z,!1);s.src=b;s.load()}}};cc.loader.register(["mp3","ogg","wav","mp4","m4a"],h);cc.audioEngine={_currMusic:null,_musicVolume:1,willPlayMusic:function(){return!1},playMusic:function(a,b){var c=this._currMusic;c&&(c.src!==a&&c.getPlaying())&&c.stop();c=h.cache[a];c||(cc.loader.load(a),c=h.cache[a]);c.play(0,b);c.setVolume(this._musicVolume);this._currMusic=c},stopMusic:function(a){var b=
...
k,!1)},150)}cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()})})(cc.__audioSupport);var res={Sprites_png:"res/Sprites.png",Sprites_plist:"res/Sprites.plist"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var SERVER_ADD=document.location.host;
function getJSON(a,c,b){this.bindFunction=function(a,b){return function(){return a.apply(b,[b])}};this.stateChange=function(a){if(4==this.request.readyState){a=null;try{a=JSON.parse(this.request.responseText)}catch(b){a=null}this.callback(a)}};this.getRequest=function(){return window.ActiveXObject?new ActiveXObject("Microsoft.XMLHTTP"):window.XMLHttpRequest?new XMLHttpRequest:!1};var d=[];if(b)for(var e in b){var f=encodeURIComponent(b[e]);d.push(e+"\x3d"+f)}this.postBody=d.join("\x26");this.callback=
c;this.url=a;if(this.request=this.getRequest())c=this.request,c.onreadystatechange=this.bindFunction(this.stateChange,this),c.open("POST",a,!0),c.setRequestHeader("X-Requested-With","XMLHttpRequest"),c.setRequestHeader("Content-type","application/x-www-form-urlencoded"),c.send(this.postBody)}
var server={_httpServerAddr:"http://"+SERVER_ADD+"/api",_socketServerAddr:"ws://"+SERVER_ADD+"/socket",_username:null,_sessionId:null,_uid:null,_socket:null,_msgId:0,_callbacks:{},getUid:function(){return server._uid},validateResult:function(a,c){var b=a.err;if(void 0!==b)return cc.log("ERR: "+b.toString()),!1;for(b=0;b<c.length;b++){var d=c[b];if(void 0===a[d])return cc.log('ERR: not found field "'+d+'" in resultult'),!1}return!0},login:function(a){if(server._sessionId)return cc.log("ALREADY LOGIN"),
!1;server._username="USER"+parseInt(1E7*Math.random()).toString();server.sendHttpRequest("user.login",function(c){if(!server.validateResult(c,["sid"]))return!1;server._sessionId=c.sid.toString();server._uid=c.uid.toString();cc.log("GET SESSION ID: "+server._sessionId);server.connect(a)},{username:server._username})},logout:function(a){if(null===server._sessionId)return cc.log("ALREADY LOGOUT"),!1;server.sendHttpRequest("user.logout",function(c){server._sessionId=null;cc.log("LOGOUTED");a&&a()})},
connect:function(a){var c="quickserver-"+server._sessionId;cc.log("CONNECT WEBSOCKET with PROTOCOL: "+c.toString());c=new WebSocket(server._socketServerAddr,c);c.onopen=function(){cc.log("WEBSOCKET CONNECTED");a&&a()};c.onerror=function(a){a instanceof Event?cc.log("ERR: CONNECT FAILED"):cc.log("ERR: "+a.toString())};c.onmessage=function(a){cc.log("SOCKET RECV: "+a.data.toString());if(null!==a.data)if(a=JSON.parse(a.data),void 0!==a.__id){var c=a.__id.toString();if(void 0!==server._callbacks[c]){var e=
server._callbacks[c];server._callbacks[c]=null;e(a)}}else if(c=a.__event,void 0!==c)server["on"+c](a)};c.onclose=function(){cc.log("WEBSOCKET DISCONNECTED");server._socket=null};server._socket=c;server._callbacks={}},disconnect:function(){null===server._socket?cc.log("NOT CONNECTED"):(server._socket.close(),server._socket=null,server._callbacks={});return!1},sendHttpRequest:function(a,c,b){getJSON(server._httpServerAddr+"?action\x3d"+a,c,b)},sendSocketMessage:function(a,c,b){null===server._socket?
...
var Tank=cc.Sprite.extend({ctor:function(a,c){this._super();var b="Tank"+a;this.initWithSpriteFrameName(b+"0001.png");this._animation=cc.animate(cc.animationCache.getAnimation(b));this._uid=c;this._state="idle"},getUid:function(){return this._uid},start:function(){this.stop();this._movingAction=this.runAction(new cc.RepeatForever(this._animation))},stop:function(){this._movingAction&&(this.stopAction(this._movingAction),this._movingAction=null)},move:function(a){this.start();this._begin=cc.p(a.x,
a.y);this._dest=cc.p(a.destx,a.desty);this._dist=this._movelen=a.dist;this._destr=a.destr;this._dir=a.dir;this._speed=a.speed;this._rotateSpeed=a.rotateSpeed;this._rotateOffset=a.rotateOffset;this._state=0<this._rotateOffset?"rotate":"move";this.setPosition(a.x,a.y);this.setRotation(a.rotation)},step:function(a){if("idle"!=this._state)if("rotate"==this._state){var c=this.getRotation();a*=this._rotateSpeed;c="right"==this._dir?c+a:c-a;this._rotateOffset-=a;0>=this._rotateOffset&&(c=this._destr,this._state=
"move");this.setRotation(c)}else if("move"==this._state){var c=cc.degreesToRadians(this.getRotation()),b=this.getPosition();a*=this._speed;this._dist-=a;0>=this._dist?(this._state="idle",b=cc.pointAtCircle(this._begin,this._movelen,c),this.stop()):b=cc.pointAtCircle(b,a,c);this.setPosition(b)}}}),BattleLayer=cc.Layer.extend({ctor:function(){this._super();var a=new cc.LayerColor(cc.color(83,71,65,255));this.addChild(a);this._tanks={};var c=this;server.onenter=function(a){server.onidle(a)};server.onidle=
function(a){var d=c.checktank(a);d.setVisible(!0);d.setPosition(a.x,a.y);d.setRotation(a.rotation)};server.onmove=function(a){var d=c.checktank(a);"undefined"!==typeof d&&d.move(a)};server.onremove=function(a){a=c.checktank(a);"undefined"!==typeof a&&(a.removeFromParent(),c._tanks[a.getUid()]=null)};server.sendSocketMessage("battle.enter");a=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,d){c.move(a.getLocation());return!1}});cc.eventManager.addListener(a,
this);this.scheduleUpdate()},checktank:function(a){var c=server.getUid(),b=a.__uid,d=this._tanks[b];"undefined"===typeof d&&(d=new Tank(a.color,b),this.addChild(d),c==b?(cc.log("your tank %s enter battle",b),this._tank=d):cc.log("tank %s enter battle",b));return this._tanks[b]=d},move:function(a){var c=this._tank;if(c&&c.isVisible()){var b=c.getPosition();a={x:b.x,y:b.y,rotation:c.getRotation(),destx:a.x,desty:a.y};server.sendSocketMessage("battle.move",a)}},update:function(a){var c=this._tanks;for(uid in c){var b=
c[uid];b&&b.step&&b.step(a)}}}),BattleScene=cc.Scene.extend({onEnter:function(){this._super();var a=new BattleLayer;this.addChild(a)}});var glview={width:480,height:800};glview.cx=glview.width/2;glview.cy=glview.height/2;
cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(glview.width,glview.height,cc.ResolutionPolicy.EXACT_FIT);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.spriteFrameCache.addSpriteFrames(res.Sprites_plist);for(var a=["Red","Blue","Green","Yellow"],c=0;c<a.length;++c){for(var b=[],d=1;2>=d;++d){var e=cc.spriteFrameCache.getSpriteFrame("Tank"+a[c]+"000"+d.toString()+".png");b.push(e)}b=new cc.Animation(b,0.15);cc.animationCache.addAnimation(b,
